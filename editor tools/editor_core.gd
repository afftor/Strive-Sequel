...
var skil_scene = load("res://editor tools/forms/skill.tscn")
var skill_value_scene = load("res://editor tools/forms/skill_value.tscn")
var skill_eff_template_scene = load("res://editor tools/forms/skill_effect_template.tscn")
var skill_sfx_scene = load("res://editor tools/forms/skill_sfx.tscn")
var buff_scene = load("res://editor tools/forms/buff.tscn")
var atomic_value_scene = load("res://editor tools/forms/atomic_value.tscn")
var atomic_scene = load("res://editor tools/forms/atomic.tscn")
var atomic_tunnel = load("res://editor tools/forms/atomic_tunnel.tscn")
var effect_arg_scene = load("res://editor tools/forms/effect_arg.tscn")
var effect_cond_scene = load("res://editor tools/forms/condition_effect.tscn")
var effect_scene = load("res://editor tools/forms/effect.tscn")
var effect_tunnel = load("res://editor tools/forms/effect_tunnel.tscn")
