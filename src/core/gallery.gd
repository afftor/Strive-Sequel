...
var scenes = {
	...
	lilia_sex_2 = ["lilia_mansion_1","lilia_mansion_2","lilia_mansion_3","lilia_mansion_4","lilia_mansion_5"],
	...
	ana_blow = ['ana_blow_1', 'ana_blow_2', 'ana_blow_4', 'ana_blow_5'],
...
var scenes_order = [
	...
	"daisy_dress_acquired_normal","cali_bj_happy","cali_riding","cali_william_evening","amelia_cali",
	"heleviel", "lilia_sex", "lilia_sex_2", "christmas",
...
var ero_scenes_collection = {
	...
	"daisy_bj_old_":["daisy_bj_old_1","daisy_bj_old_2","daisy_bj_old_3","daisy_bj_old_4","daisy_bj_old_5","daisy_bj_old_6"],
	...
	"lilia_sex_2_":['lilia_sex_2_1', 'lilia_sex_2_2'],
	...
	'ana_blow_': ['ana_blow_1', 'ana_blow_2', 'ana_blow_4', 'ana_blow_5'],
...
var scene_tooltips = {
	...
	cali_william_evening_1 = "CALI_WILLIAM_SS",
