...
var exterior_stats = ['beard', 'ass_size', 'tits_size', 'penis_size', 'balls_size', 'eye_tex', 'chin', 'eyebrows', 'hair_base_length', 'hair_assist_length', 'hair_back_length', 'hair_fringe_length', 'has_pussy'] #stats that a backuped on sex change, sure colors should not be here
