...
onready var _category_tooltips = {
    "all": tr("SEXSELECT_CATEGORY_ALL"),
    "male": tr("SEXSELECT_CATEGORY_MALE"),
    "female": tr("SEXSELECT_CATEGORY_FEMALE"),
    "futa": tr("SEXSELECT_CATEGORY_FUTA"),
}
...
func _ready():
    ...
    for category in _category_buttons.keys():
        ...
        if _category_tooltips.has(category):
            button.hint_tooltip = _category_tooltips[category]
    _reset_category_buttons()
    _limit_icon.hint_tooltip = tr("SEXTOOLTIP")
...
func rebuild_list():
    ...
    for i in ResourceScripts.game_party.character_order:
        ...
        if _is_missing_sex_traits(person):
            ...
            if newbutton.hint_tooltip == "":
                newbutton.hint_tooltip = tr("SEXSELECT_MISSING_TRAITS")
...
func _update_interaction_label():
    ...
    _interaction_limit_label.hint_tooltip = tr("SEXTOOLTIP")
