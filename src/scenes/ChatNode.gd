...
#	hire_line1 = {text = "...Pleased to meet you, [Master].", events = ['hire'], personalities = ['shy'], reqs = [], weight = 1, tags = []},#tags: oneshot (1 time use per game), outweight (will always be presented if is in pool)
	...
	greeting_line_cautious1 = {text = tr("GREETING_LINE_CAUTIOUS1"), events = ['date_greet_cautious'], personalities = ['serious','shy','bold','kind'], reqs = [], weight = 1, tags = []},
	greeting_line_cautious2 = {text = tr("GREETING_LINE_CAUTIOUS2"), events = ['date_greet_cautious'], personalities = ['serious','bold'], reqs = [], weight = 1, tags = []},
	greeting_line_cautious3 = {text = tr("GREETING_LINE_CAUTIOUS3"), events = ['date_greet_cautious'], personalities = ['serious','bold'], reqs = [], weight = 1, tags = []},
	...
	punish_line_light1 = {text = tr("PUNISH_LINE_LIGHT1"), events = ['date_punish_light'], personalities = ['bold','kind','serious','shy'], reqs = [], weight = 100, tags = []},
	punish_line_light2 = {text = tr("PUNISH_LINE_LIGHT2"), events = ['date_punish_light'], personalities = ['bold','kind','serious'], reqs = [], weight = 1, tags = []},
	punish_line_light3 = {text = tr("PUNISH_LINE_LIGHT3"), events = ['date_punish_light'], personalities = ['bold','serious'], reqs = [], weight = 1, tags = []},
	punish_line_light4 = {text = tr("PUNISH_LINE_LIGHT4"), events = ['date_punish_light'], personalities = ['bold','serious'], reqs = [], weight = 1, tags = []},

	punish_line_heavy1 = {text = tr("PUNISH_LINE_HEAVY1"), events = ['date_punish_heavy'], personalities = ['bold','kind','serious'], reqs = [], weight = 1, tags = []},

	public_line1 = {text = tr("PUBLIC_LINE1"), events = ['date_public'], personalities = ['kind','shy'], reqs = [], weight = 1, tags = []},
	public_line2 = {text = tr("PUBLIC_LINE2"), events = ['date_public'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	public_line3 = {text = tr("PUBLIC_LINE3"), events = ['date_public'], personalities = ['kind','serious'], reqs = [], weight = 1, tags = []},
	public_line4 = {text = tr("PUBLIC_LINE4"), events = ['date_public'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	public_line5 = {text = tr("PUBLIC_LINE5"), events = ['date_public'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},
	public_line6 = {text = tr("PUBLIC_LINE6"), events = ['date_public'], personalities = ['shy'], reqs = [], weight = 1, tags = []},
	public_line7 = {text = tr("PUBLIC_LINE7"), events = ['date_public'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},

	#[2* in next cases will automatically translate from dated person
	public_observe_line1 = {text = tr("PUBLIC_OBSERVE_LINE1"), events = ['date_public_observe'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},
	public_observe_line2 = {text = tr("PUBLIC_OBSERVE_LINE2"), events = ['date_public_observe'], personalities = ['bold','serious'], reqs = [], weight = 1, tags = []},
	...
	public_observe_line5 = {text = tr("PUBLIC_OBSERVE_LINE5"), events = ['date_public_observe'], personalities = ['shy','kind','serious'], reqs = [], weight = 1, tags = []},
	...
	marry_propose_agree1 = {text = tr("MARRY_PROPOSE_AGREE1"), events = ['marry_proposal_agree'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},
	marry_propose_agree2 = {text = tr("MARRY_PROPOSE_AGREE2"), events = ['marry_proposal_agree'], personalities = ['serious','bold'], reqs = [], weight = 1, tags = []},
	marry_propose_agree3 = {text = tr("MARRY_PROPOSE_AGREE3"), events = ['marry_proposal_agree'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},
	
	marry_proposal_agreed_before1 = {text = tr("MARRY_PROPOSAL_AGREED_BEFORE1"), events = ['marry_proposal_agreed_before'], personalities = ['shy','kind','serious','bold'], reqs = [], weight = 1, tags = []},
	marry_proposal_agreed_before2 = {text = tr("MARRY_PROPOSAL_AGREED_BEFORE2"), events = ['marry_proposal_agreed_before'], personalities = ['shy','kind','serious','bold'], reqs = [], weight = 1, tags = []},
	
	marry_propose_refuse1 = {text = tr("MARRY_PROPOSE_REFUSE1"), events = ['marry_proposal_refuse'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},
	marry_propose_refuse2 = {text = tr("MARRY_PROPOSE_REFUSE2"), events = ['marry_proposal_refuse'], personalities = ['serious','bold'], reqs = [], weight = 1, tags = []},
	marry_propose_refuse3 = {text = tr("MARRY_PROPOSE_REFUSE3"), events = ['marry_proposal_refuse'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},
	
	
	date_propose_agree1 = {text = tr("DATE_PROPOSE_AGREE1"), events = ['date_proposal_agree'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},
	date_propose_agree2 = {text = tr("DATE_PROPOSE_AGREE2"), events = ['date_proposal_agree'], personalities = ['serious','bold'], reqs = [], weight = 1, tags = []},
	date_propose_agree3 = {text = tr("DATE_PROPOSE_AGREE3"), events = ['date_proposal_agree'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	date_propose_agree4 = {text = tr("DATE_PROPOSE_AGREE4"), events = ['date_proposal_agree'], personalities = ['serious','kind'], reqs = [], weight = 1, tags = []},
	...
	date_propose_refuse1 = {text = tr("DATE_PROPOSE_REFUSE1"), events = ['date_proposal_refuse'], personalities = ['kind','serious'], reqs = [], weight = 1, tags = []},
	date_propose_refuse2 = {text = tr("DATE_PROPOSE_REFUSE2"), events = ['date_proposal_refuse'], personalities = ['kind','shy'], reqs = [], weight = 1, tags = []},
	date_propose_refuse3 = {text = tr("DATE_PROPOSE_REFUSE3"), events = ['date_proposal_refuse'], personalities = ['bold','serious'], reqs = [], weight = 1, tags = []},
	date_propose_refuse4 = {text = tr("DATE_PROPOSE_REFUSE4"), events = ['date_proposal_refuse'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	date_propose_refuse5 = {text = tr("DATE_PROPOSE_REFUSE5"), events = ['date_proposal_refuse'], personalities = ['kind','shy','serious'], reqs = [], weight = 1, tags = []},


	date_propose_had_sex1 = {text = tr("DATE_PROPOSE_HAD_SEX1"), events = ['date_proposal_had_sex'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	date_propose_had_sex2 = {text = tr("DATE_PROPOSE_HAD_SEX2"), events = ['date_proposal_had_sex'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	date_propose_had_sex3 = {text = tr("DATE_PROPOSE_HAD_SEX3"), events = ['date_proposal_had_sex'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},

	date_propose_was_forced1 = {text = tr("DATE_PROPOSE_WAS_FORCED1"), events = ['date_proposal_was_forced'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	date_propose_was_forced2 = {text = tr("DATE_PROPOSE_WAS_FORCED2"), events = ['date_proposal_was_forced'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	date_propose_was_forced3 = {text = tr("DATE_PROPOSE_WAS_FORCED3"), events = ['date_proposal_was_forced'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	date_propose_was_forced4 = {text = tr("DATE_PROPOSE_WAS_FORCED4"), events = ['date_proposal_was_forced'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},

	date_sex_offer1 = {text = tr("DATE_SEX_OFFER1"), events = ['date_sex_offer'], personalities = ['kind','serious'], reqs = [], weight = 1, tags = []},
	...
	date_sex_offer4 = {text = tr("DATE_SEX_OFFER4"), events = ['date_sex_offer'], personalities = ['bold','serious'], reqs = [], weight = 1, tags = []},
	date_sex_offer5 = {text = tr("DATE_SEX_OFFER5"), events = ['date_sex_offer'], personalities = ['bold','serious','kind'], reqs = [], weight = 1, tags = []},
	date_sex_offer6 = {text = tr("DATE_SEX_OFFER6"), events = ['date_sex_offer'], personalities = ['shy'], reqs = [], weight = 1, tags = []},

	date_affection1 = {text = tr("DATE_AFFECTION1"), events = ['date_affection'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	date_affection2 = {text = tr("DATE_AFFECTION2"), events = ['date_affection'], personalities = ['kind','serious','bold'], reqs = [], weight = 1, tags = []},
	date_affection3 = {text = tr("DATE_AFFECTION3"), events = ['date_affection'], personalities = ['kind','serious'], reqs = [], weight = 1, tags = []},
	...
	date_scold1 = {text = tr("DATE_SCOLD1"), events = ['date_scold'], personalities = ['kind','serious','shy'], reqs = [], weight = 1, tags = []},
	date_scold2 = {text = tr("DATE_SCOLD2"), events = ['date_scold'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	date_scold3 = {text = tr("DATE_SCOLD3"), events = ['date_scold'], personalities = ['kind','shy'], reqs = [], weight = 1, tags = []},
	date_scold4 = {text = tr("DATE_SCOLD4"), events = ['date_scold'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	date_scold5 = {text = tr("DATE_SCOLD5"), events = ['date_scold'], personalities = ['kind','serious'], reqs = [], weight = 1, tags = []},

	mimic_eat1 = {text = tr("MIMIC_EAT1"), events = ['mimic_eat'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	mimic_eat2 = {text = tr("MIMIC_EAT2"), events = ['mimic_eat','mimic_rape'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	mimic_eat3 = {text = tr("MIMIC_EAT3"), events = ['mimic_eat','mimic_rape'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},


	mimic_molest1 = {text = tr("MIMIC_MOLEST1"), events = ['mimic_rape'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	mimic_molest2 = {text = tr("MIMIC_MOLEST2"), events = ['mimic_rape'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	mimic_molest3 = {text = tr("MIMIC_MOLEST3"), events = ['mimic_rape'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},

	mimic_leave1 = {text = tr("MIMIC_LEAVE1"), events = ['mimic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	mimic_leave2 = {text = tr("MIMIC_LEAVE2"), events = ['mimic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	mimic_leave3 = {text = tr("MIMIC_LEAVE3"), events = ['mimic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	mimic_leave4 = {text = tr("MIMIC_LEAVE4"), events = ['mimic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},

	mimic_erotic_leave1 = {text = tr("MIMIC_EROTIC_LEAVE1"), events = ['mimic_erotic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = []},
	mimic_erotic_leave2 = {text = tr("MIMIC_EROTIC_LEAVE2"), events = ['mimic_erotic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = [{code = 'trait', trait = 'deviant', check = false }]},
	mimic_erotic_leave3 = {text = tr("MIMIC_EROTIC_LEAVE3"), events = ['mimic_erotic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = [{code = 'trait', trait = 'deviant', check = false }]},
	mimic_erotic_leave4 = {text = tr("MIMIC_EROTIC_LEAVE4"), events = ['mimic_erotic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = [{code = 'trait', trait = 'deviant', check = false }]},

	mimic_erotic_leave5 = {text = tr("MIMIC_EROTIC_LEAVE5"), events = ['mimic_erotic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = [{code = 'trait', trait = 'deviant', check = true }]},
	mimic_erotic_leave6 = {text = tr("MIMIC_EROTIC_LEAVE6"), events = ['mimic_erotic_leave'], personalities = ['kind','serious','shy','bold'], reqs = [], weight = 1, tags = [{code = 'trait', trait = 'deviant', check = true }]},

	praise_reject1 = {text = tr("PRAISE_REJECT1"), events = ['praise_reject'], personalities = ['kind','serious','bold'], reqs = [], weight = 1, tags = []},
	praise_reject2 = {text = tr("PRAISE_REJECT2"), events = ['praise_reject'], personalities = ['serious','shy','kind'], reqs = [], weight = 1, tags = []},
	praise_reject3 = {text = tr("PRAISE_REJECT3"), events = ['praise_reject'], personalities = ['serious','shy','bold','kind'], reqs = [], weight = 1, tags = []},

	date_start1 = {text = tr("DATE_START1"), events = ['date_start'], personalities = ['serious','shy','bold','kind'], reqs = [], weight = 1, tags = []},
	date_start2 = {text = tr("DATE_START2"), events = ['date_start'], personalities = ['serious','shy','bold','kind'], reqs = [], weight = 1, tags = []},
	date_start3 = {text = tr("DATE_START3"), events = ['date_start'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},
	date_start4 = {text = tr("DATE_START4"), events = ['date_start'], personalities = ['shy'], reqs = [], weight = 1, tags = []},
	date_start5 = {text = tr("DATE_START5"), events = ['date_start'], personalities = ['bold','serious','kind'], reqs = [], weight = 1, tags = []},
	...
	date_start8 = {text = tr("DATE_START8"), events = ['date_start'], personalities = ['kind','serious'], reqs = [], weight = 1, tags = []},
	...
	date_start_happy4 = {text = tr("DATE_START_HAPPY4"), events = ['date_start_happy'], personalities = ['shy','kind'], reqs = [], weight = 1, tags = []},
	...
	date_start_happy10 = {text = tr("DATE_START_HAPPY10"), events = ['date_start_happy'], personalities = ['serious','kind'], reqs = [], weight = 1, tags = []},
	...
	treat_food_resist1 = {text = tr("TREAT_FOOD_RESIST1"), events = ['treat_food_resist'], personalities = ['serious','kind','bold','shy'], reqs = [], weight = 1, tags = []},
	treat_food_like1 = {text = tr("TREAT_FOOD_LIKE1"), events = ['treat_food_like'], personalities = ['serious','kind','bold','shy'], reqs = [], weight = 1, tags = []},
	treat_food_hate1 = {text = tr("TREAT_FOOD_HATE1"), events = ['treat_food_hate'], personalities = ['serious','kind','bold','shy'], reqs = [], weight = 1, tags = []},
	treat_food_neutral1 = {text = tr("TREAT_FOOD_NEUTRAL1"), events = ['treat_food_neutral'], personalities = ['serious','kind','bold','shy'], reqs = [], weight = 1, tags = []},
