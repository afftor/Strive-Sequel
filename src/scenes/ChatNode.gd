...
#	hire_line1 = {text = "...Pleased to meet you, [Master].", events = ['hire'], personalities = ['shy'], reqs = [], weight = 1, tags = []},#tags: oneshot (1 time use per game), outweight (will always be presented if is in pool)
	...
	combat_win_line1 = {text = tr("COMBAT_WIN_LINE1"), events = ['combat_won_slow'], personalities = ['shy','kind','neutral'], reqs = [], weight = 1, tags = []},
	combat_win_line2 = {text = tr("COMBAT_WIN_LINE2"), events = ['combat_won_fast'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	combat_win_line3 = {text = tr("COMBAT_WIN_LINE3"), events = ['combat_won_fast'], personalities = ['serious'], reqs = [], weight = 1, tags = []},
	combat_win_line4 = {text = tr("COMBAT_WIN_LINE4"), events = ['combat_won_fast'], personalities = ['shy','kind','neutral'], reqs = [], weight = 1, tags = []},
	combat_win_line5 = {text = tr("COMBAT_WIN_LINE5"), events = ['combat_won_fast'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	combat_win_line6 = {text = tr("COMBAT_WIN_LINE6"), events = ['combat_won_slow'], personalities = ['shy'], reqs = [], weight = 1, tags = []},
	combat_win_line7 = {text = tr("COMBAT_WIN_LINE7"), events = ['combat_won_slow'], personalities = ['shy'], reqs = [], weight = 1, tags = []},
	combat_win_line8 = {text = tr("COMBAT_WIN_LINE8"), events = ['combat_won_fast'], personalities = ['shy'], reqs = [], weight = 1, tags = []},
	combat_win_line9 = {text = tr("COMBAT_WIN_LINE9"), events = ['combat_won_fast'], personalities = ['shy'], reqs = [], weight = 1, tags = []},
	combat_win_line10 = {text = tr("COMBAT_WIN_LINE10"), events = ['combat_won_fast'], personalities = ['shy'], reqs = [], weight = 1, tags = []},
	combat_win_line11 = {text = tr("COMBAT_WIN_LINE11"), events = ['combat_won_fast','combat_won_slow'], personalities = ['serious'], reqs = [], weight = 1, tags = []},
	combat_win_line12 = {text = tr("COMBAT_WIN_LINE12"), events = ['combat_won_fast'], personalities = ['serious'], reqs = [], weight = 1, tags = []},
	combat_win_line13 = {text = tr("COMBAT_WIN_LINE13"), events = ['combat_won_fast'], personalities = ['serious'], reqs = [], weight = 1, tags = []},
	combat_win_line14 = {text = tr("COMBAT_WIN_LINE14"), events = ['combat_won_fast'], personalities = ['serious'], reqs = [], weight = 1, tags = []},
	combat_win_line15 = {text = tr("COMBAT_WIN_LINE15"), events = ['combat_won_fast'], personalities = ['serious'], reqs = [], weight = 1, tags = []},
	combat_win_line16 = {text = tr("COMBAT_WIN_LINE16"), events = ['combat_won_fast','combat_won_slow'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	combat_win_line17 = {text = tr("COMBAT_WIN_LINE17"), events = ['combat_won_fast','combat_won_slow'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	combat_win_line18 = {text = tr("COMBAT_WIN_LINE18"), events = ['combat_won_fast'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	combat_win_line19 = {text = tr("COMBAT_WIN_LINE19"), events = ['combat_won_fast'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	combat_win_line20 = {text = tr("COMBAT_WIN_LINE20"), events = ['combat_won_fast'], personalities = ['bold'], reqs = [], weight = 1, tags = []},
	combat_win_line21 = {text = tr("COMBAT_WIN_LINE21"), events = ['combat_won_fast','combat_won_slow'], personalities = ['kind'], reqs = [], weight = 1, tags = []},
	combat_win_line22 = {text = tr("COMBAT_WIN_LINE22"), events = ['combat_won_slow'], personalities = ['kind'], reqs = [], weight = 1, tags = []},
	combat_win_line23 = {text = tr("COMBAT_WIN_LINE23"), events = ['combat_won_fast'], personalities = ['kind'], reqs = [], weight = 1, tags = []},
	combat_win_line24 = {text = tr("COMBAT_WIN_LINE24"), events = ['combat_won_fast'], personalities = ['kind'], reqs = [], weight = 1, tags = []},
	combat_win_line25 = {text = tr("COMBAT_WIN_LINE25"), events = ['combat_won_slow'], personalities = ['kind'], reqs = [], weight = 1, tags = []},
