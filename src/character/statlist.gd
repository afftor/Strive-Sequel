...
var template = {
	...
	slave_class = 'slave',
	personality = '',
#	authority = 0.0, obsolete
#	authority_mod = 1.0,#obsolete
	obedience = 100.0,
	obedience_drain = 20.0,
#	loyaltyObeidence = 0.0, #obsolete
#	submissionObedience = 0.0, #obsolete
	loyalty = 0.0,
	loyalty_gain = 0.0,
	loyalty_max = 0.0,
	loyalty_max_gain = 0.0,
...
#	obDrainIncrease = 0.0, obsolete
#	obDrainReduction = 1.0, obsolete
