...
#	},
	...
	pet = {
		...
		reqs = [{code = 'stat', type = 'tame_factor', operant = 'gte', value = 2}, {code = 'race_is_beast',value = false}],
	...
	petbeast = {
		...
		reqs = [{code = 'stat', type = 'tame_factor', operant = 'gte', value = 2}, {code = 'race_is_beast',value = true}],
