...
var professions = {
	...
	knight = {
		...
		statchanges = {hpmax = 40, armor = 10, speed = 3},
		traits = ['heavy_armor'],
		skills = [],
	...
	dragonknight = {
		...
		statchanges = {hpmax = 25, physics_bonus = 20, resistfire = 75, speed = 3},
		traits = ['heavy_armor'],
		skills = [],
	...
	dominator = {
		...
		statchanges = {charm_bonus = 20, wits_factor = 1, mpmax = 10},
		traits = [],
	...
	druid = {
		...
		statchanges = {wits_bonus = 15, hpmax = 10, speed = 3},
		traits = [],
		skills = [],
	...
	valkyrie = {
		...
		statchanges = {hpmax = 20, physics_bonus = 15, speed = 5},
		traits = ['medium_armor'],
		skills = [],
	...
	sniper = {
		...
		categories = ['combat'],
		showupreqs = [],
		reqs = [{code = 'stat', type = 'physics', operant = 'gte', value = 40},{code = 'has_profession', value = 'archer', check = true}],
	...
	rogue = {
		...
		showupreqs = [],
		reqs = [{code = 'stat', type = 'wits_factor', operant = 'gte', value = 2}],
		statchanges = {evasion = 10, critchance = 2, speed = 10},
	...
	assassin = {
		...
		statchanges = {speed = 10, evasion = 25, critchance = 5, hpmax = 10},
		traits = [],
		skills = [],
