...
#	},
	...
	pet = {
		...
		reqs = [{code = 'stat', type = 'brave_factor', operant = 'lte', value = 3}, {code = 'race_is_beast',check = false}],
	...
	petbeast = {
		...
		reqs = [{code = 'stat', type = 'brave_factor', operant = 'lte', value = 3}, {code = 'race_is_beast',check = true}],
