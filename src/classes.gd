...
var professions = {
	...
	director = {
		...
		categories = ['social'],
		showupreqs = [{code = 'has_profession', value = 'master', check = false}],
		reqs = [{code = 'stat', type = 'loyal', operant = 'gte', value = 75},{code = 'has_profession', value = 'headgirl', check = true}],
	...
	succubus = {
		...
		statchanges = {charm_factor = 1, sexuals_bonus = 15},
		traits = ['succubus'],
	...
	true_succubus = {
		...
		statchanges = {charm_factor = 1, sexuals_bonus = 15, magic_factor = 1},
		traits = ['succubus'],
	...
	petbeast = {
		...
		statchanges = {charm_bonus = 20, sexuals_bonus = 10, tame_factor = 1},
		traits = [],
		skills = ['serve'],
		combatskills = ['distract'],
	},
	sextoy = {
		...
		statchanges = {sexuals_bonus = 30, sexuals_factor = 1, brave_factor = -1},
		traits = ['sextoy'],
		skills = [],
