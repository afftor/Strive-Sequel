...
#	},
	...
	druid = {
		...
		reqs = [{code = 'has_profession', value = 'apprentice', check = true},{code = 'stat', type = 'magic_factor', operant = 'gte', value = 3}, {code = 'one_of_races', value = ['Elf','DarkElf','Drow','Dryad','Fairy']}],
