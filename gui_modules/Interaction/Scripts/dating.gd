...
var date_lines = {
	...
	pullear_initiate = [[tr("DATING_PULLEARS_INITIATE_1"), 1]],
	pullear_accept = [[tr("DATING_PULLEARS_ACCEPT_1"), 1]],
	pullear_resist = [[tr("DATING_PULLEARS_RESIST_1"), 1], [tr("DATING_PULLEARS_RESIST_2"), 1]],
...
#	person.add_stat("obedience", obedience)
	...
	if endmood < 20 and endfear >= 20:
		person.try_breakdown('brk_terrible_date')
