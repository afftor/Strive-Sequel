...
func open():
	...
	$StartButton.disabled = ResourceScripts.game_globals.daily_sex_left < 1
...
func update_description():
	...
	text += "\n" + "Interactions per day: " + str(ResourceScripts.game_globals.daily_sex_left) + "/1"
...
func start_scene():
	...
	GUIWorld.gui_data["INTERACTION"].main_module.startsequence(participants)
