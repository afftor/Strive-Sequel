...
var TranslationDict = {
	...
	SKILLREWARDSEXDESCRIPT = "Relieves character to improve their behavior. Increases obedience. Target must have at least 25 Lust. ",
	SKILLSEDUCE = "Seduce",
	SKILLSEDUCEDESCRIPT = "By pushing right buttons you can not only make them horny, but also follow your orders. Increases lust and obedience.",
