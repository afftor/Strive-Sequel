...
#
	...
	height = {
		tiny = [
			{type = 'scale', value = 0.6},
			{type = 'offset', value_x = 0.0, value_y = 160},
			...
			{type = 'node_attr', node = 'male_pose/HumanF1/Spine/Head', attr = 'position', value = Vector2(-351, 9)},
			...
			{type = 'node_attr', node = 'Female_pose/HumanF1/Spine/Head', attr = 'position', value = Vector2(-351, 9)},
		...
		petite = [
			{type = 'scale', value = 0.72},
			{type = 'offset', value_x = 0.0, value_y = 130},
			...
			{type = 'node_attr', node = 'male_pose/HumanF1/Spine/Head', attr = 'scale', value = Vector2(1.07, 1.1)},
			{type = 'node_attr', node = 'male_pose/HumanF1/Spine/Head', attr = 'position', value = Vector2(-353, 9)},
			...
			{type = 'node_attr', node = 'Female_pose/HumanF1/Spine/Head', attr = 'scale', value = Vector2(1.07, 1.1)},
			{type = 'node_attr', node = 'Female_pose/HumanF1/Spine/Head', attr = 'position', value = Vector2(-353, 9)},
		...
		short = [
			{type = 'scale', value = 0.84},
			{type = 'offset', value_x = 0.0, value_y = 100},
		...
		towering = [
			{type = 'scale', value = 1.2},
			{type = 'offset', value_x = 0.0, value_y = -10},
