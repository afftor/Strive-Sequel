...
#			{type = 'import_recolor_group', group = 'skin_main', material = "remove_racial_masks", ids = []}, non-existed material
	...
	armor_base = {
		...
		servant = [
			...
			{type = 'node_attr', node = 'Female_pose/HumanF1/Spine/Tits_big/Tits_armor_mesh2', attr = 'visible', value = true},
			...
			{type = 'node_attr', node = 'Female_pose/HumanF1/Spine/Tits_normal/Tits_armor_mesh2', attr = 'visible', value = true},
			...
			{type = 'node_attr', node = 'Female_pose/HumanF1/Spine/Tits_small/Tits_armor_mesh2', attr = 'visible', value = true},
			...
			{type = 'node_attr', node = 'Female_pose/HumanF1/Spine/Tits_zero/Tits_armor_mesh2', attr = 'visible', value = true},
