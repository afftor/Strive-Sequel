...
var scenedict = {
	...
	combat = "res://GUI_New/Combat_v2.tscn",
...
var scriptdict = {
	...
	ch_xp_module = "res://src/character/ch_leveling.gd",
	...
	combat_animation = "res://GUI_New/CombatAnimations_v2.gd",
...
onready var node_data = {
	...
	input_handler.NODE_SLAVETOOLTIP : {name = 'slavetooltip', mode = 'scene', scene = preload("res://GUI_New/Universal/SlaveTooltip_v2.tscn")},
