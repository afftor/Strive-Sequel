...
onready var node_data = {
	...
	input_handler.NODE_DIALOGUE : {name = 'dialogue', mode = 'scene', scene = preload("res://gui_modules/Universal/Modules/InteractiveMessageModule_animated.tscn")},
	...
	input_handler.NODE_TUTORIAL_PANEL : {name = 'tutorial_panel', mode = 'scene', scene = preload("res://gui_modules/Universal/Modules/tutorialpanel.tscn") },
	#Animations
