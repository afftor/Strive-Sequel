...
#		new_syntax = true,
	...
	aura_firearr = { #fix
		...
		target_range = 'any',
		damage_type = 'weapon',
		sfx = [{code = 'aura_firearr', target = 'target', period = 'predamage'}], 
		sound = [],
		value = [['0']],
		damagestat = 'no_stat',
		variations = [
	...
	aura_dmg_air = { #fix
		...
		target_range = 'any',
		damage_type = 'weapon',
		sfx = [{code = 'aura_arcaneblade', target = 'target', period = 'predamage'}], 
		sound = [],
		value = [['0']],
		damagestat = 'no_stat',
		variations = [
...
#		buffs = ['b_free_use']
	...
	e_tr_paladin_5_display = {
		type = 'simple',
		conditions = [{code = 'shield_with_evasion_bonus', check = true}],
		buffs = ['b_paladin_guard'],
	},
	e_tr_paladin_5 = {
		type = 'trigger',
...
#		stack = 'spellsword_aura', 
	...
	e_fa_aura_firearr = {
		...
		rem_event = [variables.TR_DEATH],
		target = 'caster',
		tags = ['spellsword_aura','spellsword_firearr', 'class_spellsword'],
	...
	e_tr_aura_firearr = {
		...
		trigger = [variables.TR_HIT],
		conditions = [
			{type = 'skill', value = ['is_qualified_for_spellsword_followup', 'eq', true]},
#			{type = 'skill', value = ['tags', 'has', 'damage']},
#			{type = 'skill', value = ['target_number', 'eq', 'single']},
#			{type = 'skill', value = ['ability_type', 'eq', 'skill']},
#			{type = 'skill', value = ['follow_up', 'eq', null]},
#			{type = 'skill', value = ['mode', 'eq', variables.SKILL_BASE]},
	...
	e_fa_aura_impale = {
		...
		rem_event = [variables.TR_DEATH],
		target = 'caster',
		tags = ['spellsword_aura','spellsword_impale', 'class_spellsword'],
...
#			{type = 'skill', value = ['mode', 'eq', variables.SKILL_BASE]},
	...
	e_fa_aura_lightning = {
		...
		rem_event = [variables.TR_DEATH],
		target = 'caster',
		tags = ['spellsword_aura','spellsword_lightning', 'class_spellsword'],
...
#			{type = 'skill', value = ['mode', 'eq', variables.SKILL_BASE]},
	...
	e_fa_aura_darkness = {
		...
		rem_event = [variables.TR_DEATH],
		target = 'caster',
		tags = ['spellsword_aura','spellsword_darkness', 'class_spellsword'],
...
#			{type = 'skill', value = ['mode', 'eq', variables.SKILL_BASE]},
	...
	e_aura_air = {
		...
		tags = ['arcaneblade_aura', 'arcaneblade_air', 'class_arcane_blade'],
	...
	e_aura_dark = {
		...
		type = 'base',
		stack = 'arcaneblade_aura',
		tags = ['arcaneblade_aura', 'arcaneblade_dark', 'class_arcane_blade'],
		statchanges = {damagetype = 'dark'},
		buffs = []
	},
	e_aura_earth = {
		...
		type = 'base',
		stack = 'arcaneblade_aura',
		tags = ['arcaneblade_aura', 'arcaneblade_earth', 'class_arcane_blade'],
	...
	e_aura_fire = {
		...
		type = 'base',
		stack = 'arcaneblade_aura',
		tags = ['arcaneblade_aura', 'arcaneblade_fire', 'class_arcane_blade'],
	...
	e_aura_light = {
		...
		type = 'base',
		stack = 'arcaneblade_aura',
		tags = ['arcaneblade_aura', 'arcaneblade_light', 'class_arcane_blade'],
	...
	e_aura_water = {
		...
		type = 'base',
		stack = 'arcaneblade_aura',
		tags = ['arcaneblade_aura', 'arcaneblade_water', 'class_arcane_blade'],
