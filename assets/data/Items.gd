...
var partmaterials = {
	...
	ArmorTrim = {
		wood = {hpmod = 0.1, resistearth = 5},
		woodmagic = {hpmod = 0.15, matk = 5, resistair = 5, resistwater = 5},
		woodiron = {hpmod = 0.25, resistearth = 5, resistwater = 10},
		woodancient = {hpmod = 0.4, resistearth = 10, resistwater = 10},
