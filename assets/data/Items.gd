...
var partmaterials = {
	...
	WeaponHandle = {
		wood = {hitrate = 5},
		woodmagic = {hitrate = 10, manamod = 0.1},
		...
		bone = {damage = 5},
		boneancient = {damage = 10},
		bonedragon = {damage = 15, hitrate = 10},
		obsidian = {resistearth = 10, resistfire = 10},
	},
	ToolBlade = {
	...
	Blade = {
		stone = {damagemod = -0.5},
		obsidian = {damage = 10, armorpenetration = 10},
		iron = {damage = 5},
		steel = {damage = 10},
		mithril = {damage = 15},
		adamantine = {damage = 20},
		bone = {damage = 3},
		boneancient = {damage = 8},
		bonedragon = {damage = 20},
	},
	BowBase = {
		wood = {damage = 6},
		woodmagic = {damage = 8, manamod = 0.1},
		woodiron = {damage = 10},
		woodancient = {damage = 15},
		obsidian = {damage = 10, armorpenetration = 10},
		iron = {damage = 9},
		steel = {damage = 13},
		mithril = {damage = 17},
		adamantine = {damage = 22},
		bone = {damage = 7},
		boneancient = {damage = 16},
		bonedragon = {damage = 20},
	},
	Rod = {
		wood = {},
