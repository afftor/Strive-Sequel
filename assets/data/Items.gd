...
var partmaterials = {
	...
	ShieldBase = {
		...
		mithril = {armor = 8, mpmax_add_part = 0.1, enchant_capacity_mod = 0.2},
		adamantine = {armor = 10, hpmax_add_part = 0.1, enchant_capacity_mod = 0.25},
		meteorite_iron = {armor = 9, mdef = 5, hpmax_add_part = 0.05, enchant_capacity_mod = 0.25},
		...
		leathermythic = {evasion = 15, armor = 5, hpmax_add_part = 0.15, enchant_capacity_mod = 0.2},
