...
var Parts = {
	...
	ArmorBaseCloth = {name = tr("ARMORBASE"), code = 'ArmorBase', icon = null},
	ArmorBaseMed = {name = tr("ARMORBASE"), code = 'ArmorBase', icon = null},
	ArmorBaseHeavy = {name = tr("ARMORBASE"), code = 'ArmorBase', icon = null},
