...
var partmaterials = {
	...
	ArmorEnc = {
		...
		ice_material = {critchance = 10, critmod = 0.2, resist_water = 20},
		air_material = {evasion = 30, hitrate = 20, resist_air = 20},
		earth_material = {hpmax = 20, mpmax = 20, resist_earth = 20},
		fire_material = {damage_mod_melee = 0.15, resist_fire = 20},
	},
}
...
var recipes = {
	...
	chest_adv_metal = {
		...
		materials = {},
		items = {},
		unlockreqs = [{type = "has_upgrade", name = 'smith', value = 3}], 
		crafttype = 'modular',
		resultamount = 1, 
		resultitemtype = 'item', 
