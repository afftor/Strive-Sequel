...
#		final_enemy = [], final_enemy_type = 'monster', final_enemy_class = ['combat'],
	...
	dungeon_bandit_den = {
		...
		character_data = {
			...
			races = [['Human',48], ['Elf',10], ['Orc',10], ['Goblin',8], ['Ratkin',8], ['BeastkinCat',8], ['BeastkinBunny',8]]
		},
		difficulty = 'easy',
		background_pool = ['cave_1', 'cave_2', 'cave_3', 'cave_4', 'cave_5', 'cave_6', 'cave_7', 'cave_8', 'cave_9', 'cave_10'],
	...
	dungeon_bandit_fort = {
		...
		character_data = {
			chance_mod = 1.2,
			races = [['Human',26], ['Orc',12], ['Elf',10], ['BeastkinCat',9], ['Goblin',8], ['Taurus',8], ['Dwarf',7], ['TribalElf',7], ['BeastkinBunny',7], ['DarkElf',3]]
		},
		difficulty = 'medium',
		background_pool = ['fort1', 'fort2', 'fort3', 'fort4', 'fort5', 'fort6', 'fort7', 'fort8'],
	...
	dungeon_rebel_redoubt = {
		...
		character_data = {
			chance_mod = 1,
			races = [['Human',24], ['Orc',12], ['Centaur',10], ['Ratkin',10], ['BeastkinWolf',6], ['Taurus',6], ['Goblin',6], ['Elf',6], ['BeastkinCat',5], ['BeastkinFox',5], ['BeastkinBunny',5], ['BeastkinTanuki',5]]
		},
		difficulty = 'medium',
		background_pool = ['fort1', 'fort2', 'fort3', 'fort4', 'fort5', 'fort6', 'fort7', 'fort8'],
		custom_background = 'combat_fort',
	...
	dungeon_undead_crypt = {
		...
		character_data = {
			chance_mod = 0.7,
			races = [['Dwarf',19], ['Human',15], ['DarkElf',6], ['Lamia',12], ['Kobold',10], ['Gnome',9], ['Harpy',8], ['Scylla',6], ['Elf',12]]
		},
		background_pool = ['crypt1', 'crypt2', 'crypt3', 'crypt4', 'crypt5', 'crypt6', 'crypt7'],
	...
	dungeon_goblin_cave = {
		...
		character_data = {
			chance_mod = 1.1,
			races = [['Goblin',34], ['Human',18], ['Ratkin',14], ['Kobold',12], ['Gnome',8], ['BeastkinBunny',8], ['BeastkinCat',6]]
		},
		background_pool = ['cave_1', 'cave_2', 'cave_3', 'cave_4', 'cave_5', 'cave_6', 'cave_7', 'cave_8', 'cave_9', 'cave_10'],
		custom_background = 'combat_cave',
		bgm = "dungeon",
	...
	dungeon_grove = {
		...
		character_data = {
			chance_mod = 0.7,
			races = [['Elf',30], ['Fairy',6], ['Dryad',8], ['TribalElf',12], ['BeastkinWolf',12], ['BeastkinFox',10], ['Human',6]]
		},
...
#			},
	...
	dungeon_spider_lair = {
		...
		character_data = {
			chance_mod = 0.5,
			races = [['Elf',26], ['Arachna',5], ['Fairy',7], ['TribalElf',16], ['Human',10], ['Dryad',8], ['BeastkinFox',8], ['BeastkinTanuki',8]]
		},
		purchase_area = 'forests',
	...
	dungeon_ancient_jungles = {
		...
		character_data = {
			chance_mod = 1,
			races = [['TribalElf',32], ['Harpy',9], ['Dryad',9], ['BeastkinFox',8], ['BeastkinTanuki',8], ['Arachna',7], ['Nereid',7], ['Centaur',6], ['Slime',6], ['Lamia',4], ['DarkElf',4]]
		},
		purchase_area = 'forests',
		background_pool = ['jungle1', 'jungle2', 'jungle3', 'jungle4', 'jungle5', 'jungle6', 'jungle7'],
	...
	dungeon_goblin_stronghold = {
		...
		character_data = {
			chance_mod = 1.1,
			races = [['Goblin',20], ['Orc',15], ['Human',12], ['Ratkin',10], ['BeastkinWolf',10], ['Kobold',8], ['Harpy',8], ['Taurus',8], ['DarkElf',5], ['Demon',7]]
		},
		difficulty = 'medium',
		background_pool = ['goblin_stronghold1', 'goblin_stronghold2', 'goblin_stronghold3', 'goblin_stronghold4'],
		custom_background = 'combat_fort',
...
#				{code = 'stage', value = 5, operant = 'gte'}]}
	...
	quest_mae_ancient_jungle = {
		code = 'quest_mae_ancient_jungle',
		type = 'dungeon',
		name = tr("QUEST_MAE_ANCIENT_JUNGLE_TEXT"),
		classname = '',
		descript = tr("QUEST_MAE_ANCIENT_JUNGLE_DESC"),
		character_data = {
			chance_mod = 1,
			races = [['local', 3], ['common',5], ['uncommon',1]]
		},
...
#	},
	...
	quest_mae_spirit_ritual = {
		code = 'quest_mae_spirit_ritual',
		type = 'encounter',
		name = tr("QUEST_MAE_SPIRIT_RITUAL_TEXT"),
		area = 'forests',
		classname = '',
		descript = tr("QUEST_MAE_SPIRIT_RITUAL_DESC"),
		difficulty = 'easy',
		bgm = "dungeon",
		background = 'forest3',
		custom_background = 'combat_forest',
	...
	quest_mae_northern_tribe = {
		code = 'quest_mae_northern_tribe',
		type = 'encounter',
		name = tr("QUEST_MAE_NORTHERN_TRIBE_TEXT"),
		area = 'forests',
		classname = '',
		descript = tr("QUEST_MAE_NORTHERN_TRIBE_DESC"),
		difficulty = 'easy',
		bgm = "dungeon",
		background = 'forest4',
		custom_background = 'combat_forest',
	...
	quest_jean_demon_location = {
		code = 'quest_jean_demon_location',
		type = 'encounter',
		name = tr("QUEST_JEAN_DEMON_LOCATION_TEXT"),
		area = 'empire',
		classname = '',
		descript = tr("QUEST_JEAN_DEMON_LOCATION_DESC"),
		difficulty = 'easy',
		bgm = "dungeon",
		background = 'combat_volcano',
		custom_background = 'combat_volcano',
		enemyarray =  [],
		eventarray = [],
		levels = [1,1],
	...
	quest_lira_grove_location = {
		code = 'quest_lira_grove_location',
		type = 'encounter',
		name = tr("QUEST_LIRA_GROVE_LOCATION_TEXT"),
		area = 'forests',
		classname = '',
		descript = tr("QUEST_LIRA_GROVE_LOCATION_DESC"),
		difficulty = 'easy',
		background = 'forest3',
		custom_background = 'combat_forest',
		enemyarray = [],
	...
	quest_lira_road_location = {
		code = 'quest_lira_road_location',
		type = 'encounter',
		name = tr("LIRA_QUEST3_ROAD_LOCATION_NAME"),
		area = 'plains',
		classname = '',
		descript = tr("LIRA_QUEST3_ROAD_LOCATION_DESC"),
		difficulty = 'easy',
		background = 'forest3',
		custom_background = 'combat_forest',
		enemyarray = [],
	...
	quest_lira_bandits_den = {
		code = 'quest_lira_bandits_den',
		type = 'dungeon',
		name = tr("LIRA_QUEST3_DEN_LOCATION_NAME"),
		area = 'plains',
		classname = '',
		descript = tr("LIRA_QUEST3_DEN_LOCATION_DESC"),
		character_data = {
			chance_mod = 1.5,
			races = [['local', 3], ['common',5], ['uncommon',1]]
		},
	...
	quest_kharzug_deep = {
		code = 'quest_kharzug_deep',
		type = 'encounter',
		name = tr("QUEST_KHARZUG_DEEP_TEXT"),
		classname = '',
