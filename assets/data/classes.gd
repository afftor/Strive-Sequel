...
var professions = {
	...
	alchemist = {
		...
		categories = ['labor'],
		showupreqs = [],
		reqs = [{code = 'has_any_profession', value = ['apprentice', 'scholar']},{code = 'stat', stat = 'wits', operant = 'gte', value = 25}],
...
#	},
	...
	sextoy = {
		...
		statchanges = {sexuals_bonus = 15, sexuals_factor = 1, timid_factor = 1, mod_pros = 0.5},
		traits = [],#'sextoy'],
		skills = ['sharedtoy'],
		combatskills = ['endure'],
		conflict_classes = [],
	...
	caster = {
		...
		reqs = [{code = 'stat', stat = 'wits', operant = 'gte', value = 40}],
	...
	druid = {
		...
		reqs = [{code = 'has_any_profession', value = ['apprentice', 'scholar']},{code = 'stat', stat = 'wits', operant = 'gte', value = 80}, {code = 'one_of_races', value = ['Elf','TribalElf','DarkElf','Dryad','Fairy']}],
	...
	archmage = {
		...
		reqs = [{code = 'stat', stat = 'wits', operant = 'gte', value = 90},{code = 'has_profession', profession = 'apprentice', check = true},{code = 'has_profession', profession = 'scholar', check = true}],
	...
	technomancer = {
		...
		categories = ['combat','magic'],
		showupreqs = [],
		reqs = [{code = 'stat', stat = 'wits', operant = 'gte', value = 50},{code = 'has_profession', profession = 'engineer', check = true}],
	...
	priest = {
		...
		reqs = [{code = 'has_profession', profession = 'acolyte', check = true},{code = 'stat', stat = 'wits', operant = 'gte', value = 40}],
	...
	bishop = {
		...
		traits = ['advanced_spells','healer2'],
		skills = ['praise'],
	...
	monk = {
		...
		categories = ['combat','magic'],
		showupreqs = [],
		reqs = [{code = 'has_profession', profession = 'acolyte', check = true},{code = 'stat', stat = 'physics', operant = 'gte', value = 30}],
