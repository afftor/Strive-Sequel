...
#	},
	...
	alios_champion = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 20, wits_bonus = 15, price = 500, chg_wisdom_max = 1, mastery_air = 3, mastery_light = 1, disabled_masteries = ['dark']},
		traits = ['alios'],
		skills = [],
	...
	nixx_champion = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 10, hpmax = 25, resist_dark = 75, price = 500, chg_wisdom_max = 1, chg_dexterity_max = 1, mastery_dark = 3, mastery_stealth = 2, disabled_masteries = ['light']},
