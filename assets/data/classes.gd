...
#	},
	...
	archmage = {
		...
		reqs = [{code = 'stat', stat = 'wits', operant = 'gte', value = 75},{code = 'has_profession', profession = 'apprentice', check = true},{code = 'has_profession', profession = 'scholar', check = true}],
	...
	acolyte = {
		...
		tags = [],
		categories = ['combat','magic'],
		showupreqs = [{code = "class_unlocked", class = 'acolyte', operant = 'eq', check = true}],
		reqs = [],
