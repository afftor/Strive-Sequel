...
var professions = {
	...
	alchemist = {
		...
		traits = ['alchemist', 'master_alchemist'],
		skills = [],
	...
	harlot = {
		...
		showupreqs = [],
		reqs = [{code = 'stat', stat = 'sexuals_factor', operant = 'gte', value = 3}, {code = 'has_profession', profession = 'geisha', check = false}],
		statchanges = {sex_stamina = 1, mod_pros = 0.2, chg_persuasion_max = 1},
		traits = ['harlot'],
		skills = [],
		combatskills = [],
		conflict_classes = ['geisha'],
	},
	geisha = {
		code = 'geisha',
		name = '',
		...
		categories = ['social', 'sexual'],
		showupreqs = [],
		reqs = [{code = 'stat', stat = 'charm', operant = 'gte', value = 40},{code = 'has_profession', profession = 'harlot', check = false}],
		statchanges = {charm_bonus = 5, wits_bonus = 5, price = 200, mod_hostess = 0.2, chg_persuasion_max = 1},
		traits = ['courtesan'],
		skills = [],
		combatskills = [],
		conflict_classes = ['harlot'],
	},
	succubus = {
		code = 'succubus',
		name = '',
		...
		tags = ['permanent', 'cant_spawn'],
		categories = ['social', 'sexual'],
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [],
		combatskills = ['euphoria_apply'],
		statchanges = {sex_stamina = 2, trainee_amount = 1, mastery_point_magic = 1}, #charm_bonus = 5, chg_persuasion_max = 1,
	...
	succubus_old = {
		...
		tags = ['obsolete'],
		categories = ['social', 'sexual'],
		showupreqs = [{code = 'race', check = false, race = 'Demon'}, {code = 'disabled', check = true}],
		reqs = [{code = 'stat', stat = 'sexuals_factor', operant = 'gte', value = 4},{code = 'stat', stat = 'charm_factor', operant = 'gte', value = 3},{code = 'has_profession', profession = 'harlot', check = true},{code = 'race', check = false, race = 'Demon'}, {code = 'disabled', check = true}],
		combatskills = ['euphoria_apply'],
		statchanges = {sex_stamina = 2, charm_bonus = 5, chg_persuasion_max = 1, trainee_amount = 1, mastery_point_magic = 1},
		traits = ['succubus', 'trainer'],
	...
	true_succubus_old = { #obsolete
		...
		tags = ['obsolete'],
		categories = ['social', 'sexual'],
		showupreqs = [{code = 'race', check = true, race = 'Demon'}, {code = 'disabled', check = true}],
		reqs = [{code = 'stat', stat = 'sexuals_factor', operant = 'gte', value = 4},{code = 'stat', stat = 'charm_factor', operant = 'gte', value = 3},{code = 'has_profession', profession = 'harlot', check = true},{code = 'race', check = true, race = 'Demon'}, {code = 'disabled', check = true}],
		combatskills = ['euphoria_apply'],
		statchanges = {sex_stamina = 2, charm_bonus = 10, mpmax = 10, chg_persuasion_max = 1, trainee_amount = 3, mastery_point_magic = 1, mastery_mind = 1},
	...
	pet = {
		...
		statchanges = {charm_bonus = 10, mod_pros = 0.2, price = 100, manhunt = 1, desirability_bonus = 10},
		traits = [],
		skills = [],
		combatskills = [],
	...
	petbeast = {
		...
		statchanges = {charm_bonus = 15, sex_stamina = 1, mod_pros = 0.3, price = 150, manhunt = 1, desirability_bonus = 15},
		traits = ['petbeast'],
		skills = [],
		combatskills = [],
	...
	sextoy = {
		...
		reqs = [{code = 'has_any_profession', value = ['pet','petbeast'], check = true}, {code = 'has_profession', profession = 'harlot', check = true}, {code = 'stat', stat = 'sexuals_factor', operant = 'gte', value = 4}, {code = 'stat', stat = 'consent', operant = 'gte', value = 4}],
		statchanges = {sex_stamina = 2, mod_pros = 0.2, price = 100},
		traits = [],#'sextoy'],
		skills = [],#'sharedtoy'],
		combatskills = [],
		conflict_classes = [],
	...
	dancer = {
		...
		statchanges = {charm_bonus = 10, price = 100, mod_dancer = 0.3, mod_strip = 0.3, chg_persuasion_max = 1},
		traits = [],
	...
	rogue = {
		...
		name = '',
		descript = '',
		icon = load("res://assets/images/iconsclasses/rogue.png"),
		tags = [],
		categories = ['combat'],
		showupreqs = [],
		reqs = [{code = 'stat', stat = 'physics_factor', operant = 'gte', value = 3}],
	...
	assassin = {
		...
		statchanges = {speed = 10, evasion = 25, hpmax = 10, critmod = 0.15, chg_dexterity_max = 1, mastery_point_combat = 2, mastery_stealth = 1},
		traits = ['assassin'],
		skills = [],
		combatskills = [],
		conflict_classes = [],
	...
	ashmedai_champion = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {charm_bonus = 10, sex_stamina = 1, chg_persuasion_max = 1, mastery_dark = 2, mastery_point_magic = 1},
		traits = [],
		skills = [],
		combatskills = ['euphoria_apply'],
		conflict_classes = [],
	...
	ninja = {
		...
		statchanges = {mdef = 10, atk = 5, chg_dexterity_max = 1, mastery_point_combat = 1, mastery_stealth = 1},
		traits = ['ninja'],
		skills = [],
		combatskills = [],
		conflict_classes = [],
	...
	nixx_champion = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 10, hpmax = 25, resist_dark = 75, chg_wisdom_max = 1, chg_dexterity_max = 1, mastery_dark = 2, mastery_stealth = 1, disabled_masteries = ['light']},
	...
	satori = {
		...
		name = '',
		descript = '',
		icon = load("res://assets/images/iconsclasses/kuro_class.png"),
		tags = ['permanent'],
		categories = ['magic','combat'],
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 10, hpmax = 25, resist_dark = 50, chg_wisdom_max = 2, mastery_dark = 3, mastery_stealth = 1, disabled_masteries = ['light'], damage_reduction = 30},
		traits = ['nixx_champion2'],
		skills = [],
		combatskills = ['void_barrage'],
		conflict_classes = [],
	},
	asura = {
		...
		name = '',
		descript = '',
		icon = load("res://assets/images/iconsclasses/kuro_mc_class.png"),
		tags = ['permanent'],
		categories = ['magic','combat'],
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 10, hpmax = 25, resist_dark = 20, chg_wisdom_max = 1, mastery_dark = 2, mastery_stealth = 1, disabled_masteries = ['light'], damage_reduction = 15},
		traits = ['nixx_champion2'],
		skills = [],
		combatskills = ['void_barrage'],
		conflict_classes = [],
