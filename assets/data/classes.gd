...
#	},
	...
	nixx_champion2 = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 10, hpmax = 25, resist_dark = 50, price = 500, chg_wisdom_max = 2, mastery_dark = 3, mastery_stealth = 1, disabled_masteries = ['light'], damage_reduction = 50},
	...
	nixx_champion3 = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 10, hpmax = 25, resist_dark = 20, price = 500, chg_wisdom_max = 1, mastery_dark = 2, mastery_stealth = 1, disabled_masteries = ['light'], damage_reduction = 20},
		traits = ['nixx_champion2'],
		skills = [],
		combatskills = [],
		conflict_classes = [],
