...
#	},
	...
	knight = {
		...
		categories = ['combat'],
		showupreqs = [],
		reqs = [{code = 'stat', stat = 'physics', operant = 'gte', value = 60},{code = 'has_profession', profession = 'fighter', check = true}],
	...
	druid = {
		...
		reqs = [{code = 'has_any_profession', value = ['apprentice', 'scholar']},{code = 'stat', stat = 'magic_factor', operant = 'gte', value = 3}, {code = 'one_of_races', value = ['Elf','DarkElf','Drow','Dryad','Fairy']}],
