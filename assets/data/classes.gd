...
#	},
	...
	succubus = {
		...
		statchanges = {sexuals_bonus = 15, charm_bonus = 5, chg_persuasion_max = 1},
		traits = ['succubus'],
	...
	true_succubus = {
		...
		statchanges = {sexuals_bonus = 15, charm_bonus = 10, mpmax = 10, chg_persuasion_max = 1},
	...
	dominator = {
		...
		statchanges = {charm_bonus = 15, mpmax = 10, resist_mind = 20, chg_persuasion_max = 1},
		traits = ['advanced_spells'],
	...
	bard = {
		...
		statchanges = {charm_bonus = 15, speed = 3, mod_dancer = 0.2, mod_hostess = 0.2, chg_persuasion_max = 1},
		traits = ['basic_combat'],
		skills = [],
