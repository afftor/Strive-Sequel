...
var professions = {
	...
	smith = {
		...
		reqs = [{code = 'stat', stat = 'physics', operant = 'gte', value = 25}],
		statchanges = {physics_bonus = 10, hpmax = 15, mod_smith = 1.0, mod_tailor = 1.0, chg_strength_max = 1},
		traits = [],#'smith'],
		skills = [],
	...
	alchemist = {
		...
		statchanges = {wits_bonus = 10, mod_alchemy = 1.0, chg_wisdom_max = 1},
		traits = ['alchemist'],
		skills = [],
...
#	},
	harlot = {
		...
		statchanges = {sexuals_bonus = 10, mod_pros = 0.5, chg_charm_max = 1},
		traits = [], #'harlot'],
		skills = ['rewardsex'],
	...
	geisha = {
		...
		statchanges = {charm_bonus = 5, wits_bonus = 5, price = 200, mod_hostess = 0.5, chg_charm_max = 1},
		traits = [],
		skills = ['rewardsex'],
		combatskills = [],
		conflict_classes = [],
	...
	succubus = {
		...
		statchanges = {sexuals_bonus = 15, charm_bonus = 5, chg_charm_max = 1},
		traits = ['succubus'],
	...
	true_succubus = {
		...
		statchanges = {sexuals_bonus = 15, charm_bonus = 10, mpmax = 10, chg_charm_max = 1},
	...
	dancer = {
		...
		statchanges = {charm_bonus = 10, price = 100, mod_dancer = 0.5, mod_strip = 0.5, chg_charm_max = 1},
		traits = [],
	...
	fighter = {
		...
		showupreqs = [],
		reqs = [{code = 'stat', stat = 'physics_factor', operant = 'gte', value = 3}],
		statchanges = {physics_bonus = 5, hpmax = 15, speed = 5, chg_strength_max = 1},
	...
	knight = {
		...
		statchanges = {hpmax = 30, armor = 5, speed = 5, chg_strength_max = 1},
	...
	berserker = {
		...
		statchanges = {hpmax = 20, physics_bonus = 10, speed = 5, chg_strength_max = 1},
	...
	scholar = {
		...
		showupreqs = [],
		reqs = [{code = 'stat', stat = 'wits_factor', operant = 'gte', value = 3}],
		statchanges = {mpmax = 5, chg_wisdom_max = 1},
		traits = ['basic_spells'],
		skills = [],
	...
	dominator = {
		...
		statchanges = {charm_bonus = 15, mpmax = 10, resist_mind = 20, chg_charm_max = 1},
		traits = ['advanced_spells'],
	...
	druid = {
		...
		statchanges = {wits_bonus = 10, hpmax = 5, resist_earth = 20, chg_wisdom_max = 1},
	...
	necromancer = {
		...
		statchanges = {mpmax = 15, wits_bonus = 10, resist_dark = 25, damage_mod_dark = 0.2, chg_wisdom_max = 1},
	...
	rogue = {
		...
		showupreqs = [],
		reqs = [{code = 'stat', stat = 'physics_factor', operant = 'gte', value = 3}],
		statchanges = {critchance = 3, speed = 5, evasion = 10, chg_dexterity_max = 1},
	...
	thief = {
		...
		statchanges = {evasion = 10, wits_bonus = 5, chg_dexterity_max = 2},
	...
	assassin = {
		...
		statchanges = {speed = 10, evasion = 25, hpmax = 10, critmod = 0.25, chg_dexterity_max = 1},
	...
	engineer = {
		...
		statchanges = {wits_bonus = 5, hpmax = 5, hitrate = 10, mod_build = 1.0, chg_dexterity_max = 1},
	...
	paladin = {
		...
		statchanges = {armor = 8, hpmax = 20, resist_dark = 10, resist_light = 10, chg_strength_max = 1},
	...
	shaman = {
		...
		statchanges = {hpmax = 10, wits_bonus = 5, mpmax = 12, chg_wisdom_max = 1},
		traits = ['basic_spells'],
		skills = [],
	...
	ranger = {
		...
		statchanges = {hpmax = 10, chg_dexterity_max = 1},
	...
	bard = {
		...
		statchanges = {charm_bonus = 15, speed = 3, mod_dancer = 0.2, mod_hostess = 0.2, chg_charm_max = 1},
		traits = ['basic_combat'],
		skills = [],
	...
	archmage = {
		...
		statchanges = {wits_bonus = 10, mdef = 5, chg_wisdom_max = 1},
		traits = ['advanced_spells'],
		skills = [],
		combatskills = ['l_orb'],
		conflict_classes = [],
	...
	battlesmith = {
		...
		statchanges = {hpmax = 20, physics_bonus = 15, mod_smith = 0.5, chg_strength_max = 1},
		traits = ['basic_combat'],
		skills = [],
	...
	technomancer = {
		...
		statchanges = {mpmax = 10, damage_mod_air = 0.25, wits_bonus = 10, chg_wisdom_max = 1},
		traits = ['basic_spells'],
		skills = [],
	...
	priest = {
		...
		statchanges = {wits_bonus = 5, hpmax = 10, mpmax = 10, chg_wisdom_max = 1},
		traits = ['basic_spells'],
		skills = [],
		combatskills = ['bless'],
		conflict_classes = [],
	...
	bishop = {
		...
		statchanges = {wits_bonus = 10, mpmax = 20, chg_wisdom_max = 1},
	...
	monk = {
		...
		statchanges = {physics_bonus = 5, armorpenetration = 10, hpmax = 10, chg_dexterity_max = 1},
		traits = ['basic_combat'],
		skills = [],
	...
	renown_royalty = {
		...
		statchanges = {charm_bonus = 15, price = 1500, chg_charm_max = 1},
		traits = ['renown'],
	...
	alios_champion = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 20, wits_bonus = 15, price = 500, chg_wisdom_max = 1},
	...
	deathknight = {
		...
		statchanges = {hpmax = 10, resist_light = 20, speed = 5, chg_strength_max = 1},
	...
	warlock = {
		...
		statchanges = {mpmax = 10, wits_bonus = 10, chg_wisdom_max = 1},
	...
	witch = {
		...
		statchanges = {wits_bonus = 10, mod_alchemy = 0.25, chg_wisdom_max = 1},
	...
	ninja = {
		...
		statchanges = {evasion = 10, mdef = 10, atk = 5, chg_dexterity_max = 1},
