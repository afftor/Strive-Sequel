...
#	},
	...
	dragonknight = {
		...
		statchanges = {hpmax = 25, physics_bonus = 15, resist_fire = 35, speed = 3, damage_mod_fire = 0.25, mastery_point_combat = 2, mastery_fire = 1},
		traits = ['advanced_combat','heavy_armor'],
		skills = [],
	...
	berserker = {
		...
		statchanges = {hpmax = 20, physics_bonus = 10, speed = 5, chg_strength_max = 1, mastery_warfare = 3},
	...
	dominator = {
		...
		statchanges = {charm_bonus = 15, mpmax = 10, resist_mind = 20, chg_persuasion_max = 1, trainee_amount = 2, mastery_mind = 2,  mastery_point_magic = 2},
		traits = ['advanced_spells', 'trainer'],
	...
	druid = {
		...
		statchanges = {wits_bonus = 10, hpmax = 5, resist_earth = 20, chg_wisdom_max = 1, mastery_earth = 1, mastery_water = 1,  mastery_point_magic = 2},
	...
	bloodmage = {
		...
		statchanges = {hpmax = 20, mastery_point_magic = 3},
	...
	valkyrie = {
		...
		statchanges = {hpmax = 15, physics_bonus = 15, speed = 5, resist_air = 20, mastery_point_combat = 3},
	...
	souleater = {
		...
		statchanges = {damage_mod_mind = 0.2, mastery_point_magic = 2},
		traits = ['advanced_spells'],
	...
	necromancer = {
		...
		statchanges = {mpmax = 15, wits_bonus = 10, resist_dark = 25, damage_mod_dark = 0.2, chg_wisdom_max = 1, mastery_dark = 2, mastery_point_magic = 2},
	...
	sniper = {
		...
		statchanges = {hitrate = 25, critchance = 3, speed = 10, mastery_point_combat = 2, mastery_marksmanship = 2},
	...
	assassin = {
		...
		statchanges = {speed = 10, evasion = 25, hpmax = 10, critmod = 0.25, chg_dexterity_max = 1, mastery_point_combat = 2, mastery_stealth = 2},
	...
	templar = {
		...
		statchanges = {wits_bonus = 5, hpmax = 10, resist_mind = 15, damage_mod_light = 0.2, mastery_point_universal = 2, mastery_light = 1, mastery_fire = 1},
	...
	paladin = {
		...
		statchanges = {armor = 8, hpmax = 20, resist_dark = 10, resist_light = 10, chg_strength_max = 1, mastery_protection = 2, mastery_light = 1, mastery_point_combat = 2},
	...
	shaman = {
		...
		statchanges = {hpmax = 10, wits_bonus = 5, mpmax = 12, chg_wisdom_max = 1, mastery_point_magic = 3},
		traits = ['basic_spells'],
		skills = [],
	...
	archmage = {
		...
		statchanges = {wits_bonus = 10, mdef = 5, chg_wisdom_max = 1, mastery_point_magic = 4},
		traits = ['advanced_spells'],
		skills = [],
		combatskills = [],
		conflict_classes = [],
	...
	battlesmith = {
		...
		statchanges = {hpmax = 20, physics_bonus = 15, mod_smith = 0.5, chg_strength_max = 1, mastery_point_combat = 2},
		traits = ['basic_combat'],
		skills = [],
	...
	acolyte = {
		...
		showupreqs = [],
		reqs = [],
		statchanges = {hpmax = 5, mpmax = 5, mastery_light = 2,  mastery_point_magic = 1},
	...
	bishop = {
		...
		statchanges = {wits_bonus = 10, mpmax = 20, chg_wisdom_max = 1, mastery_light = 2, mastery_point_magic = 2},
	...
	renown_royalty = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {charm_bonus = 15, price = 1500, chg_persuasion_max = 1, mastery_leadership = 3},
		traits = [],
		skills = [],#'allure'],
		combatskills = [],
		conflict_classes = [],
	...
	broken_royalty = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mod_pros = 2, price = 500, enable_mastery_leadership = false},
	...
	alios_champion = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 20, wits_bonus = 15, price = 500, chg_wisdom_max = 1, mastery_air = 3, mastery_light = 1, enable_mastery_dark = false},
	...
	freyas_priestess = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {wits_bonus = 10, mpmax = 15, price = 750, chg_wisdom_max = 1, mastery_light = 2, mastery_earth = 1, mastery_point_magic = 2},
	...
	ashmedai_champion = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {charm_bonus = 10, sexuals_bonus = 10, chg_persuasion_max = 1, mastery_dark = 3, mastery_point_magic = 2},
		traits = ['basic_spells','advanced_spells'],
		skills = [],
		combatskills = ['euphoria_apply'],
		conflict_classes = [],
	...
	deathknight = {
		...
		statchanges = {hpmax = 10, resist_light = 20, speed = 5, chg_strength_max = 1, mastery_point_universal = 2, mastery_warfare = 2},
	...
	warlock = {
		...
		statchanges = {mpmax = 10, wits_bonus = 10, chg_wisdom_max = 1, mastery_point_magic = 3, mastery_dark = 2},
	...
	witch = {
		...
		statchanges = {wits_bonus = 10, mod_alchemy = 0.25, chg_wisdom_max = 1, mastery_point_magic = 3, mastery_dark = 1, mastery_water = 1},
	...
	ninja = {
		...
		statchanges = {evasion = 10, mdef = 10, atk = 5, chg_dexterity_max = 1, mastery_point_combat = 1, mastery_stealth = 2},
	...
	nixx_champion = {
		...
		showupreqs = [{code = 'disabled', check = true}],
		reqs = [{code = 'cant_spawn_naturally'}],
		statchanges = {mpmax = 10, hpmax = 25, resist_dark = 75, price = 500, chg_wisdom_max = 1, chg_dexterity_max = 1, mastery_dark = 3, mastery_stealth = 2, enable_mastery_light = false},
