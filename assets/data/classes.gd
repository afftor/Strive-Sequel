...
var professions = {
	...
	harlot = {
		...
		statchanges = {sex_stamina = 1, mod_pros = 0.5, chg_persuasion_max = 1},
		traits = [], #'harlot'],
		skills = [],
		combatskills = [],
		conflict_classes = [],
	...
	geisha = {
		...
		categories = ['social', 'sexual'],
		showupreqs = [],
		reqs = [{code = 'stat', stat = 'charm', operant = 'gte', value = 40},{code = 'has_profession', profession = 'harlot', check = true}],
	...
	petbeast = {
		...
		statchanges = {charm_bonus = 15, sex_stamina = 1, mod_pros = 0.3, price = 150, manhunt = 1},
		traits = [],
		skills = [],
		combatskills = [],
	...
	sextoy = {
		...
		statchanges = {sex_stamina = 2, mod_pros = 0.5, price = 300},
		traits = [],#'sextoy'],
		skills = [],#'sharedtoy'],
		combatskills = [],
		conflict_classes = [],
