...
var professions = {
	...
	ruler = {
		...
		statchanges = {hpmax = 20, trainee_amount = 3},
		traits = ['trainer'],
		skills = [],#'supremacy'],
	...
	farmer = {
		...
		showupreqs = [],
		reqs = [],
		statchanges = {hpmax = 15, mod_farm = 0.5, mod_collect = 0.5, mod_cook = 0.2},
		traits = [], #'farmer'],
		skills = [],
		combatskills = [],
		conflict_classes = [],
...
#	},
	...
	succubus = {
		...
		statchanges = {sexuals_bonus = 15, charm_bonus = 5, chg_persuasion_max = 1, trainee_amount = 1},
	...
	true_succubus = {
		...
		statchanges = {sexuals_bonus = 15, charm_bonus = 10, mpmax = 10, chg_persuasion_max = 1, trainee_amount = 3},
	...
	dominator = {
		...
		statchanges = {charm_bonus = 15, mpmax = 10, resist_mind = 20, chg_persuasion_max = 1, trainee_amount = 2},
	...
	bard = {
		...
		statchanges = {charm_bonus = 15, speed = 3, mod_service = 0.25, mod_dancer = 0.2, mod_hostess = 0.2, chg_persuasion_max = 1}, #idk if dancer and hostess should remain after service add
		traits = ['basic_combat'],
		skills = [],
	...
	renown_royalty = {
		...
		statchanges = {charm_bonus = 15, price = 1500, chg_persuasion_max = 1},
		traits = [],
		skills = [],#'allure'],
		combatskills = ['command'],
		conflict_classes = [],
