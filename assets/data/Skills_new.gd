...
var skills_icon_dict = {
	
	draw_blood = load("res://assets/images/iconsskills/Lich-strike.png"),
	sunder = load("res://assets/images/iconsskills/icon_elementa_weakness.png"),
	cleave = load("res://assets/images/iconsskills/swipe.png"),
	strike_through = load("res://assets/images/iconsskills/Aimed-strike.png"), 
	execution = load(""),
	
	taunt = load("res://assets/images/iconsskills/Protect.png"),
	disarm_enemy = load(""),
	provocation = load("res://assets/images/iconsskills/taunt.png"),
	stonewall = load("res://assets/images/iconsskills/icon_endure.png"),
	last_stand = load(""),
	
	hide = load("res://assets/images/iconsskills/icon_eyes.png"),
	dip_poison = load(""),
	backkick = load(""),
	assassinate = load("res://assets/images/iconsskills/assassinate.png"),
	devastation = load("res://assets/images/iconsskills/windblade.png"),
	
	strafe = load("res://assets/images/iconsskills/heavyshot.png"),
	trap = load("res://assets/images/iconsskills/Trap.png"),
	ensnare = load(""),
	bolt_trap = load(""),
	arrow_rain = load("res://assets/images/iconsskills/arrowshower.png"),
	
	first_aid = load("res://assets/images/iconsskills/HealBandage.png"),
	inspire = load("res://assets/images/iconsskills/Inspire.png"),
	leadersmark = load("res://assets/images/iconsskills/Command.png"),
	intimidating_presence = load("res://assets/images/iconsskills/Fear.png"),
	stun_immunity = load("res://assets/images/iconsskills/Authority.png"),
	rally = load(""),
	
	firearr = load("res://assets/images/iconsskills/firebolt.png"),
	bloodboil = load(""),
	flame_sphere = load("res://assets/images/iconsskills/firestorm.png"),
	fire_shield = load(""),
	magma_blast = load(""),
	inferno = load("res://assets/images/iconsskills/FireBomb.png"),
	
	rejuvenation = load("res://assets/images/iconsskills/Heal.png"),
	water_edge = load("res://assets/images/iconsskills/wateredge.png"),
	water_shield = load(""),
	frost_prison = load("res://assets/images/iconsskills/Barrier.png"),
	clarity = load("res://assets/images/iconsskills/Mindread.png"),
	blizzard = load("res://assets/images/iconsskills/icon_ice.png"),
	hailstorm = load(""),
	
	earth_shield = load(""),
	acid_bomb = load("res://assets/images/iconsskills/AcidBomb.png"),
	natures_gift = load(""),
	overgrowth = load("res://assets/images/iconsskills/icon_plant.png"),
	earthquake = load("res://assets/images/iconsskills/icon_earthquake.png"),
	teleport = load("res://assets/images/iconsskills/icon_teleportation.png"),
	disintegrate = load(""),
	
	windblade = load("res://assets/images/iconsskills/windblade.png"),
	lightning = load("res://assets/images/iconsskills/icon_lightning.png"),
	haste = load("res://assets/images/iconsskills/tackle.png"),
	windwhispers = load("res://assets/images/iconsskills/meditate.png"),
	chain_lightning = load("res://assets/images/iconsskills/Drain.png"),
	air_shield = load(""),
	tempest = load("res://assets/images/iconsskills/icon_energy_field.png"),
	eyeofthestorm = load("res://assets/images/iconsskills/Innervate.png"),
	
	healing = load("res://assets/images/iconsskills/restoration.png"),
	blessing = load("res://assets/images/iconsskills/icon_light.png"),
	resurrection = load("res://assets/images/iconsskills/icon_reincarnation.png"),
	elemental_protection = load("res://assets/images/iconsskills/icon_elemental_protection.png"),
	pacify = load("res://assets/images/iconsskills/Serve2.png"),
	radiance = load("res://assets/images/iconsskills/light_spell.png"),
	mass_resurrection = load("res://assets/images/iconsskills/light_spell_aoe.png"),
	
	darkness = load("res://assets/images/iconsskills/icon_dark.png"),
	black_tendrils = load(""),
	malediction = load("res://assets/images/iconsskills/icon_elementa_weakness.png"),
	devour_magic = load("res://assets/images/iconsskills/ManaDrain.png"),
	veil = load(""),
	"void" : load(""),
	
	mindread = load("res://assets/images/iconsskills/Mindread.png"),
	influence = load("res://assets/images/iconsskills/Warn.png"),
	mindblast = load("res://assets/images/iconsskills/slash.png"),
	invigorate = load("res://assets/images/iconsskills/lesserheal.pngg"),
	stronginfluence = load("res://assets/images/iconsskills/Charm.png"),
	mindshatter = load("res://assets/images/iconsskills/Mindblast.png"),
	domination = load("res://assets/images/iconsskills/Mind_Control.png"),
}
