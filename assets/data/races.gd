...
#			hair_base_color_1 = ['g','red_1', 'red_2', 'red_3','brown_1','brown_2', 'brown_3', 'black_1', 'black_2', 'black_3'],
	...
	Centaur = {
		...
		race_bonus = {hpfactor = 1.6, mastery_point_combat = 1, disabled_masteries = ['stealth'], price = 115},
	...
	Slime = {
		...
		race_bonus = {hpfactor = 1.1, mastery_water = 2, disabled_masteries = ['fire'], resist_normal = 30, price = 105},
	...
	Nereid = {
		...
		race_bonus = {hpfactor = 0.85, mod_fish = 0.2, mastery_water = 2, disabled_masteries = ['air'], price = 140},
