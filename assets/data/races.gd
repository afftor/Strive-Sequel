...
var racelist = {
	...
	Elf = {
		...
		race_bonus = {hpmax_mul2 = 0.9, hitrate = 10, mastery_marksmanship = 1, price = 150},
	...
	TribalElf = {
		...
		race_bonus = {hpmax_mul2 = 1.0, hitrate = 5, mastery_fire = 1, price = 130},
	...
	DarkElf = {
		...
		race_bonus = {hpmax_mul2 = 1.1, matk = 5, mastery_dark = 1, price = 165},
...
#			hair_base_color_1 = ['g','red_1', 'red_2', 'red_3','brown_1','brown_2', 'brown_3', 'black_1', 'black_2', 'black_3'],
	...
	Demon = {
		...
		race_bonus = {hpmax_mul2 = 1.3, resist_dark = 15, mastery_fire = 1, price = 200},
	...
	BeastkinBunny = {
		...
		basestats = {
			...
			magic_factor = [1,3],
			tame_factor = [4,5],
			authority_factor = [5,5],
			sexuals_factor = [4,6],
			charm_factor = [2,5],
			wits_factor = [1,2],
		},
		race_bonus = {hpmax_mul2 = 1, sexuals_bonus = 5, mastery_point_magic = 1, price = 100},
