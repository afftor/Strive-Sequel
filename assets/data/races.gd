...
var racelist = {
	...
	Kobold = {
		...
		race_bonus = {hpfactor = 0.75, mod_collect = 0.1, damage_mod_melee = -0.1, evasion = 15},
		personality = {kind = 0.5, bold = 1, shy = 0.3, serious = 0.5},
	...
	Gnome = {
		...
		race_bonus = {hpfactor = 0.7, evasion = 20, damage_mod_melee = -0.1, mod_collect = -0.1},
	...
	Fairy = {
		...
		race_bonus = {hpfactor = 0.65, matk = 8, damage_mod_melee = -0.2, evasion = 25, mod_collect = -0.2},
