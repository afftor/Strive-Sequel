...
var racelist = {
	Human = {
		...
		bodyparts = {
			...
			chin = ['default', 'curve', 'small', 'skinny', 'short', 'loli', 'male', 'muscle'],
			eye_tex = ['eyes1', 'eyes2', 'eyes3', 'eyes4', 'eyes5', 'eyes1m', 'eyes2m', 'eyes3m', 'eyes4m', 'eyes5m'],
			eyeshape = ['face1','face2','face3','face4','face5','face6','face7','face8','face_m1','face_m2','face_m3','face_m4','face_m5',],
			...
			beard = [['no',20],['style1',1], ['style2',1], ['style3',1], ['style4',1], ['style5',1], ['style6',1], ['style7',1], ['style8',1], ['style9',1], ['style10',1], ['style11',1], ['style12',1], ['style13',1], ['style14',1], ['style15',1], ['style16',1], ['style17',1]],
			},
	...
	Dwarf = {
		...
		bodyparts = {
			...
			height = ['short','petite'],
			body_shape = ['shortstack'],
			beard = [['style1',1], ['style2',1], ['style3',1], ['style4',1], ['style5',1], ['style6',1], ['style7',1], ['style8',1], ['style9',1], ['style10',1], ['style11',1], ['style12',1], ['style13',1], ['style14',1], ['style15',1], ['style16',1], ['style17',1]],
			},
		global_weight = 60,
	},
	Fairy = {
