...
var traits = {
	core_trait = {#adds core effects
		...
		visible = false,
		icon = null,
		effects = ['e_phy6', 'e_wit6', 'e_charm6', 'e_sex6', 'e_auth6', 'e_tame6', 'e_mag6', 'e_virgin', 'e_person_bold', 'e_person_shy', 'e_person_kind', 'e_person_serious', 'e_love', 'e_friend', 'e_rival', 'e_standing_love_pest', 'e_standing_housemate', 'e_standing_sworn_servant', 'e_standing_beloved', 'work_rule_luxury', 'work_rule_ration', 'work_rule_shifts', 'work_rule_masturbation', 'work_rule_constrain', 'e_pregnancy', 'e_pregnancy1', 'e_pregnancy_breeder', 'e_thrall'],#'e_atkpass'],
#		tags = ['bleed']
	},
...
#	},
	...
	the_ever_adapting_nature = {
		code = 'the_ever_adapting_nature',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['ever_adapting_nature','ever_adapting_nature_burn','ever_adapting_nature_wet'],
		tags = [],
	},
	white_stag_white_fog = {
		code = 'white_stag_white_fog',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['white_fog_apply'],
		tags = [],
	},
	cycle_of_life = {
		code = 'cycle_of_life',
		...
		icon = null,
		visible = false,
		effects = ['cycle_of_life'],
		tags = [],
	},
	kudzu_first_strike = {
		code = 'kudzu_first_strike',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['kudzu_first_strike','kudzu_removed',],
		tags = [],
	},
	cycle_of_life_subject = {
		code = 'cycle_of_life_subject',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['cycle_of_life_affected'],
		tags = [],
	},
	test_of_the_forest_spirit = {
		code = 'test_of_the_forest_spirit',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['test_of_the_forest_spirit_trait','test_concluded'],
		tags = [],
	},
	entrance_animation_hare = {
		code = 'entrance_animation_hare',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['entrance_animation_hare'],
		tags = [],
	},
	entrance_animation_turtle = {
		code = 'entrance_animation_turtle',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['entrance_animation_turtle'],
		tags = [],
	},
	entrance_animation_eagle = {
		code = 'entrance_animation_eagle',
		name = '',
		descript = '',
		icon = null,
		visible = false,
	...
	black_knight_greg = {
		code = 'black_knight_greg',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['black_knight_greg','black_knight_greg_display'],
		tags = [],
	},
	lonesome_rage_bygone_glory = {
		code = 'lonesome_rage_bygone_glory',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['lonesome_rage_bygone_glory_display','lonesome_rage','bygone_glory','bygone_glory_1'],
		tags = [],
	},
	demonness_gift_null_cloak = {
		code = 'demonness_gift_null_cloak',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['demonness_gift_null_cloak'],
		tags = [],
	},
	trinket_smokebomb = {
		code = 'trinket_smokebomb',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['trinket_smokebomb'],
		tags = [],
	},
	greg_final_stand = {
		code = 'greg_final_stand',
		name = '',
		descript = '',
		icon = null,
		visible = false,
		effects = ['greg_final_stand','ridicluous_grit_apply'],
		tags = [],
	},
	greg_relation  = {
		code = 'greg_relation',
