...
#	},
	...
	handy = {
		...
		effects = [],
		bonusstats = {mod_tailor = 0.2, mod_smith = 0.2, mod_alchemy = 0.2, mod_cook = 0.2, mod_build = 0.2},
		weight = 100,
	...
	inept = {
		...
		icon = "res://assets/images/iconstraits/hammer.png",
		effects = [],
		bonusstats = {mod_tailor = -0.8, mod_smith = -0.8, mod_alchemy = -0.8, mod_cook = -0.8, mod_build = -0.8},
		weight = 100,
