...
var traits = {
	core_trait = {#adds core effects
		...
		visible = false,
		icon = null,
		effects = ['e_phy6', 'e_wit6', 'e_charm6', 'e_sex6', 'e_auth6', 'e_tame6', 'e_mag6', 'e_virgin', 'e_person_bold', 'e_person_shy', 'e_person_kind', 'e_person_serious', 'e_love', 'e_friend', 'e_rival', 'work_rule_luxury', 'work_rule_ration', 'work_rule_shifts', 'work_rule_masturbation', 'work_rule_constrain', 'e_pregnancy', 'e_pregnancy1', 'e_pregnancy_breeder', 'e_thrall'],#'e_atkpass'],
#		tags = ['bleed']
	},
