...
#		new_syntax = true,
	...
	fire_cleave = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'burn_new', chance = 0.2, duration = 2})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
...
#		effects = [Effectdata.rebuild_template({effect = 'e_s_shred_old', duration = 3})], #if change to new version - Effectdata.rebuild_template_globals({effect = 'e_s_shred2'})
	...
	scorched_earth = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'burn', chance = 0.3, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_blind', duration = 1})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	enchanting_whisper = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'cursed', duration = 2}), Effectdata.rebuild_template_globals({effect = 'e_s_sleep', chance = 0.3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 4,
	...
	rusty_trap = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'bleed', duration = 2}), Effectdata.rebuild_template({effect = 'poison', duration = 2}), Effectdata.rebuild_template_globals({effect = 'e_s_ensnare2'})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	flash_stone = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_blind', duration = 2, chance = 0.7}), Effectdata.rebuild_template({effect = 'stun', duration = 1, chance = 0.3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	monstrous_grip = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template_globals({effect = 'e_s_ensnare2'}), Effectdata.rebuild_template({effect = 'silence',  duration = 1}), Effectdata.rebuild_template({effect = 'disarm', duration = 1})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 1,
