...
#		effects = [Effectdata.rebuild_template({effect = 'e_s_shred_old', duration = 3})], #if change to new version - Effectdata.rebuild_template_globals({effect = 'e_s_shred2'})
	...
	crippling_bite = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_bleed_new', chance = 0.5,  push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_disarm3', duration = 1})],
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
	...
	blinding_heat = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_silence1', duration = 1}), Effectdata.rebuild_template({effect = 'e_s_stun1', duration = 1}), Effectdata.rebuild_template({effect = Effectdata.rebuild_remove_effect('burn')})], 
		cost = {},
		charges = 0,
		combatcooldown = 2,
		cooldown = 0,
	...
	hot_metal = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template_globals({effect = 'e_s_shred3'}), Effectdata.rebuild_template({effect = 'e_s_burn_new', duration = 2})], 
		cost = {mp = 3},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
	...
	glaciation = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_stun1', duration = 1}), Effectdata.rebuild_template_globals({effect = 'e_s_shred2'}), Effectdata.rebuild_template_globals({effect = 'e_s_shatter2'})],
		cost = {mp = 3},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	north_wind = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_wet'}), Effectdata.rebuild_template({effect = 'e_s_disarm3', duration = 1, chance = 0.3, push_characters = true})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	enchanting_whisper = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_cursed', duration = 2}), Effectdata.rebuild_template({effect = 'e_s_sleep', chance = 0.3, push_characters = true})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 4,
	...
	curse_of_despair = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_disarm3', chance = 0.5, push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_silence1', chance = 0.5, push_characters = true, duration = 2})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
	...
	rusty_trap = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_bleed_new', push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_poison_new', push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_ensnare', push_characters = true, duration = 2})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	sneaky_trick = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_disarm3', push_characters = true, duration = 1}), Effectdata.rebuild_template({effect = 'e_s_shred2', push_characters = true})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	herokiller = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_stun1', push_characters = true, duration = 1})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	flash_stone = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_blind', duration = 2, chance = 0.7, push_characters = true}), Effectdata.rebuild_template({effect = 'e_s_stun1', duration = 1, chance = 0.3, push_characters = true})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	shock_charge = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect =  'e_s_silence1', duration = 1, chance = 0.7, push_characters = true}), Effectdata.rebuild_template({effect = 'e_s_disarm3', duration = 1, chance = 0.7, push_characters = true})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	monstrous_swing = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_stun1', duration = 1, chance = 0.5, push_characters = true})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	monstrous_grip = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_ensnare', push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_silence1', push_characters = true, duration = 1}), Effectdata.rebuild_template({effect = 'e_s_disarm3', push_characters = true, duration = 1})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 1,
	...
	bile_corrosive = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_poison_new', push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_shred3',  push_characters = true})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
