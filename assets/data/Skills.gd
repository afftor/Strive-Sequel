...
#		new_syntax = true,
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_stun', chance = 0.3, duration = 1})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
...
#		new_syntax = true,
	...
	mimic_attack = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_disarm', duration = 3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
	...
	entangle_sa = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_disarm', duration = 1})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
...
#		effects = [Effectdata.rebuild_template({effect = 'e_s_shred_old', duration = 3})], #if change to new version - Effectdata.rebuild_template_globals({effect = 'e_s_shred2'})
	...
	windblast = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_silence', duration = 3, chance = 0.5})], 
		cost = {},
		charges = 0,
		combatcooldown = 1,
		cooldown = 0,
	...
	swipe_en = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = Effectdata.rebuild_make_status({effect = 'e_s_stun', duration = 1})})], 
		cost = {},
		repeat = 2,
		random_target = true,
		charges = 0,
	...
	cleave_w = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_bleed_new', chance = 0.3,  push_characters = true, duration = 2})], 
		cost = {mp = 5},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	crippling_bite = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_bleed_new', chance = 0.5,  push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_disarm', duration = 1})],
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_fear', chance = 0.5,  push_characters = true, duration = 2})],
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
	...
	leadersmark_s = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_hmark', duration = 3}), Effectdata.rebuild_template({effect = 'e_s_burn_new', chance = 0.5, push_characters = true, duration = 3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	fire_lung = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_burn_new', chance = 0.2, duration = 2})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
	...
	purification_by_fire = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_silence', duration = 1}), Effectdata.rebuild_make_status({effect = 'e_s_stun', duration = 1}), Effectdata.rebuild_template({effect = Effectdata.rebuild_remove_effect('burn')})], 
		cost = {},
		charges = 0,
		combatcooldown = 2,
		cooldown = 0,
	...
	hot_metal = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_shred', duration = 3}), Effectdata.rebuild_template({effect = 'e_s_burn_new', duration = 2})], 
		cost = {mp = 3},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
	...
	scorched_earth = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_burn_new', chance = 0.3, push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_blind', duration = 1})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	glaciation = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_make_status({effect = 'e_s_stun', duration = 1}), Effectdata.rebuild_template({effect = 'e_s_shred', duration = 2}), Effectdata.rebuild_template({effect = 'e_s_shatter', duration = 2})],
		cost = {mp = 3},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	north_wind = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_wet'}), Effectdata.rebuild_template({effect = 'e_s_disarm', duration = 1, chance = 0.3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	cruelty = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect =  'e_s_fear', duration = 2})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	hunters_mark = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_hmark', duration = 3}), Effectdata.rebuild_template({effect = 'e_s_fear', duration = 3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	hunting = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_bleed_new', chance = 0.3, push_characters = true, duration = 1})], 
		cost = {},
		repeat = 2,
		charges = 0,
		combatcooldown = 0,
	...
	enchanting_whisper = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_cursed', duration = 2}), Effectdata.rebuild_template_globals({effect = 'e_s_sleep', chance = 0.3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 4,
	...
	curse_of_despair = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_disarm', chance = 0.5, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_silence', chance = 0.5, duration = 2})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
	...
	torture = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_fear', duration = 2}), Effectdata.rebuild_template({effect = 'e_s_bleed_new', duration = 2, chance = 0.5, push_characters = true})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	rusty_trap = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_bleed_new', push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_poison_new', push_characters = true, duration = 2}), Effectdata.rebuild_template_globals({effect = 'e_s_ensnare2'})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	sneaky_trick = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_disarm',  duration = 1}), Effectdata.rebuild_template({effect = 'e_s_shred', duration = 2})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	flash_stone = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_blind', duration = 2, chance = 0.7}), Effectdata.rebuild_template({effect = 'e_s_stun', duration = 1, chance = 0.3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	shock_charge = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect =  'e_s_silence', duration = 1, chance = 0.7}), Effectdata.rebuild_template({effect = 'e_s_disarm', duration = 1, chance = 0.7})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	monstrous_swing = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_stun', duration = 1, chance = 0.5})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	monstrous_grip = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template_globals({effect = 'e_s_ensnare2'}), Effectdata.rebuild_template({effect = 'e_s_silence',  duration = 1}), Effectdata.rebuild_template({effect = 'e_s_disarm', duration = 1})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 1,
	...
	bile_corrosive = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_poison_new', push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_shred',  duration = 3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	pecking = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_bleed_new', chance = 0.5,  push_characters = true, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_fear', chance = 0.7,  push_characters = true, duration = 1})],
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
...
var masteries = {
	...
	light = {
		...
		level2 = {combat_skills = ["blessing"], explore_skills = [], traits = ['vigor'], action = []},
