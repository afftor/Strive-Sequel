...
#		damagestat = ['no_stat']
	...
	hardwork = {#+50% productivity for the day
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({trigger = variables.TR_SOC_SPEC, duration = 4, effect = 'e_t_hardwork'})],
		cost = {},
		charges = 1,
		cooldown = 3,
...
#		dialogue_show_repeat = false,
	...
	discipline = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({duration = 4, effect = 'e_t_discipline'})],
		cost = {},
		charges = 2,
		cooldown = 1,
