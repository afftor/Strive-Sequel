...
var Skilllist = {
	...
	publicsexhumiliation = {
		...
		value = [['50'],['20'],['25']],
		damagestat = ['fear','lust','fear'],
		receiver = ['target','all','all']
	},
	publicexecution = {
	...
	serve = {
		...
		value = [['20'],['caster.charm','*0.2','+30'],['-10']],
		damagestat = ['lust','obedience','exhaustion'],
		receiver = ['caster','target','target']
	},
	sedate = {
		code = 'sedate',
	...
	innervate = {#target +50 energy ------ Energy become obsolete
		code = 'innervate',
		descript = '',
		type = 'social',
		ability_type = 'spell',
