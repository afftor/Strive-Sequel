...
#		dialogue_show_repeat = false,
	...
	endure = {
		code = 'endure',
		descript = '',
		icon = load("res://assets/images/iconsskills/Command.png"),#to fix
		type = 'combat',
		ability_type = 'skill', 
		tags = ['buff'],
		reqs = [],
...
#	},
	...
	earthquake_glob = {
		...
		cooldown = 0,
		catalysts = {},
		target = 'full',# or 'enemy'
		target_number = 'all',
		target_range = 'any',
		damage_type = 'earth',
		sfx = [{code = 'decay', target = 'target_frame', period = 'predamage'}], #to fix
		sounddata = {initiate = null, strike = 'blade', hit = null},
		value = 0.8
	},
