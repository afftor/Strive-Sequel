...
var Skilllist = {
	praise = { #+25 obedience, +5 loyal, -10 fear
		...
		tags = [],
		value = [['25'],['5'],['-10']],
		damagestat = ['obedience','loyal','fear'],
	},
	...
	#is this 50% of current productivity or simple add 50% to productivity since it is percental value by itself
		code = 'hardwork',
		name = '',
		descript = '',
		type = 'social',
