...
#		effects = [Effectdata.rebuild_template({effect = 'e_s_shred_old', duration = 3})], #if change to new version - Effectdata.rebuild_template_globals({effect = 'e_s_shred2'})
	...
	purification_by_fire = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_silence1', duration = 1}), Effectdata.rebuild_make_status({effect = 'e_s_stun1', duration = 1}), Effectdata.rebuild_template({effect = Effectdata.rebuild_remove_effect('burn')})], 
		cost = {},
		charges = 0,
		combatcooldown = 2,
		cooldown = 0,
	...
	glaciation = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_make_status({effect = 'e_s_stun1', duration = 1}), Effectdata.rebuild_template({effect = 'e_s_shred', duration = 2}), Effectdata.rebuild_template({effect = 'e_s_shatter', duration = 2})],
		cost = {mp = 3},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	north_wind = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_wet'}), Effectdata.rebuild_template({effect = 'e_s_disarm3', duration = 1, chance = 0.3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	curse_of_despair = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_disarm3', chance = 0.5, duration = 2}), Effectdata.rebuild_template({effect = 'e_s_silence1', chance = 0.5, duration = 2})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 0,
	...
	sneaky_trick = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_disarm3',  duration = 1}), Effectdata.rebuild_template({effect = 'e_s_shred', duration = 2})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	flash_stone = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_blind', duration = 2, chance = 0.7}), Effectdata.rebuild_template({effect = 'e_s_stun1', duration = 1, chance = 0.3})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	shock_charge = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect =  'e_s_silence1', duration = 1, chance = 0.7}), Effectdata.rebuild_template({effect = 'e_s_disarm3', duration = 1, chance = 0.7})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 2,
	...
	monstrous_swing = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_stun1', duration = 1, chance = 0.5})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 3,
	...
	monstrous_grip = { 
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template_globals({effect = 'e_s_ensnare2'}), Effectdata.rebuild_template({effect = 'e_s_silence1',  duration = 1}), Effectdata.rebuild_template({effect = 'e_s_disarm3', duration = 1})], 
		cost = {},
		charges = 0,
		combatcooldown = 0,
		cooldown = 1,
