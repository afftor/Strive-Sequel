...
var Skilllist = {
	...
	rewardsex = {
		...
		ability_type = 'skill',
		reqs = [],
		targetreqs = [{code = 'stat', type = 'lust', operant = 'gte', value = 25}],
		effects = [],
		manacost = 0,
		charges = 2,
		cooldown = 1,
	...
	publicexecution = {
		...
		ability_type = 'skill',
		reqs = [],
		targetreqs = [{code = 'stat', type = 'obedience',operant = 'lte', value = 25}],
	...
	acid_bomb = {#reduces enemy armor by 25 for 3 turns and deals earth damage
		...
		name = '',
		descript = '',
		icon = load('res://assets/images/iconsitems/miscarriagepot.png'),
		type = 'combat', 
		ability_type = 'spell',
		tags = ['damage'],
		reqs = [],
	...
	resurrect = {
		...
		type = 'combat', 
		ability_type = 'spell',
		tags = ['resurrect', 'noevade','noreduce'],
		reqs = [],
		targetreqs = [],
	...
	acidbomb = {
		...
		reqs = [],
		targetreqs = [],
		effects = [Effectdata.rebuild_template({effect = 'e_s_acidbomb', duration = 4})], 
		manacost = 0,
		energycost = 0,
		charges = 0,
		combatcooldown = 0,
...
#dummyskills
	...
	pet_lust_skill = {
		...
		type = 'social',
		ability_type = 'skill',
		reqs = [{code = 'stat', type = 'lust', operant = 'gte', value = 50}],
		targetreqs = [],
		effects = [],
		manacost = 0,
		charges = 1,
		...
		dialogue_text = '',
		dialogue_image = null,
		dialogue_options = [{code = "pet_lust_obed_convert", reqs = [], text = '1'},
		{code = "pet_lust_xp_convert", reqs = [], text = '2'},
		{code = "pet_lust_hp_convert", reqs = [], text = '3'},
		],
	},
