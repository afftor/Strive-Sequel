...
#		damagestat = ['+obedience','+fear'],
	...
	sharedtoy = { #+obedience to everyone on 
		...
		ability_type = 'skill',
		social_skill_stats = ['sexuals'],
		reqs = [{code = 'stat', stat = 'lust', operant = 'gte', value = 75}],
		targetreqs = [{code = 'is_master', check = false}],
		effects = [],
		manacost = 0,
		energycost = 0,
		...
		dialogue_show_repeat = false,
		dialogue_image = 'sexreward',
		value = [['75'], ['caster.sexuals', '/100', '+1', '*45']],
...
#		damagestat = ['no_stat']
	...
	serve = {
		...
		value = [['20'], ['caster.charm', '*2', '/100', '+1', '*30'],['4']],
		damagestat = ['-lust','loyaltyObedience','loyalty'],
