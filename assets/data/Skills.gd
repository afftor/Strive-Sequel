...
var Skilllist = {
	...
	warn = {#
		...
		dialogue_show_repeat = true,
		dialogue_image = 'warn',
		value = [['caster.physics', '*0.04','+3'], ['24'], ['caster.charm', "*0.04",'+4']],
	...
	rewardsex = {
		...
		value = [['caster.sexuals', '*0.08','+8'], ['36'], ['25']],
		damagestat = ['+loyalty', '+obedience', '-lust'],
	},
	punish = {
		code = 'punish',
		descript = '',
		...
		value = [['caster.physics', '*0.05','+12'], ['24'], ['caster.charm', "*0.12",'+10']],
		damagestat = ['+submission', '+obedience', '+authority'],
