...
var encounters = {
	...
	coalition_last_stand = {unittype = 'randomgroup', unitcode = 'coalition_last_stand', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'kuro_resolution_intro', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
	...
	act4_3_opened_seal_cultists = {unittype = 'randomgroup', unitcode = 'bandits_assassin2', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'act4_3_opened_seal_after_fight', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
	act4_3_erdyna_betrayal_fight = {unittype = 'randomgroup', unitcode = 'erdyna_boss', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'red_rooks_betrayal_win_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
	act4_3_red_rooks_leader_fight = {unittype = 'randomgroup', unitcode = 'erdyna_thugs', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'red_rooks_leader_win_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
	...
	act4_road_cave_fight_rouge = {unittype = 'randomgroup', unitcode = 'act4_road_cave_melchor_only', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'act4_road_mhyrana_ritual_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
	act4_road_cave_fight_alone = {unittype = 'randomgroup', unitcode = 'act4_road_cave_melchor_threeway', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'act4_road_mhyrana_ritual_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
	...
	jean_golems_window_1 = {unittype = 'randomgroup', unitcode = 'jean_golems_window_1', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_sidequest_mansion_rynn_intro_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	jean_golems_window_2 = {unittype = 'randomgroup', unitcode = 'jean_golems_window_2', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_sidequest_mansion_rynn_intro_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	jean_tunnel = {unittype = 'randomgroup', unitcode = 'jean_tunnel', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_sidequest_underground_tunnel_3', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	jean_ruins_monsters_1 = {unittype = 'randomgroup', unitcode = 'jean_ruins_monsters_1', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_q2_after_fight', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	jean_ruins_boss_fight = {unittype = 'randomgroup', unitcode = 'jean_ruins_boss_fight', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_q2_capture_figure_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	jean_sylas_thugs = {unittype = 'randomgroup', unitcode = 'jean_sylas_thugs', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_sylas_carriage_after_fight', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	jean_sylas_1 = {unittype = 'randomgroup', unitcode = 'jean_sylas_1', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_sylas_sylas_win_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	jean_sylas_2 = {unittype = 'randomgroup', unitcode = 'jean_sylas_2', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_sylas_sylas_win_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	jean_demon_1 = {unittype = 'randomgroup', unitcode = 'jean_demon_1', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_sylas_fight_jean_result', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	jean_demon_2 = {unittype = 'randomgroup', unitcode = 'jean_demon_2', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'jean_sylas_demon_fight_result', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix
	
	rouge_warehouse_escape = {unittype = 'randomgroup', unitcode = 'rouge_warehouse_escape', bg = 'default', bgm = 'default', win_effects = [{code = 'start_event', data = 'rouge_warehouse_escape_win', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]}, #fix

	lira_grove_centipedes = {unittype = 'randomgroup', unitcode = 'lira_grove_enemy', bg = 'combat_forest', bgm = 'default', win_effects = [{code = 'start_event', data = 'lira_quest_1_fight_aftermath_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
	lira_quest3_bait = {unittype = 'randomgroup', unitcode = 'bandits_easy_boss', bg = 'combat_forest', bgm = 'default', win_effects = [{code = 'start_event', data = 'lira_quest3_road_postfight_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
	lira_quest3_den_boss = {unittype = 'randomgroup', unitcode = 'bandits_medium_boss', bg = 'combat_forest', bgm = 'default', win_effects = [{code = 'start_event', data = 'lira_quest3_den_3', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
	lira_quest3_caravan = {unittype = 'randomgroup', unitcode = 'bandits_medium_boss', bg = 'combat_forest', bgm = 'default', win_effects = [{code = 'start_event', data = 'lira_quest3_caravan_ambush_2', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
}
...
var enemygroups = {
	...
	act4_road_cave_melchor_threeway = {maxunits = 6, reqs = [], units = {melchor_chancellor = [1,1], rouge_third_party = [1,1], imperial_soldier = [3,3], mhyrana_cultist = [1,1]}},
	act4_road_cave_melchor_only = {maxunits = 6, reqs = [], units = {melchor_chancellor = [1,1], imperial_soldier = [3,3], mhyrana_cultist = [2,2]}},
	...
	white_stag = {reqs = [], units = {white_stag = [1,1],}},
	...
	robbed_man = {reqs = [], units = {lilith_boss = [1,1], rebel_recruit = [2,2], ashmedai_tentacle = [2,2]}},
	lilia_boss = {reqs = [], units = {fat_bandit = [1,1], redhead_boss_bandit = [1,1], small_bandit = [1,1]}},
	lilith_patron = {reqs = [], units = {lilith_boss_2 = [1,1], ashmedai_tentacle = [4,4]}},
	...
	nixx_boss = {reqs = [], units = {nixx = [1,1], unlit_brazier = [1,1]}},
	...
	jean_tunnel = {reqs = [], units = {mutant = [2,2], mutant2 = [1,1]}},
	jean_ruins_monsters_1 = {reqs = [], units = {guardian_golem = [2,2]}},
	jean_ruins_boss_fight = {reqs = [], units = {guardian_golem = [2,2]}},
	jean_sylas_thugs = {reqs = [], units = {bandit_assassin = [2,2], bandit_boss_melee = [1,1]}},
	jean_sylas_1 = {reqs = [], units = {sylas = [1,1]}},
	...
	lira_grove_enemy = {reqs = [], units = {centipede_quest = [2,2]}},
	...
	hector_boss_fight = {reqs = [], units = {clansman_guard = [2,2], hector_boss = [1,1], clansman_archer = [2,2], bandit_mage = [1,1]}},
	...
	dwarf_ceremony_cult2 = {reqs = [], units = {dwarf_king = [1,1]}},
	coalition_last_stand = {reqs = [], units = {coal_bolthar = [1,1], coal_dwarf = [1,1], coal_ratkin = [1,1], coal_kobold = [1,1], coal_goblin = [1,1]}},
...
var enemies = {
	bandit_melee = {
		...
		traits = [],
		tags = ['human','bandit'],
		ai = [['basic', 75], ['ads', 25], ['aoe', 20], ['damage_spot', 10], ['support', 10], ['instant', 10], ['taunt', 25], ['selfbuf', 50], ['heal', 10]],
		ai_hard = [['basic', 50], ['ads', 50], ['aoe', 50], ['damage_spot', 20], ['support', 20], ['instant', 20], ['taunt', 50], ['selfbuf', 70], ['heal', 10]],
		ai_position = ['melee'],
		xpreward = 10,
	...
	bandit_archer = {
		...
		traits = [],
		tags = ['human','bandit'],
		ai = [['basic', 66], ['ads', 33], ['selfbuf', 50], ['damage_spot', 33], ['trap', 10], ['support', 10], ['heal', 20]],
		ai_position = ['ranged'],
		xpreward = 10,
	...
	bandit_assassin = {
		...
		traits = [],
		tags = ['human','bandit'],
		ai =  [['basic', 66], ['ads', 33], ['selfbuf', 50], ['damage_spot', 33], ['trap', 10], ['aoe', 10]],
		ai_position = ['ranged'],
		xpreward = 15,
	...
	bandit_boss_melee = {
		...
		traits = ['boss_resists'],
		tags = ['human','bandit'],
		ai = [['basic', 85], ['aoe', 50], ['ads', 33], ['selfbuf', 50], ['damage_spot', 33], ['trap', 10], ['heal', 20]],
		ai_hard = [['basic', 85], ['aoe', 50], ['ads', 33], ['selfbuf', 50], ['damage_spot', 33], ['trap', 10], ['heal', 20]],
		ai_position = ['melee'],
		xpreward = 40,
	...
	bandit_boss_archer = {
		...
		traits = ['boss_resists'],
		tags = ['human','bandit'],
		ai = [['basic', 45], ['ads', 40], ['aoe', 15], ['selfbuf', 50], ['ads', 33], ['selfbuf', 50], ['damage_spread', 33], ['trap', 10], ['trap', 10], ['heal', 20]],
		ai_hard = [['basic', 85], ['aoe', 50], ['ads', 33], ['selfbuf', 50], ['damage_spot', 33], ['damage_spread', 33], ['trap', 10], ['heal', 20]],
		ai_position = ['ranged'],
		xpreward = 40,
	...
	bandit_boss_mage = {
		...
		traits = ['boss_resists'],
		tags = ['human','bandit'],
		ai = [['basic', 45], ['ads', 40], ['aoe', 15], ['support', 50], ['damage_spot', 33], ['damage_spread', 33]],
		ai_hard = [['basic', 85], ['aoe', 50], ['ads', 33], ['support', 50], ['damage_spot', 33], ['damage_spread', 33]],
		ai_position = ['ranged'],
		xpreward = 40,
	...
	rebel_recruit = {
		...
		traits = [],
		tags = ['human'],
		ai = [['basic', 66], ['ads', 33], ['taunt', 50], ['damage_spot', 33], ['support', 10], ['heal', 10], ['instant', 30], ['aoe', 30]],
		ai_hard = [['basic', 50], ['ads', 50], ['taunt', 50], ['damage_spot', 33], ['support', 10], ['heal', 10], ['instant', 30], ['aoe', 30]],
		ai_position = ['melee'],
		xpreward = 10,
	...
	rebel_knight = {
		...
		traits = [],
		tags = ['human'],
		ai = [['basic', 75], ['ads', 25], ['taunt', 50], ['damage_spot', 33], ['support', 10], ['heal', 30], ['instant', 30], ['aoe', 50]],
		ai_hard = [['basic', 50], ['ads', 50], ['taunt', 50], ['damage_spot', 33], ['support', 10], ['heal', 30], ['instant', 30], ['aoe', 50]],
		ai_position = ['melee'],
		xpreward = 10,
	...
	rebel_mage = {
		...
		traits = [],
		tags = ['human'],
		ai = [['aoe', 33], ['ads', 66], ['heal', 10], ['damage_spread', 40], ['damage_spot', 60], ['support', 40], ['instant', 50], ['resurrect', 50]],
		ai_position = ['ranged'],
		xpreward = 15,
	...
	rebel_healer = {
		...
		tags = ['human'],
#		ai = [['basic', 25], ['heal', 75]],
		ai = [['basic', 25], ['damage_spot', 30], ['ads', 20], ['support', 50], ['aoe', 30], ['instant', 70], ['heal', 75], ['resurrect', 90]],
		ai_position = ['ranged'],
		xpreward = 15,
	...
	trained_dog = {
		...
		tags = ['beast'],
#		ai = [['basic', 100],['ads', 0]],
		ai = [['basic', 100], ['selfbuf', 10], ['taunt', 10]],
		ai_position = ['melee'],
		xpreward = 10,
...
#		ai = [['basic', 100],['ads', 0]],
	...
	trained_raptor = {
		...
		tags = ['beast'],
#		ai = [['basic', 50],['ads', 50]],
		ai = [['basic', 50], ['damage_spot', 10], ['ads', 50], ['selfbuf', 10], ['taunt', 10]],
		ai_position = ['melee'],
		xpreward = 20,
		allowed_mastery = ['warfare','protection','stealth'],
	},
...
#		ai = [['basic', 100],['ads', 0]],
	...
	ballista = {
		...
		tags = ['mech'],
#		ai = [['basic', 50],['ads', 50]],
		ai = [['basic', 50], ['damage_spot', 30], ['ads', 50], ['aoe', 10]],
		ai_position = ['ranged'],
		xpreward = 20,
		allowed_mastery = ['warfare','protection','stealth'],
	},
...
#		ai = [['ads', 45], ['aoe', 45], ['support', 10]], #add healing on self when hp < 50 with 75% chance
		ai = [['basic', 10], ['damage_spread', 20], ['damage_spot', 20], ['ads', 45], ['support', 10], ['aoe', 45], ['heal', 80]],
		ai_position = ['ranged'],
		xpreward = 15,
	...
	cave_goblin_melee = {
		...
		tags = ['goblin'],
#		ai = [['basic', 66], ['ads', 33]],
		ai = [['basic', 66], ['damage_spot', 10], ['ads', 33], ['support', 10], ['aoe', 10], ['instant', 10], ['selfbuf', 40]],
		ai_position = ['melee'],
		xpreward = 7,
	...
	cave_goblin_archer = {
		...
		tags = ['goblin'],
#		ai = [['basic', 100]],
		ai = [['basic', 100], ['damage_spot', 30], ['ads', 30], ['aoe', 10], ['selfbuf', 50]],
		ai_position = ['ranged'],
		xpreward = 10,
	...
	cave_goblin_mage = {
		...
		tags = ['goblin'],
#		ai = [['ads', 100]],
		ai = [['damage_spread', 50], ['damage_spot', 50], ['ads', 100], ['support', 10], ['aoe', 50], ['instant', 10], ['heal', 10]],
		ai_position = ['ranged'],
		xpreward = 10,
	...
	cave_goblin_boss = {
		...
		tags = ['goblin'],
#		ai = [['basic', 66], ['ads', 33]],
		ai = [['basic', 66], ['damage_spot', 10], ['ads', 33], ['support', 10], ['aoe', 10], ['instant', 10], ['heal', 10], ['taunt', 10],],
		ai_position = ['melee'],
		xpreward = 20,
	...
	cave_goblin_shaman = {
		...
		tags = ['goblin'],
#		ai = [['basic', 66], ['ads', 33]],
		ai = [['basic', 66], ['damage_spread', 10], ['damage_spot', 30], ['ads', 33], ['support', 10], ['aoe', 10], ['instant', 10], ['heal', 10]],
		ai_position = ['ranged'],
		xpreward = 20,
...
#		ai = [['basic', 66], ['ads', 33]],
	...
	ogre_melee = {
		...
		traits = [],
		tags = ['ogre'],
		ai = [['basic', 66], ['damage_spot', 70], ['ads', 33], ['support', 10], ['aoe', 10], ['taunt', 20]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['melee'],
		xpreward = 20,
		allowed_mastery = ['warfare','leadership','protection'],
	...
	ogre_mage = {
		...
		traits = [],
		tags = ['ogre'],
		ai = [['basic', 66], ['damage_spot', 40], ['ads', 33], ['support', 40], ['aoe', 40]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['ranged'],
		xpreward = 25,
	...
	troll = {
		...
		traits = [],
		tags = ['troll'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['support', 33], ['aoe', 33], ['instant', 10], ['heal', 33], ['taunt', 20]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['melee'],
		xpreward = 50,
		allowed_mastery = ['warfare','leadership','protection'],
	...
	skeleton_melee = {
		...
		traits = [],
		tags = ['undead'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['support', 10], ['aoe', 33], ['instant', 10], ['selfbuf', 10], ['taunt', 10]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['melee'],
		xpreward = 10,
	...
	skeleton_shield_melee = {
		...
		tags = ['undead'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['support', 10], ['aoe', 33], ['taunt', 66]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['melee'],
		xpreward = 10,
	...
	skeleton_archer = {
		...
		traits = [],
		tags = ['undead'],
		ai = [['basic', 66], ['damage_spread', 33], ['damage_spot', 33], ['ads', 33], ['support', 10], ['instant', 66], ['selfbuf', 66], ['trap', 10]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['ranged'],
		xpreward = 10,
...
#		ai = [['basic', 66], ['ads', 33]],
	...
	zombie = {
		...
		traits = [],
		tags = ['undead'],
		ai = [['basic', 66], ['damage_spot', 10], ['ads', 33], ['aoe', 33], ['instant', 10], ['taunt', 10]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['melee'],
		xpreward = 10,
	...
	undead_lich = {
		...
		traits = ['boss_resists'],
		tags = ['undead'],
		ai = [['damage_spread', 66], ['damage_spot', 33], ['ads', 66], ['support', 10], ['aoe', 33], ['instant', 10]],

#		ai = [['aoe', 33], ['ads', 66]],
		ai_hard = [['damage_spread', 50], ['damage_spot', 50], ['ads', 50], ['support', 10], ['aoe', 50], ['instant', 50]],
...
#		ai_hard = [['basic', 50], ['ads', 50]],
	...
	wolf = {
		...
		traits = [],
		tags = ['beast'],
		ai = [['basic', 100], ['damage_spot', 10], ['ads', 10], ['aoe', 10], ['taunt', 10]],
#		ai = [['basic', 100]],
		ai_position = ['melee'],
		xpreward = 5,
	...
	spider_weak = {
		...
		traits = [],
		tags = ['insect'],
		ai = [['basic', 66], ['damage_spread', 0], ['damage_spot', 33], ['ads', 33], ['aoe', 10], ['selfbuf', 10]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['melee'],
		xpreward = 7,
	...
	spider = {
		...
		traits = [],
		tags = ['insect'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['aoe', 10], ['taunt', 10]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['melee'],
		xpreward = 7,
		allowed_mastery = ['warfare','stealth','leadership'],
	...
	willowisp = {
		...
		traits = [],
		tags = ['demon'],
		ai = [['damage_spread', 50], ['damage_spot', 50], ['ads', 100], ['support', 50], ['aoe', 50], ['instant', 10]],
#		ai = [['ads', 100]],
		ai_position = ['ranged'],
		xpreward = 7,
	...
	spider_ranged = {
		...
		traits = [],
		tags = ['insect'],
		ai = [['damage_spot', 50], ['ads', 100], ['aoe', 10], ['selfbuf', 50], ['trap', 50]],
#		ai = [['basic', 0], ['ads', 100]],
		ai_position = ['ranged'],
		xpreward = 7,
...
#		ai = [['basic', 33], ['ads', 66]],
	...
	spider_alfa_boss = {
		...
		traits = ['boss_resists'],
		tags = ['insect'],
		ai = [['basic', 50], ['damage_spread', 50], ['damage_spot', 50], ['ads', 50], ['support', 50], ['aoe', 50], ['instant', 50], ['heal', 50], ['selfbuf', 50], ['taunt', 50]],
...
#		ai = [['basic', 50], ['ads', 50]],
	...
	spider_queen_boss = {
		...
		tags = ['insect'],
#		ai = [['basic', 33], ['ads', 66]],
		ai = [['basic', 50], ['damage_spot', 50], ['ads', 50], ['support', 50], ['aoe', 50], ['instant', 50], ['heal', 50], ['selfbuf', 50], ['taunt', 50]],
		ai_position = ['ranged'],
		xpreward = 20,
	...
	rat = {
		...
		tags = ['beast'],
#		ai = [['basic', 100]],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['aoe', 10], ['selfbuf', 10]],
...
#		ai = [['basic', 50],['ads',50]],
	...
	elder_gryphon_boss = {
		...
		speed = [75,45],
		resists = {air = 50, fire = -25, earth = -50},
		status_resists = {stun = 60, freeze = 30, sleep = 50, disarm = 100, silence = 20},
		race = 'beast',
		cast_weapon = "bite",
		loot = 'gryphon_loot',
		icon = "res://assets/images/enemies/gryphon.png",
		skills = ['accelerating_plunge','comet_dive', 'tornado', 'downburst_gust', 'deafening_shriek', 'multilate_prey', 'multilate_prey_prio', 'charge_through', 'attack'],
		traits = ['boss_resists', 'from_heaven_above'],
		tags = ['beast'],
		ai = [['basic', 50], ['damage_spot', 50], ['ads', 50], ['summon', 50], ['aoe', 50], ['damage', 10], ['buff', 50]],
		skill_rotation = [
			['accelerating_plunge', 'comet_dive', 'tornado', 'attack'],['accelerating_plunge', 'comet_dive', 'downburst_gust', 'attack'],
			['accelerating_plunge', 'comet_dive','multilate_prey_prio', 'multilate_prey', 'attack'],['accelerating_plunge', 'comet_dive', 'tornado', 'attack'],
			['accelerating_plunge', 'comet_dive', 'downburst_gust', 'attack'],['accelerating_plunge', 'comet_dive','multilate_prey_prio', 'charge_through', 'attack'],
			['accelerating_plunge', 'comet_dive','multilate_prey_prio', 'multilate_prey', 'attack'],['accelerating_plunge', 'comet_dive', 'deafening_shriek', 'multilate_prey', 'attack'],
		],
		ai_position = ['ranged'],
		xpreward = 75,
		allowed_mastery = [],
	...
	tornado = {
		...
		matk = 80,
		speed = 62,
		resists = {light = 100, mind = 100, fire = -50, dark = 100, air = -50, water = 50, normal = 80},
		status_resists = {stun = 500, bleed = 500, poison = 500, disarm = 500, freeze = 500, 
			silence = 500, burn = 500, confuse = 500, shock = 500, fear = 500, cursed = 500,
			sleep = 500, blind = 500, shred = 500 },
		race = 'golem',
		loot = 'bandit_loot',
		icon = "res://assets/images/iconsskills/windwall.png",
		skills = ['storm_path'],
		traits = ['turbulence_air',],
		tags = ['golem','air'],
		ai = [['basic', 33], ['debuff', 33], ['damage', 33], ['summon', 33], ['support', 33], ['aoe', 33]],
		skill_rotation = [['storm_path',]],
		ai_position = ['melee'],
		xpreward = 10,
	},
...
#		ai = [['basic', 50],['aoe', 50]],
	...
	rock_thrower = {
		...
		tags = ['golem'],
#		ai = [['basic', 100]],
		ai = [['basic', 50], ['damage_spot', 50], ['ads', 50], ['support', 50], ['aoe', 50], ['instant', 10]],
		ai_position = ['ranged'],
		xpreward = 15,
		allowed_mastery = ['warfare','marksmanship','leadership','stealth'],
	},
...
#		ai = [['basic', 20],['ads',40],['aoe',40]],
		ai = [['basic', 20], ['damage_spot', 20], ['ads', 40], ['support', 20], ['aoe', 40]],
		ai_position = ['any'],
		xpreward = 15,
...
#		ai = [['basic', 100]],
	...
	wild_raptor =  {
		...
		tags = ['beast'],
#		ai = [['basic', 100]],
		ai = [['basic', 100], ['damage_spot', 50], ['ads', 50], ['support', 50], ['aoe', 50], ['instant', 10], ['taunt', 50]],
	...
	centipede = {
		...
		tags = ['insect'],
#		ai = [['basic', 25],['ads',75]],
		ai = [['basic', 25], ['damage_spot', 50], ['ads', 75], ['support', 50], ['aoe', 50], ['instant', 10], ['taunt', 50]],
		ai_position = ['any'],
		xpreward = 20,
		allowed_mastery = ['warfare','protection','leadership','stealth'],
	},
	centipede_quest = {
		code = 'centipede_quest',
		name = '',
		descript = '',
		hpmax = 300,
		armor = 55,
...
#		ai = [['basic', 25],['ads',75]],
	...
	ogre_alpha = {
		...
		traits = ['boss_resists'],
		tags = ['ogre'],
		ai = [['basic', 30], ['damage_spot', 50], ['ads', 70], ['support', 10], ['aoe', 50], ['instant', 10], ['heal', 10], ['selfbuf', 50], ['taunt', 50]],
#		ai = [['basic', 30],['ads',70]],
		ai_position = ['ranged'],
		xpreward = 100,
	...
	great_viper = {
		...
		tags = ['beast'],
#		ai = [['basic', 100]],
		ai = [['basic', 100], ['damage_spot', 50], ['ads', 75], ['support', 50], ['aoe', 50], ['instant', 10], ['taunt', 50]],
		ai_position = ['any'],
		xpreward = 100,
		allowed_mastery = ['warfare','protection','leadership','stealth'],
	},
...
#		ai = [['basic', 100]],
	...
	ifrit = {
		...
		tags = ['demon'],
		ai = [['basic', 30], ['damage_spread', 10], ['damage_spot', 70], ['ads', 70], ['support', 10], ['aoe', 30], ['instant', 10], ['heal', 40], ['resurrect', 10], ['selfbuf', 30], ['taunt', 10]],
#		ai = [['basic', 30],['ads',70]],
		ai_position = ['any'],
		xpreward = 15,
	...
	magma_beast = {
		...
		traits = ['boss_resists'],
		tags = ['beast'],
		ai = [['damage_spot', 10], ['ads', 10], ['support', 10], ['aoe', 100], ['taunt', 10]],
#		ai = [['aoe', 100]],
		ai_position = ['ranged'],
		xpreward = 100,
		allowed_mastery = ['warfare','protection','leadership','stealth'],
	...
	erebus_stone = {
		...
		tags = ['mech'],
		ai = [['basic', 25], ['damage_spread', 75], ['damage_spot', 75], ['ads', 75], ['support', 25], ['aoe', 50], ['instant', 50], ['heal', 10], ['taunt', 10]],
#		ai = [['basic', 25],['ads', 75]],
		ai_position = ['ranged'],
		xpreward = 50,
	...
	dwarf_fighter = {
		...
		traits = [],
		tags = ['human'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['heal', 10], ['taunt', 10]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_hard = [['basic', 50], ['damage_spot', 50], ['ads', 50], ['heal', 20], ['taunt', 30]],
#		ai_hard = [['basic', 50], ['ads', 50]],
		ai_position = ['melee'],
		xpreward = 15,
		allowed_mastery = ['warfare','protection','leadership','stealth'],
	...
	dwarf_fighter_elite = {
		...
		tags = ['human'],
#		ai = [['basic', 66], ['ads', 33]],
		ai = [['basic', 66], ['damage_spot', 33], ['support', 10], ['ads', 33], ['heal', 10], ['taunt', 10]],
#		ai_hard = [['basic', 50], ['ads', 50]],
		ai_hard = [['basic', 50], ['damage_spot', 50], ['support', 20], ['ads', 50], ['heal', 20], ['taunt', 30]],
		ai_position = ['melee'],
		xpreward = 25,
	...
	dwarf_ranged = {
		...
		traits = [],
		tags = ['human'],
		ai = [['basic', 100], ['damage_spot', 50], ['ads', 50], ['selfbuf', 50], ['trap', 50]],
#		ai = [['basic', 100]],
		ai_position = ['ranged'],
		xpreward = 10,
		allowed_mastery = ['warfare','marksmanship','stealth'],
	...
	mutant = {
		...
		race = 'humanoid',
		loot = 'assassin_loot',
		icon = "res://assets/images/enemies/mutant1.png",
		skills = ['attack','sunder'],
		traits = [],
		tags = ['human'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['heal', 10], ['taunt', 10]],
...
#		ai_hard = [['basic', 50], ['ads', 50]],
	...
	mutant2 = {
		...
		race = 'humanoid',
		loot = 'assassin_loot',
		icon = "res://assets/images/enemies/mutant2.png",
		skills = ['attack','ensnare'],
		traits = [],
		tags = ['human'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['heal', 10], ['taunt', 10]],
#		ai = [['basic', 66], ['ads', 33]],
...
#		ai_hard = [['basic', 50], ['ads', 50]],
	...
	pack_leader_boss = {
		...
		traits = ['boss_resists'],
		tags = ['beast'],
		ai = [['basic', 50], ['damage_spot', 30], ['ads', 30], ['support', 30], ['aoe', 30], ['selfbuf', 50], ['taunt', 50],],
#		ai = [['basic', 50],['aoe', 30],['debuff', 50]],
	...
	sergeant_boss = {
		...
		traits = ['boss_resists'],
		tags = ['human'],
		ai = [['basic', 50], ['damage_spot', 50], ['ads', 20], ['support', 20], ['aoe', 30], ['instant', 10], ['heal', 20], ['selfbuf', 20], ['taunt', 20]],
#		ai = [['basic', 50],['aoe', 30],['debuff', 20]],
	...
	castellan_boss = {
		...
		traits = ['boss_resists'],
		tags = ['human'],
		ai = [['basic', 20], ['damage_spot', 50], ['ads', 50], ['support', 10], ['aoe', 30], ['heal', 20], ['resurrect', 10], ['selfbuf', 20], ['taunt', 20], ['trap', 10]],
#		ai = [['basic', 20],['aoe', 30],['ads', 50]],
	...
	jarl_boss = {
		...
		traits = ['boss_resists'],
		tags = ['human', 'bandit'],
		ai = [['basic', 50], ['damage_spot', 20], ['ads', 20], ['support', 10], ['aoe', 30], ['heal', 10], ['taunt', 10], ['trap', 10]],
#		ai = [['basic', 50],['aoe', 30],['ads', 20]],
	...
	bounty_hunter_boss = {
		...
		traits = ['boss_resists'],
		tags = ['human', 'bandit'],
		ai = [['basic', 33], ['damage_spread', 10], ['damage_spot', 33], ['ads', 66], ['support', 66], ['aoe', 33], ['instant', 10], ['heal', 10], ['selfbuf', 10], ['trap', 10]],
#		ai = [['basic', 33],['debuff', 66]],
	...
	warlock_boss = {
		...
		traits = ['boss_resists'],
		tags = ['demon','bandit'],
		ai = [['damage_spread', 10], ['damage_spot', 66], ['ads', 33], ['support', 33], ['aoe', 66]],
#		ai = [['aoe', 66],['debuff', 33]],
		ai_position = ['ranged'],
		xpreward = 30,
	...
	hobgoblin_thug = {
		...
		traits = [],
		tags = ['goblin'],
		ai = [['basic', 100], ['damage_spot', 80], ['ads', 80], ['aoe', 40], ['taunt', 20], ['trap', 20]],
#		ai = [['basic', 100]],
		ai_position = ['melee'],
		xpreward = 15,
		allowed_mastery = ['warfare','protection','leadership','stealth'],
	...
	hobgoblin_crossbowman = {
		...
		traits = [],
		tags = ['goblin'],
		ai = [['basic', 50], ['damage_spot', 50], ['ads', 50], ['aoe', 10], ['trap', 20]],
#		ai = [['basic', 50], ['ads', 50]],
		ai_position = ['ranged'],
		xpreward = 15,
		allowed_mastery = ['warfare','marksmanship','leadership','stealth'],
	...
	hobgoblin_tormentor = {
		...
		traits = [],
		tags = ['goblin'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['support', 10], ['aoe', 33], ['heal', 10], ['taunt', 10], ['trap', 33]],
#		ai = [['basic', 66], ['aoe', 33]],
		ai_position = ['ranged'],
		xpreward = 15,
	...
	warg = {
		...
		traits = [],
		tags = ['beast'],
		ai = [['basic', 60], ['damage_spot', 40], ['ads', 40], ['support', 10], ['aoe', 10], ['selfbuf', 40], ['taunt', 10]],
#		ai = [['basic', 60], ['ads', 40]],
		ai_position = ['melee'],
		xpreward = 15,
		allowed_mastery = ['warfare','protection','leadership','stealth'],
	...
	vulture = {
		...
		traits = [],
		tags = ['beast'],
		ai = [['basic', 60], ['damage_spot', 40], ['ads', 40], ['support', 10], ['aoe', 10],  ['selfbuf', 40]],
#		ai = [['basic', 60], ['ads', 40]],
		ai_position = ['ranged'],
		xpreward = 15,
		allowed_mastery = ['warfare','leadership','stealth'],
	...
	warlord = {
		...
		traits = ['boss_resists'],
		tags = ['goblin'],
		ai = [['basic', 40],  ['damage_spot', 40], ['ads', 20], ['support', 20], ['aoe', 20], ['instant', 10], ['heal', 10], ['taunt', 20]],
#		ai = [['basic', 40], ['ads', 20], ['aoe', 20], ['debuff', 20]],
	...
	alchemist = {
		...
		traits = ['boss_resists'],
		tags = ['goblin'],
		ai = [['damage_spread', 10], ['damage_spot', 40], ['ads', 40], ['support', 20], ['aoe', 40], ['heal', 20], ['resurrect', 20]],
#		ai = [['aoe', 40], ['aoe', 40], ['debuff', 20]],
	...
	battle_troll = {
		...
		traits = ['boss_resists'],
		tags = ['troll'],
		ai = [['basic', 30], ['damage_spot', 40], ['ads', 40], ['support', 30], ['aoe', 40], ['heal', 30], ['selfbuf', 30], ['taunt', 40]],
#		ai = [['basic', 30], ['ads', 40], ['aoe', 30]],
	...
	greg = {
		...
		speed = [55,30],
		resists = {},
		status_resists = {stun = 50, freeze = 65, sleep = 40, disarm = 15},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/greg_enemy.png",
		skills = ['glint_of_the_sword','lacerating_dance','isolate','disengage','disposal'],
		traits = ['boss_resists','black_knight_greg','lonesome_rage_bygone_glory','demonness_gift_null_cloak',],
		tags = ['human','boss'],
		ai = [['damage', 66], ['ads', 33], ['support', 33], ['aoe', 33], ['heal', 33], ['debuff', 33]],
		skill_rotation = [
			['glint_of_the_sword', 'disengage'],['lacerating_dance', 'disengage'],
			['disposal', 'isolate', 'disengage'],['disposal', 'lacerating_dance', 'disengage'],
			['disposal', 'glint_of_the_sword', 'disengage'],['disengage', 'glint_of_the_sword'],
		],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
	...
	greg_act4 = {
		...
		icon = "res://assets/images/enemies/greg_enemy.png",
		skills = ['glint_of_the_sword','lacerating_dance','isolate','disengage','disposal','wake_of_blackened_blade','greg_last_bark'],
		traits = ['boss_resists','black_knight_greg','lonesome_rage_bygone_glory','demonness_gift_null_cloak','trinket_smokebomb','greg_final_stand','greg_relation'],
		tags = ['human','boss'],
		ai = [['damage', 66], ['damage_spot', 33], ['ads', 33], ['support', 33], ['aoe', 33], ['instant', 33], ['heal', 33], ['debuff', 33]],
		skill_rotation = [
			['greg_last_bark', 'wake_of_blackened_blade', 'isolate', 'disengage'],['greg_last_bark', 'lacerating_dance', 'disengage'],
			['greg_last_bark', 'disposal', 'glint_of_the_sword', 'disengage'],['greg_last_bark', 'disposal', 'isolate', 'disengage'],
			['greg_last_bark', 'disposal', 'lacerating_dance', 'disengage'],['greg_last_bark', 'disengage', 'glint_of_the_sword'],
		],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
	...
	erdyna = {
		...
		traits = ['boss_resists'],
		tags = ['human','boss'],
		ai = [['damage_spot', 0], ['ads', 66], ['aoe', 33], ['selfbuf', 10], ['trap', 33]],
#		ai = [['ads', 66],['aoe',33]],
		ai_position = ['melee'],
		xpreward = 100,
	...
	nixx = {
		...
		matk = 140,
		speed = [70,50],
		resists = {dark = 100, mind = 50, light = -50, fire = -25},
		status_resists = {stun = 65, freeze = 30, sleep = 100, silence = 20},
		race = 'demon',
		loot = 'nixx_reward',
		icon = "res://assets/images/enemies/nix.png",
		skills = ['attack','umbral_reign','shadow_made_manifest','stygian_wailing','tenebrous_rake','void_deluge','caliginous_undulation','nixx_ult'],
		traits = ['boss_resists','nixx_trait','snuffing_out_the_candle'],
		tags = ['boss','deity'],
		ai = [['damage_spread', 50], ['damage', 50], ['ads', 50], ['aoe', 50],['summon',30],['debuff',40]],
		skill_rotation = [
			['nixx_ult', 'shadow_made_manifest', 'umbral_reign', 'tenebrous_rake', 'void_deluge', 'attack'],['nixx_ult', 'umbral_reign', 'shadow_made_manifest', 'caliginous_undulation', 'tenebrous_rake', 'attack'],
			['nixx_ult', 'shadow_made_manifest', 'umbral_reign', 'void_deluge', 'tenebrous_rake', 'attack'],['nixx_ult', 'stygian_wailing', 'shadow_made_manifest', 'tenebrous_rake', 'attack'],
		],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
	...
	unlit_brazier = {
		...
		matk = 0,
		speed = 0,
		resists = {fire = -100, light = -50, water = 200, dark = 100},
		status_resists = {stun = 100, disarm = 100, silence = 100, confuse = 100, bleed = 100, poison = 100, shock = 100, fear = 100, cursed = 100, sleep = 100, blind = 100,},
		race = 'mech',
		loot = 'guardian_golem_loot',
		icon = "res://assets/images/enemies/brazier_unlit.png",
		skills = ['nothing',],
		traits = ['environmental_object','unlit_brazier'],
		tags = ['mech','environmental_object'],
		ai = [['nothing', 100],],
		ai_position = ['ranged'],
		xpreward = 0,
	},
	lighted_brazier = {
		code = 'lighted_brazier',
		name = '',
		descript = '',
		hpmax = 1000,
		armor = 65,
		...
		matk = 0,
		speed = 0,
		resists = {fire = 200, light = 100, water = -100, dark = -50},
		status_resists = {stun = 100, disarm = 100, silence = 100, confuse = 100, bleed = 100, poison = 100, shock = 100, fear = 100, cursed = 100, sleep = 100, blind = 100,},
		race = 'mech',
		loot = 'guardian_golem_loot',
		icon = "res://assets/images/enemies/brazier_lit.png",
		skills = ['nothing',],
		traits = ['environmental_object','light_brazier'],
		tags = ['mech','environmental_object'],
		ai = [['nothing', 100],],
		ai_position = ['ranged'],
		xpreward = 0,
	...
	shadow_monstrosity = {
		...
		matk = 120,
		speed = 40,
		resists = {fire = -50, light = -100, dark = 100, mind = 50},
		race = 'demon',
		loot = 'willowisp_loot',
		icon = "res://assets/images/enemies/darkboss.png",
		skills = ['attack','darkness','smother_the_flame','bump_in_the_midnight','malediction'],
		traits = ['intangible_shadow','nixx_malleable_creation'],
		tags = ['demon'],
		ai = [['damage_spread', 30], ['debuff', 50], ['ads', 40], ['heal', 50], ['dark', 10], ['damage', 50],['ultimate',50]],
#		ai = [['ads', 100]],
		ai_position = ['melee'],
		xpreward = 7,
	},
	aire = {
		...
		speed = [65,30],
		resists = {},
		status_resists = {stun = 65, freeze = 25, disarm = 50, sleep = 50},
		critmod = 1.5,
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/aire_enemy.png",
		skills = ['ranged_attack', 'arrowrain','for_the_princess', 'ricochet_shot', 'trap', 'leadersmark', 'first_aid'],
		traits = ['boss_resists','aire_overwatch_assignment','aire_behind_cover','aire_aim_adjustment'],
		tags = ['human','boss'],
		ai = [['basic', 10], ['damage', 33], ['damage_spot', 33], ['ads', 33], ['aoe', 33], ['selfbuf', 66], ['trap', 50]],
		skill_rotation = [
			['trap', 'ricochet_shot', 'ranged_attack'],['for_the_princess', 'leadersmark', 'ranged_attack'],
			['first_aid', 'arrowrain', 'ranged_attack'],['ricochet_shot', 'arrowrain', 'ranged_attack']
		],
		ai_position = ['ranged'],
		xpreward = 100,
		preset_masteries = {},
	...
	demoness = {
		...
		skills = ['shadowstrike','voidslam','dark_gift','puppet_on_a_string','force_martyrdom'],
		traits = ['boss_resists','demoness_what_a_pain'],
		tags = ['human','demon','boss'],
		gear = [],
		ai = [['basic', 33], ['damage_spread', 33],  ['damage', 33], ['damage_spot', 33], ['support', 80], ['ads', 33], ['aoe', 33], ['heal', 10],],
		skill_rotation = [
			['voidslam','shadowstrike','dark_gift','puppet_on_a_string','attack'],
			['dark_gift','puppet_on_a_string','shadowstrike','attack'],
			['force_martyrdom','puppet_on_a_string','shadowstrike','attack'],
			['puppet_on_a_string','force_martyrdom','dark_gift','attack'],
			['force_martyrdom','dark_gift','puppet_on_a_string','shadowstrike','attack']
		],
#		ai = [['ads', 33],['aoe',33], ['basic', 33]],
	...
	sylas = {
		...
		race = 'humanoid',
		loot = 'erebus_stone_loot',
		icon = "res://assets/images/enemies/sylas.png",
		skills = [],
		traits = ['boss_resists'],
		tags = ['human','boss'],
		ai = [['basic', 10], ['damage_spot', 33], ['ads', 33], ['aoe', 33], ['selfbuf', 66]],
#		ai = [['ads', 33],['aoe',33], ['ads', 33]],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {warfare = 5, stealth = 5, protection = 3},
	},
	sylas_weak = {
		code = 'sylas_weak',
		name = '',
...
#		ai = [['ads', 33],['aoe',33], ['ads', 33]],
	...
	#Jean with the demon driving. A caster who opens with a Greater Flame Sphere and then walks the
	#party through one high-tier AoE per turn; the shells and the Second Mouth are in jean_demon.gd.
	#Her ATK is deliberately poor - Demonic Struggle's 250% is the demon overtaxing her body.
	jean_evil = {
		code = 'jean_evil',
		name = '',
		descript = '',
		...
		matk = 150,
		speed = 55,
		resists = {light = -50, dark = 25, fire = 25},
		status_resists = {stun = 30, freeze = 30, sleep = 50},
		race = 'humanoid',
		loot = 'erebus_stone_loot',
		icon = "res://assets/images/enemies/jean evil.png",
		skills = ['jd_abyss', 'jd_soil_liquefaction', 'jd_winterfall', 'jd_perfect_storm', 'jd_catch_breath', 'jd_volcanic_eruption', 'jd_demonic_struggle'],
		traits = ['boss_resists', 'jd_jean_trait'],
		tags = ['human','demon','boss'],
		gear = [],
		ai = [['damage', 60], ['aoe', 50], ['ads', 40], ['debuff', 30], ['damage_spot', 30], ['heal', 40], ['support', 20], ['ultimate', 50], ['basic', 20]],
		#one spell a turn, in a fixed order. 'Unskippable' holds the row when she is Silenced so the
		#sequence resumes where it left off instead of losing a spell to the gag.
		skill_rotation = [
			['jd_abyss', 'Unskippable'],
			['jd_soil_liquefaction', 'Unskippable'],
			['jd_winterfall', 'Unskippable'],
			['jd_perfect_storm', 'Unskippable'],
			['jd_catch_breath', 'Unskippable'],
			['jd_volcanic_eruption', 'Unskippable'],
		],
		ai_position = ['ranged'],
		xpreward = 120,
		need_req = true,
	},
	#The dream eater in its own body. It wants everyone asleep, then deeper asleep, then never awake;
	#every row of its rotation puts a skill that needs a waking target in front of Eternal Slumber, so
	#the wipe is only reachable once the whole party is Comatose.
	jean_demon = {
		code = 'jean_demon',
		name = '',
		descript = '',
		...
		matk = 150,
		speed = 55,
		resists = {light = -100, dark = 25, mind = 50},
		status_resists = {sleep = 100, disarm = 100, silence = 30},
		race = 'humanoid',
		loot = 'erebus_stone_loot',
		icon = "res://assets/images/enemies/demon.png",
		skills = ['jd_engulfing_dream', 'jd_oneiric_feeding', 'jd_sapid_unreality', 'jd_eternal_slumber', 'jd_show_body', 'jd_vision_indulgence', 'jd_mass_illusion', 'jd_faustian_deliverance'],
		traits = ['boss_resists', 'jd_demon_trait'],
		tags = ['human','demon','boss'],
		gear = [],
		ai = [['damage', 60], ['aoe', 50], ['ads', 40], ['debuff', 40], ['damage_spot', 30], ['buff', 20], ['ultimate', 50], ['basic', 20]],
		skill_rotation = [
			['jd_sapid_unreality', 'jd_oneiric_feeding', 'jd_engulfing_dream', 'jd_show_body', 'jd_eternal_slumber'],
			['jd_sapid_unreality', 'jd_oneiric_feeding', 'jd_vision_indulgence', 'jd_show_body', 'jd_eternal_slumber'],
			['jd_sapid_unreality', 'jd_oneiric_feeding', 'jd_mass_illusion', 'jd_eternal_slumber'],
			['jd_sapid_unreality', 'jd_oneiric_feeding', 'jd_faustian_deliverance', 'jd_show_body', 'jd_eternal_slumber'],
			['jd_sapid_unreality', 'jd_oneiric_feeding', 'jd_vision_indulgence', 'jd_show_body', 'jd_eternal_slumber'],
			['jd_sapid_unreality', 'jd_oneiric_feeding', 'jd_show_body', 'jd_eternal_slumber'],
		],
		ai_position = ['ranged'],
		xpreward = 120,
		need_req = true,
	...
	fat_bandit = {
		...
		tags = ['human','bandit'],
		ai = [['basic', 75], ['ads', 25], ['aoe', 20], ['damage', 10], ['support', 10], ['debuff', 10], ['taunt', 25], ['selfbuf', 50], ['heal', 10]],
		skill_rotation = [
			['howling_rising_axe', 'attack'],
			['clumsy_log_splitter', 'fat_bandit_charge', 'attack'],
			['brutal_axe_swing', 'attack'],
			['fat_bandit_charge', 'attack'],
		],
		ai_position = ['melee'],
		xpreward = 15,
		allowed_mastery = [],
	...
	redhead_boss_bandit = {
		...
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/bandit_redhead.png",
		skills = ['attack','confusing_order','redhead_masterful_swordmanship','beat_em_up','redhead_magic'],
		traits = ['self_preservation','redhead_boss_trait'],
		tags = ['human','bandit'],
		ai = [['basic', 75], ['ads', 25], ['aoe', 20], ['damage', 10], ['support', 10], ['instant', 10], ['taunt', 25], ['selfbuf', 50], ['heal', 10]],
		ai_position = ['melee'],
		skill_rotation = [
			['redhead_masterful_swordmanship', 'attack'],
			['beat_em_up', 'attack'],
			['confusing_order', 'attack'],
			['redhead_magic', 'attack'],
		],
		xpreward = 15,
		allowed_mastery = [],
	},
	small_bandit = {
		...
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/bandit_small.png",
		skills = ['attack','straight_forward_slash','god_this_is_embarrassing','flimsy_dagger_toss','dont_mind_me'],
		traits = ['self_preservation','swifty_guy_trait'],
		tags = ['human','bandit'],
		ai = [['basic', 75], ['ads', 25], ['aoe', 20], ['damage', 10], ['support', 10], ['instant', 10], ['taunt', 25], ['selfbuf', 50], ['heal', 10]],
		ai_position = ['melee'],
		skill_rotation = [
			['straight_forward_slash', 'attack'],
			['god_this_is_embarrassing', 'attack'],
			['flimsy_dagger_toss', 'attack'],
			['dont_mind_me', 'attack'],
		],
		xpreward = 15,
		allowed_mastery = [],
	...
	lilith_boss = {
		...
		matk = 105,
		speed = [65,30],
		resists = {light = -50, dark = 75, mind = 50},
		status_resists = {stun = 50, freeze = 50, disarm = 35, silence = 55},
		race = 'demon',
		loot = 'erebus_stone_loot',
		icon = "res://assets/images/enemies/lilith_boss.png",
		skills = ['bad_touch','ambushing_tendrils','vile_pheromone','aphrodisiac_bombardment','tide_of_tentacles','ashmedai_wwbop','ashmedai_regen_appendage','burst_forth_my_pulsing_flesh'],
		traits = ['boss_resists','tantalising_tentacle', 'demon_god_mastery_lust'],
		tags = ['demon', 'deity','boss'],
#		ai = [['ads', 33],['aoe',33], ['basic', 33]],
		ai = [['basic', 33], ['damage', 33], ['debuff', 33], ['ads', 33], ['aoe', 33],['resurrect', 20]],
		ai_position = ['ranged'],
		skill_rotation = [
			['ashmedai_wwbop', 'vile_pheromone', 'bad_touch'],['ashmedai_wwbop', 'ambushing_tendrils', 'bad_touch'],
			['ashmedai_wwbop', 'burst_forth_my_pulsing_flesh', 'ashmedai_regen_appendage', 'bad_touch'],['ashmedai_wwbop', 'tide_of_tentacles', 'bad_touch'],
			['ashmedai_wwbop', 'burst_forth_my_pulsing_flesh', 'ashmedai_regen_appendage', 'bad_touch'],['ashmedai_wwbop', 'aphrodisiac_bombardment', 'bad_touch'],
		],
		xpreward = 50,
		preset_masteries = {},
		need_req = true,
...
#		ai = [['ads', 33],['aoe',33], ['basic', 33]],
	...
	ashmedai_tentacle = {
		...
		matk = 80,
		speed = 80,
		resists = {light = -75, dark = 50, mind = 25},
		race = 'demon',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/ashmedai_tentacle.png",
		skills = ['tentacle_lasso', 'sticky_fluids', 'constricting_bind'],
		traits = ['slippery_thick_skin'],
		tags = ['demon','tentacle'],
		ai = [['damage', 30], ['ads', 30], ['debuff', 80],['important', 200]],
		ai_position = ['melee'],
		xpreward = 30,
		allowed_mastery = [],
	},
...
#		ai = [['ads', 66],['basic', 33]],
		...
		skill_rotation = [
			['entangle','firearr','attack'],
			['overwhelming_flame','firearr','attack'],
			['overwhelming_flame','firearr','attack'],
			['i_must_resist'],
		],
		ai_position = ['ranged'],
	...
	leon = {
		...
		speed = [85, 25],
		resists = {},
		status_resists = {stun = 40, freeze = 50, sleep = 80, poison = 30, disarm = 50},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/enemy_leon.png",
		skills = ['lion_swipe','bramble_trap','jaw_of_life','primal_roar','mad_dash','regression_curse_run_amok'],
		traits = ['boss_resists','leon_ambush_predator','leon_sanguine_instinct','leon_cornered_beast'],
		tags = ['human','boss'],
		ai = [],
		skill_rotation = [
			['bramble_trap', 'mad_dash', 'jaw_of_life'],['jaw_of_life'],
			['primal_roar', 'lion_swipe', 'jaw_of_life'],['mad_dash', 'bramble_trap', 'jaw_of_life'],
			['lion_swipe', 'primal_roar', 'jaw_of_life'],['regression_curse_run_amok', 'Unskippable'],
		],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
	...
	kuro = {
		...
		matk = 115,
		speed = [97,55],
		resists = {light = -50, dark = 30},
		status_resists = {stun = 50, freeze = 50, sleep = 100, blind = 100},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/kuro.png",
		skills = ['void_barrage', 'encroaching_dusk', 'night_night', 'silent_night', 'raze_the_light', 'bump_in_the_night', 'skewing_shadow', 'attack', 'veil'],
		traits = ['boss_resists', 'nixx_blessing_nyctophobia', 'snuffing_out_the_candle'],
		tags = ['human','boss'],
		ai = [['damage', 33],['buff', 33], ['ads', 33], ['aoe', 33], ['cleanse', 33], ['debuff', 33]],
		skill_rotation = [
			['encroaching_dusk', 'Unskippable'],['night_night', 'raze_the_light', 'silent_night', 'attack'],
			['void_barrage', 'silent_night', 'attack'],['bump_in_the_night', 'raze_the_light', 'silent_night', 'attack'],
			['skewing_shadow', 'silent_night', 'attack'],['veil', 'silent_night', 'raze_the_light', 'attack'],
		],
		ai_position = ['ranged'],
		xpreward = 50,
		preset_masteries = {},
	...
	white_stag = {
		...
		matk = 200,
		speed = [75,58],
		resists = {air = 25, fire = -25},
		status_resists = {stun = 50, freeze = 50, disarm = 100, sleep = 70},
		race = 'beast',
		loot = 'white_stag_loot',
		icon = "res://assets/images/enemies/white_stag.png",
		skills = ['manchineel_apple','wild_trampling','goring_rush','curse_primeval_regression','graze_the_grass_priority','graze_the_grass','how_dissapointing','attack'],
		traits = ['boss_resists','the_ever_adapting_nature','cycle_of_life','test_of_the_forest_spirit'],
		tags = ['boss'],
		ai = [['basic', 33], ['damage', 33], ['debuff', 66], ['aoe', 33], ['heal', 33], ['buff', 10], ['selfbuf', 33]],
		skill_rotation = [
			['how_dissapointing', 'manchineel_apple', 'goring_rush', 'wild_trampling'],['manchineel_apple', 'curse_primeval_regression', 'wild_trampling'],
			['how_dissapointing', 'manchineel_apple', 'graze_the_grass_priority','graze_the_grass', 'wild_trampling'],['manchineel_apple', 'goring_rush', 'wild_trampling'],
			['how_dissapointing', 'manchineel_apple', 'curse_primeval_regression', 'wild_trampling'],['manchineel_apple', 'wild_trampling'],
		],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
	...
	white_stag_human = {
		...
		skills = ['manchineel_apple','smothering_kudzu','grass_graze_back','curse_primeval_regression','liana_flogging','imposing_pressure'],
		traits = ['boss_resists', 'the_ever_adapting_nature','white_stag_white_fog','cycle_of_life'],
		tags = ['boss'],
		ai = [['basic', 33], ['debuff', 33], ['damage', 33], ['summon', 33], ['support', 33], ['aoe', 33]],
		skill_rotation = [
			['smothering_kudzu', 'manchineel_apple', 'grass_graze_back', 'liana_flogging'],['grass_graze_back', 'curse_primeval_regression', 'liana_flogging'],
			['manchineel_apple', 'curse_primeval_regression', 'grass_graze_back', 'liana_flogging'],['manchineel_apple', 'grass_graze_back', 'liana_flogging'],
			['manchineel_apple', 'grass_graze_back', 'imposing_pressure', 'liana_flogging'],['manchineel_apple', 'grass_graze_back', 'liana_flogging'],
		],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
	...
	smothering_kudzu = {
		...
		matk = 50,
		speed = 64,
		resists = {fire = -100, mind = 50, light = 50, dark = -50, water = 30, earth = 75},
		race = 'plant',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/maneater_plant.png",
		skills = ['suffocating_greenery','engulf_by_evergreen','sensing_nutrient','attack'],
		traits = ['kudzu_first_strike','cycle_of_life_subject'],
		tags = ['plant',],
		ai = [['basic', 33], ['debuff', 33], ['damage', 33], ['summon', 33], ['support', 33], ['aoe', 33]],
		skill_rotation = [['suffocating_greenery','sensing_nutrient','engulf_by_evergreen','attack']],
		ai_position = ['melee'],
		xpreward = 30,
	},
	the_stride = {
		...
		skills = ['disarm_enemy','backkick','graze_the_grass','graze_the_grass_priority','attack'],
		traits = ['cycle_of_life_subject','entrance_animation_hare'],
		tags = ['beast','spirit'],
		ai = [['basic', 33], ['debuff', 33], ['damage', 33], ['summon', 33], ['support', 33], ['aoe', 33]],
		skill_rotation = [['backkick'],['graze_the_grass_priority','graze_the_grass'],['disarm_enemy']],
		ai_position = ['melee'],
		xpreward = 30,
	},
	the_shell = {
		...
		matk = 55,
		speed = 35,
		resists = {fire = 50, air = -50, water = 50, earth = -50},
		race = 'beast',
		loot = 'bandit_loot',
		icon = "res://assets/images/iconsskills/icon_turtle.png",
		skills = ['provocation','muddy_water','attack'],
		traits = ['cycle_of_life_subject','entrance_animation_turtle'],
		tags = ['beast','spirit'],
		ai = [['basic', 33], ['debuff', 33], ['damage', 33], ['summon', 33], ['support', 33], ['aoe', 33]],
		skill_rotation = [['provocation'],['muddy_water'],['muddy_water']],
		ai_position = ['melee'],
		xpreward = 30,
	},
	the_talon = {
		...
		matk = 85,
		speed = 60,
		resists = {water = -50, earth = 75},
		race = 'beast',
		loot = 'bandit_loot',
		icon = "res://assets/images/iconsskills/icon_eagle.png",
		skills = ['air_cutter','tempest','attack'],
		traits = ['cycle_of_life_subject','entrance_animation_eagle'],
		tags = ['beast','spirit'],
		ai = [['basic', 33], ['debuff', 33], ['damage', 33], ['summon', 33], ['support', 33], ['aoe', 33]],
		skill_rotation = [['air_cutter'],['tempest'],['tempest'],],
		ai_position = ['melee'],
		xpreward = 30,
	},
	elf_specter = {
		...
		traits = [],
		tags = ['undead'],
		ai = [['basic', 75], ['damage_spot', 75], ['ads', 75], ['support', 25], ['aoe', 25], ['heal', 50], ['resurrect', 10], ['taunt', 10]],
#		ai = [['basic', 75], ['aoe', 25]],
		ai_hard = [['basic', 50], ['damage_spot', 50], ['ads', 50], ['support', 50], ['aoe', 50], ['heal', 50], ['resurrect', 10], ['taunt', 10]],
#		ai_hard = [['basic', 50], ['aoe', 50]],
	...
	elf_soldier = {
		...
		tags = [],
#		ai = [['basic', 75], ['aoe', 25]],
		ai = [['basic', 75], ['damage_spread', 25], ['damage_spot', 25], ['ads', 25], ['support', 10], ['aoe', 25],  ['taunt', 25]],
		ai_hard = [['basic', 50], ['damage_spread', 50], ['damage_spot', 50], ['ads', 50], ['support', 10], ['aoe', 50],  ['taunt', 25]],
#		ai_hard = [['basic', 50], ['aoe', 50]],
		ai_position = ['melee'],
		xpreward = 20,
	...
	clansman_guard = {
		...
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/rebel_recruit.png",
		skills = ['attack', 'draw_blood','stonewall'],
		traits = [],
		tags = ['human',],
		ai = [['basic', 75], ['ads', 25], ['aoe', 20], ['damage_spot', 10], ['support', 10], ['instant', 10], ['taunt', 25], ['selfbuf', 50], ['heal', 10]],
		ai_hard = [['basic', 50], ['ads', 50], ['aoe', 50], ['damage_spot', 20], ['support', 20], ['instant', 20], ['taunt', 50], ['selfbuf', 70], ['heal', 10]],
	...
	clansman_archer = {
		...
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/bandit_archer.png",
		skills = ['ranged_attack','suppresive_fire'],
		traits = [],
		tags = ['human','bandit'],
		ai = [['basic', 66], ['ads', 33], ['selfbuf', 50], ['damage_spot', 33], ['trap', 10], ['support', 10], ['heal', 20],['aoe',90]],
		ai_position = ['ranged'],
		xpreward = 10,
		allowed_mastery = ['marksmanship','stealth','leadership'],
	},
	ramont_boss = {#daisy quest option
		...
		speed = 45,
		resists = {},
		status_resists = {stun = 100, freeze = 90, disarm = 50},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/bandit_boss.png",
		skills = ['attack','disarm_enemy','command_embargo','ramont_eviction_notice','ramont_piercing_obsidian'],
		traits = ['boss_resists','ramont_riposte_stance'],
		tags = ['human','boss'],
		ai = [['basic', 33], ['damage', 80], ['support',40], ['ultimate', 200]],
		skill_rotation = [
			['command_embargo','disarm_enemy','attack'],
			['ramont_eviction_notice','Unskippable'],
			['ramont_piercing_obsidian','attack'],
			['command_embargo','attack'],
			['disarm_enemy','attack']
		],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['melee'],
	...
	hector_boss = {#cali quest option
		...
		speed = [70,42],
		resists = {},
		status_resists = {stun = 50, freeze = 40, disarm = 30},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/bandit_boss.png",
		skills = ['attack','protect_me','enraging_belittlement','enraging_belittlement_cali','out_of_my_way','you_ungratful_mutt','sunder','draw_blood','cleave'],
		traits = ['boss_resists','hector_blood_of_mother','hector_vain_pride',],
		skill_rotation = [
			['protect_me', 'sunder', 'attack'],['you_ungratful_mutt', 'draw_blood', 'attack'],
			['protect_me', 'enraging_belittlement_cali','enraging_belittlement', 'attack'],['you_ungratful_mutt','out_of_my_way', 'attack'],
			['enraging_belittlement_cali','enraging_belittlement', 'sunder', 'attack'],['you_ungratful_mutt', 'draw_blood', 'attack'],
			['you_ungratful_mutt', 'cleave', 'attack'],['you_ungratful_mutt', 'protect_me', 'attack'],
			['you_ungratful_mutt', 'out_of_my_way', 'attack'],['you_ungratful_mutt', 'enraging_belittlement_cali','enraging_belittlement', 'draw_blood', 'attack'],
		],
		tags = ['human','boss'],
		ai = [['basic', 20], ['damage', 40], ['support', 20], ['defense', 40], ['aoe', 40], ['taunt', 40]],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
		need_req = true,
	...
	reyan_boss = {#anastasia boss
		...
		speed = [60,35],
		resists = {},
		status_resists = {stun = 65, freeze = 30, sleep = 50},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/ana_merc.png",
		skills = ['split_armor_spill_blood','dusty_whirlwind','blurring_flurry_of_blade','blinding_cross_slash','disposal','attack'],
		traits = ['boss_resists','reyan_antagonism','second_wind','dual_blade_mastery'],
		tags = ['human','boss'],
		ai = [['basic', 33], ['damage_spot', 33], ['ads', 66], ['aoe', 33],  ['damage', 10], ['selfbuf', 33], ['trap', 66]],
		skill_rotation = [
			['disposal', 'split_armor_spill_blood', 'attack'],['disposal', 'dusty_whirlwind', 'attack'],
			['disposal', 'blurring_flurry_of_blade', 'attack'],['disposal', 'blinding_cross_slash', 'attack'],
		],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
	...
	grotus_ascended = {
		...
		skill_rotation = [
			['grotus_obliteration','grotus_haymaker'],['grotus_obliteration','grotus_stomping'],
			['grotus_obliteration','grotus_thunderous_slam'],['grotus_obliteration','grotus_power_surge','grotus_haymaker'],
			['grotus_obliteration','grotus_energy_discharge','grotus_haymaker'],['grotus_obliteration','grotus_stomping'],
			['grotus_obliteration','grotus_thunderous_slam'],['grotus_obliteration','grotus_present_thyself'],
		],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
	...
	dwarf_king = {
		...
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/king.png",
		skills = ['attack','sunder', 'summon_random_dk_guard', 'kill_them_now', 'dk_buff_ally', 'crossbowmen_on_my_command', 'dk_blow_em_up', 'emperor_hammerfall', 'open_the_magma_chamber'],
		traits = ['boss_resists','dwarf_king_trait'],
		tags = ['human','dwarf','royalty'],
		ai = [['basic', 66], ['damage_spot', 33], ['damage', 33],['summon', 33], ['ads', 33], ['heal', 10], ['debuff', 10], ['buff',30]],
		skill_rotation = [
			['open_the_magma_chamber', 'kill_them_now', 'sunder', 'attack'],['open_the_magma_chamber', 'summon_random_dk_guard', 'dk_buff_ally', 'attack'],
			['open_the_magma_chamber', 'dk_blow_em_up',  'crossbowmen_on_my_command', 'emperor_hammerfall', 'attack'],['open_the_magma_chamber', 'summon_random_dk_guard', 'dk_buff_ally', 'attack'],
			['open_the_magma_chamber', 'dk_buff_ally', 'sunder', 'attack'],['open_the_magma_chamber', 'summon_random_dk_guard', 'crossbowmen_on_my_command', 'attack'],
			['open_the_magma_chamber', 'dk_blow_em_up', 'emperor_hammerfall', 'sunder', 'attack'],['open_the_magma_chamber', 'emperor_hammerfall', 'kill_them_now', 'sunder', 'attack'],
			['open_the_magma_chamber', 'dk_buff_ally', 'crossbowmen_on_my_command', 'sunder', 'attack'],['open_the_magma_chamber', 'dk_blow_em_up', 'attack'],
		],
		ai_position = ['melee'],
		xpreward = 150,
		need_req = true,
	...
	dwarven_skirmisher = {
		...
		matk = 50,
		speed = 65,
		resists = {dark = 40, light = 80, earth = -20, fire = -50},
		status_resists = {disarm = 50},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/dwarf fighter.png",
		skills = ['double_bitted_axe','cleave','execution'],
		traits = ['dwarf_skirmisher_trait'],
		tags = ['human',],
		ai = [['basic', 66], ['damage', 33], ['debuff',33], ['ads', 33], ['heal', 10], ['taunt', 10]],
		ai_position = ['melee'],
		xpreward = 15,
	},
	dwarven_shielder = {
		code = 'dwarven_shielder',
		name = '',
		descript = '',
		hpmax = 750,
		armor = 250,
		...
		matk = 20,
		speed = 55,
		resists = {fire = 40, earth = 80, water = -20, air = -50},
		status_resists = {shred = 50},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/iconsskills/icon_endure.png",
		skills = ['attack','disarm_enemy','stonewall','strike_through'],
		traits = ['dwarf_shielder_trait'],
		tags = ['human'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['heal', 10], ['taunt', 10]],
		ai_position = ['melee'],
		xpreward = 15,
	...
	obsidian_golem = {
		...
		matk = 85,
		speed = 30,
		resists = {air = 40, fire = 80, normal = -20, light = -50},
		status_resists = {stun = 100, bleed = 100, poison = 100},
		race = 'golem',
		loot = 'guardian_golem_loot',
		icon = "res://assets/images/enemies/guardian_golem.png",
		skills = ['prismatic_beam','tremor_wave','rock_slide'],
		traits = ['obsidian_golem_trait'],
		tags = ['golem'],
		ai = [['basic', 100],['damage',50]],
		skill_rotation = [
			['tremor_wave','prismatic_beam'],
			['tremor_wave','prismatic_beam'],
			['rock_slide','prismatic_beam'],
		],
		ai_position = ['melee'],
		xpreward = 25,
	},

	#coalition finale (act 3, refused Bolthar) - skills and traits in skilldata/bosses/coalition.gd.
	#Everyone here gets exactly one action per round; the fight is meant to get easier with each kill.
	coal_bolthar = {
		code = 'coal_bolthar',
		name = '',
		descript = '',
		...
		matk = 60,
		speed = 85,
		resists = {earth = 50, light = 50, dark = 20},
		status_resists = {},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/gnome.png",
		skills = ['attack', 'coal_pebble_fist', 'coal_iron_mountain_lean', 'coal_nerve_point', 'coal_mighty_step', 'coal_rock_sling', 'coal_five_stones'],
		traits = ['boss_resists', 'coal_bolthar_trait'],
		tags = ['human', 'gnome', 'boss'],
		ai = [['basic', 20], ['damage', 66], ['damage_spot', 40], ['ads', 40], ['aoe', 40], ['debuff', 30], ['ultimate', 60]],
		skill_rotation = [
			['coal_five_stones', 'coal_pebble_fist', 'coal_nerve_point'],
			['coal_five_stones', 'coal_iron_mountain_lean', 'coal_rock_sling'],
			['coal_five_stones', 'coal_pebble_fist', 'coal_mighty_step'],
			['coal_five_stones', 'coal_nerve_point'],
	...
	coal_kobold = {
		...
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/kobold mage.png",
		skills = ['attack', 'coal_magma_pendant', 'coal_cursed_flint', 'coal_fan_o_flame', 'coal_lava_spill', 'coal_throat_spray', 'coal_dragon_tonic'],
		traits = ['boss_resists', 'coal_kobold_trait'],
		tags = ['kobold', 'boss'],
		ai = [['basic', 15], ['damage', 66], ['ads', 40], ['aoe', 40], ['debuff', 30], ['heal', 40], ['support', 30], ['ultimate', 60]],
		skill_rotation = [
			['coal_dragon_tonic', 'coal_lava_spill', 'coal_cursed_flint', 'coal_magma_pendant', 'coal_throat_spray'],
			['coal_dragon_tonic', 'coal_magma_pendant', 'coal_throat_spray'],
			['coal_dragon_tonic', 'coal_fan_o_flame', 'coal_throat_spray'],
		],
		ai_position = ['ranged'],
		xpreward = 60,
		need_req = true,
	...
	coal_ratkin = {
		...
		matk = 70,
		speed = 70,
		resists = {water = 50, earth = 20, fire = -40},
		status_resists = {},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/RatIcon2.png",
		skills = ['attack', 'dip_poison', 'coal_poison_vapors', 'coal_paralytic_reaction', 'coal_rodent_agility', 'coal_hazardous_outburst', 'coal_epidemic_begin'],
		traits = ['boss_resists', 'ratkin_hide', 'coal_ratkin_trait'],
		tags = ['ratkin', 'boss'],
		ai = [['basic', 15], ['damage', 66], ['ads', 40], ['aoe', 30], ['debuff', 40], ['buff', 40], ['support', 30], ['ultimate', 60]],
		skill_rotation = [
			['coal_epidemic_begin', 'coal_rodent_agility', 'dip_poison'],
			['coal_epidemic_begin', 'coal_poison_vapors', 'dip_poison'],
			['coal_epidemic_begin', 'coal_paralytic_reaction', 'coal_hazardous_outburst'],
			['coal_epidemic_begin', 'coal_poison_vapors', 'dip_poison'],
		],
		ai_position = ['melee'],
		xpreward = 60,
	...
	coal_goblin = {
		...
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/hobgoblin alchemist.png",
		skills = ['attack', 'coal_frag_grenade', 'coal_flash_grenade', 'coal_incendiary_grenade', 'coal_land_mine', 'coal_reloading', 'coal_big_red_button'],
		traits = ['boss_resists', 'coal_goblin_trait'],
		tags = ['goblin', 'boss'],
		ai = [['basic', 10], ['damage', 66], ['ads', 40], ['aoe', 30], ['debuff', 40], ['buff', 40], ['support', 40], ['summon', 60], ['ultimate', 60]],
		skill_rotation = [
			['coal_big_red_button', 'coal_reloading'],
		],
		ai_position = ['ranged'],
		xpreward = 60,
		need_req = true,
	...
	coal_dwarf = {
		...
		matk = 30,
		speed = 50,
		resists = {fire = 30, earth = 30},
		status_resists = {},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/dwarf fighter.png",
		skills = ['attack', 'double_bitted_axe', 'stonewall', 'coal_chop_off', 'hammerfall', 'coal_yield_my_flesh', 'coal_mountain_crumble'],
		traits = ['boss_resists', 'coal_dwarf_trait'],
		tags = ['human', 'dwarf', 'boss'],
		ai = [['basic', 40], ['damage', 60], ['ads', 40], ['debuff', 30], ['buff', 40], ['support', 40], ['heal', 30], ['taunt', 20], ['ultimate', 60]],
		skill_rotation = [
	...
	test_summon = {
		...
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/demon_enemy.png",
		skills = ['imperial_noble_protection'],
		traits = [],
		tags = ['demon','bandit'],
		ai = [['buff', 33],['support',500]],
		ai_position = ['ranged'],
		xpreward = 30,
	},
	rilu_maddened = {
		...
		matk = 95,
		speed = [75,50],
		resists = {dark = 40, mind = 30, light = -40},
		status_resists = {stun = 60, freeze = 40, sleep = 20, silence = 40, disarm = 10},
		race = 'humanoid',
		loot = 'lich_loot',
		icon = "res://assets/images/enemies/rilu.png",
		skills = ['attack', 'ominous_whispers', 'hexed_coffin_nail', 'crazed_spirit_possession', 'forced_exorcism','forced_exorcism_prio','undying_spirit',],
		traits = ['boss_resists','cursed_girl','guardian_spirit_protection_frenzied'],
		tags = ['human','boss'],
		ai = [['damage_spot', 40],['heal',20], ['ads', 40], ['aoe', 40], ['ultimate', 20]],
		ai_position = ['ranged'],
		skill_rotation = [
			['ominous_whispers', 'hexed_coffin_nail'],['crazed_spirit_possession', 'hexed_coffin_nail'],
			['hexed_coffin_nail', 'crazed_spirit_possession'],['forced_exorcism_prio','forced_exorcism', 'hexed_coffin_nail'],
			['crazed_spirit_possession', 'hexed_coffin_nail'],['undying_spirit', 'hexed_coffin_nail'],
		],
		xpreward = 60,
		need_req = true,
	},
	sebastian = {
		...
		matk = 155,
		speed = [70,53],
		resists = {dark = 95, light = -50},
		status_resists = {stun = 40, freeze = 60, sleep = 50, silence = 60, bleed = 30},
		race = 'undead',
		loot = 'lich_loot',
		icon = "res://assets/images/enemies/lich.png",
		skills = ['attack', 'arrival_of_the_departed', 'ticket_please', 'afterlife_amenities', 'dead_running','end_of_the_line','no_light_tunnel_end',],
		traits = ['boss_resists','fbr_ceaseless_harvest','first_class_service','death_and_taxes','rilu_payback'],
		tags = ['boss','undead'],
		ai = [['damage', 40],['heal',20], ['debuff', 40], ['aoe', 40], ['support',30], ['resurrect',20], ['summon',15], ['ultimate', 20]],
		ai_position = ['ranged'],
		skill_rotation = [
			['arrival_of_the_departed', 'afterlife_amenities'],['no_light_tunnel_end', 'ticket_please', 'afterlife_amenities'],
			['no_light_tunnel_end', 'dead_running', 'ticket_please', 'afterlife_amenities'],['no_light_tunnel_end', 'afterlife_amenities'],
			['no_light_tunnel_end', 'ticket_please', 'afterlife_amenities'],['no_light_tunnel_end', 'end_of_the_line', 'afterlife_amenities'],
		],
		xpreward = 80,
		need_req = true,
	},
	talisman_wrapped_undead = {
		code = 'talisman_wrapped_undead',
		name = '',
		descript = '',
		hpmax = 2020,
		armor = 80,
		...
		matk = 89,
		speed = 63,
		resists = {light = -50, mind = 50, dark = 70},
		status_resists = {bleed = 1000, poison = 1000},
		race = 'undead',
		loot = 'lich_loot',
		icon = "res://assets/images/enemies/cultist.png",
		skills = ['talisman_disguised_as_ticket','cumulating_curse'],
		traits = ['you_want_ticket'],
		tags = ['undead'],
		ai = [['damage_spread', 66], ['damage_spot', 33], ['ads', 66], ['support', 10], ['aoe', 33], ['damage', 10]],
		ai_position = ['ranged'],
		skill_rotation = [
			['talisman_disguised_as_ticket','cumulating_curse'],
		],
		xpreward = 35,
		need_req = true,
	},
	giant_skeleton_golem = {
		code = 'giant_skeleton_golem',
		name = '',
		descript = '',
		hpmax = 2360,
		armor = 206,
		...
		matk = 65,
		speed = 40,
		resists = {light = -100, dark = 85, mind = 70},
		status_resists = {bleed = 1000, poison = 1000, disarm = 1000},
		race = 'undead',
		loot = 'skeleton_melee_loot',
		icon = "res://assets/images/enemies/bone golem.png",
		skills = ['talisman_guided_punch','bonemeal_spray'],
		traits = ['giant_ribcage'],
		tags = ['undead'],
		ai = [['damage_spot', 100], ['aoe', 50],],
		ai_position = ['ranged'],
		xpreward = 35,
	},
	bileful_zombie = {
		...
		matk = 80,
		speed = 35,
		resists = {fire = -50, light = -100, dark = 70, mind = 50, water = 50},
		status_resists = {poison = 1000},
		race = 'undead',
		loot = 'zombie_loot',
		icon = "res://assets/images/enemies/mutant2.png",
		skills = ['weighty_colision','waste_discharge'],
		traits = ['bloated_with_noxious_gas'],
		tags = ['undead'],
		ai = [['damage_spot', 10], ['ads', 33], ['aoe', 33], ['instant', 10], ['taunt', 10]],
		ai_position = ['melee'],
		xpreward = 10,
	},
	rabid_zombie = {
		...
		matk = 5,
		speed = 90,
		resists = {fire = -50, light = -100, dark = 50, mind = 75},
		status_resists = {poison = 1000,},
		race = 'undead',
		loot = 'zombie_loot',
		icon = "res://assets/images/enemies/zombie.png",
		skills = ['quick_death'],
		traits = ['adrenal_glands_overdrive'],
		tags = ['undead'],
		ai = [['damage_spot', 10], ['ads', 33], ['aoe', 33], ['instant', 10], ['damage', 10]],
		ai_position = ['melee'],
		skill_rotation = [['quick_death',],],
		xpreward = 10,
	},
	muscular_zombie = {
		code = 'muscular_zombie',
		name = '',
		descript = '',
		hpmax = 720,
		armor = 85,
		...
		matk = 5,
		speed = 40,
		resists = {earth = -50, light = -100, dark = 50, mind = 50},
		status_resists = {poison = 100},
		race = 'undead',
		loot = 'zombie_loot',
		icon = "res://assets/images/enemies/mutant1.png",
		skills = ['swelling_muscle','hysterical_strength'],
		traits = ['go_postal'],
		tags = ['undead'],
		ai = [['damage_spot', 10], ['ads', 33], ['aoe', 33], ['support', 90], ['taunt', 10]],
		ai_position = ['melee'],
		xpreward = 10,
	},

	melchor_chancellor = {
		code = 'melchor_chancellor',
		name = '',
		descript = '',
		hpmax = 4200,
		armor = 70,
		...
		critchance = 5,
		critmod = 0.3,
		resists = {light = 50, fire = 25, earth = 25, mind = 25, dark = -25},
		status_resists = {stun = 75, freeze = 75, sleep = 100},
		race = 'humanoid',
		loot = 'hard_boss_chest',
		icon = "res://assets/images/sprites/advisor.png",
		skills = ['melchor_word_of_laws','melchor_restraining_order','melchor_obstruction','melchor_emergency_lockdown','melchor_summary_judgment','melchor_buster_call'],
		traits = ['boss_resists','melchor_chancellor_of_palatine','melchor_regulation_clause','melchor_clear_the_field'],
		tags = ['human','boss','imperial'],
		ai = [['basic', 10], ['damage', 66], ['damage_spot', 66], ['ads', 50], ['aoe', 50], ['debuff', 50], ['heal', 40], ['support', 40], ['ultimate', 66]],
		skill_rotation = [
			['melchor_buster_call','melchor_restraining_order','melchor_obstruction'],['melchor_buster_call','melchor_word_of_laws','melchor_obstruction'],
			['melchor_buster_call','melchor_restraining_order','melchor_obstruction'],['melchor_buster_call','melchor_word_of_laws','melchor_obstruction'],
			['melchor_buster_call','melchor_emergency_lockdown','melchor_obstruction'],['melchor_buster_call','melchor_summary_judgment','melchor_obstruction'],
		],
		ai_position = ['ranged'],
		xpreward = 150,
		preset_masteries = {},
	...
	rouge_third_party = {
		...
		critmod = 0.6,
		resists = {dark = 25},
		status_resists = {stun = 50, freeze = 50, sleep = 30, fear = 100},
		race = 'humanoid',
		loot = 'hard_boss_chest',
		icon = "res://assets/images/portraits/rouge_prt.png",
		skills = ['rouge_puncture_artery','rouge_feasting_frenzy','rouge_adamant_pursuit','rouge_nail_stiletto','rouge_eat_your_heart_out'],
		traits = ['boss_resists','rouge','rouge_refracted_image','rouge_third_party','rouge_appetizer'],
		tags = ['human','boss'],
		ai = [['basic', 40], ['damage', 66], ['damage_spot', 66], ['ads', 50], ['debuff', 40], ['buff', 50], ['support', 30], ['ultimate', 80]],
		skill_rotation = [
			['rouge_puncture_artery','rouge_nail_stiletto','attack'],['rouge_feasting_frenzy','rouge_nail_stiletto','attack'],
			['rouge_adamant_pursuit','rouge_nail_stiletto','attack'],['rouge_nail_stiletto','attack'],
			['rouge_eat_your_heart_out','rouge_feasting_frenzy','attack'],['rouge_eat_your_heart_out','rouge_adamant_pursuit','attack'],
		],
		ai_position = ['melee'],
		xpreward = 120,
		preset_masteries = {},
	...
	imperial_soldier = {
		...
		speed = 55,
		resists = {},
		status_resists = {fear = 50},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/humanguard.png",
		skills = ['attack','imperial_coordinate_attack','imperial_threat_suppression','imperial_bastion','imperial_noble_protection','imperial_weed_out'],
		traits = ['imperial_soldier_training'],
		tags = ['human','imperial'],
		ai = [['basic', 40], ['damage', 50], ['damage_spot', 40], ['ads', 40], ['debuff', 40], ['support', 60], ['buff', 50], ['heal', 30]],
		ai_position = ['melee'],
		xpreward = 40,
		need_req = true,
	},
	mhyrana_cultist = {
		code = 'mhyrana_cultist',
		name = '',
		descript = '',
		hpmax = 400,
		armor = 20,
		...
		matk = 60,
		speed = 45,
		resists = {dark = 25, light = -25},
		status_resists = {},
		race = 'humanoid',
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/cultist.png",
		skills = ['attack','mindblast'],
		traits = ['imperial_purge_target'],
		tags = ['human','cultist'],
		ai = [['basic', 50], ['damage', 50], ['ads', 33]],
		ai_position = ['ranged'],
		xpreward = 10,
	},
}
