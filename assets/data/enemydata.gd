...
#		ai = [['ads', 33],['aoe',33], ['basic', 33]],
	...
	kurdan = {
		...
		tags = ['human','boss'],
#		ai = [['ads', 66],['basic', 33]],
		ai = [['basic', 33], ['damage_spot', 66], ['ads', 66], ['support', 10]],
		ai_position = ['ranged'],
		xpreward = 25,
...
#		ai = [['basic', 66], ['ads', 33]],
	...
	hector_boss = {#cali quest option
		...
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/bandit_boss.png",
		skills = ['attack','hector_protect_me','enraging_belittlement','enraging_belittlement_cali','out_of_my_way','you_ungratful_mutt','sunder','draw_blood','cleave'],
		traits = ['boss_resists','hector_blood_of_mother','hector_vain_pride',],
		skill_rotation = [
			['hector_protect_me', 'sunder', 'attack'],['you_ungratful_mutt', 'draw_blood', 'attack'],
			['hector_protect_me', 'enraging_belittlement_cali','enraging_belittlement', 'attack'],['you_ungratful_mutt','out_of_my_way', 'attack'],
			['enraging_belittlement_cali','enraging_belittlement', 'sunder', 'attack'],['you_ungratful_mutt', 'draw_blood', 'attack'],
			['you_ungratful_mutt', 'cleave', 'attack'],['you_ungratful_mutt', 'hector_protect_me', 'attack'],
		...
		tags = ['human','boss'],
		ai = [['basic', 20], ['damage', 40], ['selfish', 20], ['defense', 40], ['aoe', 40], ['taunt', 40]],
		ai_position = ['melee'],
		xpreward = 100,
		preset_masteries = {},
		need_req = true,
