...
var encounters = {
	...
	lira_quest3_den_boss = {unittype = 'randomgroup', unitcode = 'bandits_medium_boss', bg = 'combat_forest', bgm = 'default', win_effects = [{code = 'start_event', data = 'lira_quest3_bandit_leader_1', args = []}], lose_effects = [{code = 'start_event', data = 'generic_lose_scene', args = []}]},
...
#		ai = [['ads', 33],['aoe',33], ['ads', 33]],
	...
	jean_evil = {
		...
		tags = ['human','demon','boss'],
		gear = [],
		ai = [['basic', 33], ['damage_spread', 33], ['damage_spot', 33], ['ads', 33], ['aoe', 33], ['heal', 10],],
		
#		ai = [['ads', 33],['aoe',33], ['basic', 33]],
		ai_position = ['ranged'],
		xpreward = 50,
		preset_masteries = {dark = 3, fire = 6, air = 4},
	},
	jean_demon = {
		code = 'jean_demon',
		name = '',
...
#		ai = [['ads', 33],['aoe',33], ['basic', 33]],
		ai_position = ['ranged'],
		xpreward = 50,
		preset_masteries = {dark = 6, fire = 2, earth = 3},
	},
