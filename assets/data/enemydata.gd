...
var enemygroups = {
	...
	act4_road_cave_melchor_only = {maxunits = 6, reqs = [], units = {melchor_chancellor = [1,1], imperial_soldier = [4,4], mhyrana_cultist = [1,1]}},
...
#		ai = [['basic', 66], ['ads', 33]],
	...
	test_boss = {
		...
		loot = 'bandit_loot',
		icon = "res://assets/images/enemies/demon_enemy.png",
		skills = ['bonemeal_spray'],
		traits = ['boss_resists', 'first_class_service'],
		tags = ['demon','bandit'],
	...
	melchor_chancellor = {
		...
		skill_rotation = [
			['melchor_buster_call','melchor_restraining_order','melchor_obstruction'],
			['melchor_buster_call','melchor_word_of_laws','melchor_obstruction'],
			['melchor_buster_call','melchor_restraining_order','melchor_obstruction'],
			['melchor_buster_call','melchor_word_of_laws','melchor_obstruction'],
			['melchor_buster_call','melchor_emergency_lockdown','melchor_obstruction'],
			['melchor_buster_call','melchor_summary_judgment','melchor_obstruction'],
		],
		ai_position = ['ranged'],
		xpreward = 150,
		preset_masteries = {},
	...
	rouge_third_party = {
		...
		critmod = 0.6,
		resists = {dark = 25},
		status_resists = {stun = 50, freeze = 50, fear = 100},
		race = 'humanoid',
		loot = 'hard_boss_chest',
		icon = "res://assets/images/sprites/rouge.png",
		...
		skill_rotation = [
			['rouge_puncture_artery','rouge_nail_stiletto','attack'],
			['rouge_feasting_frenzy','rouge_nail_stiletto','attack'],
			['rouge_adamant_pursuit','rouge_nail_stiletto','attack'],
			['rouge_nail_stiletto','attack'],
			['rouge_eat_your_heart_out','rouge_feasting_frenzy','attack'],
			['rouge_eat_your_heart_out','rouge_adamant_pursuit','attack'],
		],
		ai_position = ['melee'],
		xpreward = 120,
		preset_masteries = {},
