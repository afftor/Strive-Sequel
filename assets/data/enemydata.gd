...
var enemygroups = {
	...
	rebel_convoy = {reqs = [], units = {rebel_recruit = [2,2],  rebel_mage = [1,1]}, challenges = [['event_enemy_dexterity_sneak', 1],['event_enemy_charm_avoid',0.8]], challenge_chance = 0.4},
	...
	event_rebels_2 = {reqs = [], units = {rebel_knight = [1,1], rebel_healer = [1,1], rebel_mage = [1,1]}, challenges = [['event_enemy_dexterity_sneak', 1],['event_enemy_charm_avoid',0.8]], challenge_chance = 0.4},
...
var enemies = {
	...
	rebel_knight = {
		...
		skills = ['attack','cleave','sunder'],
		traits = [],
		tags = ['human'], 
		ai = [['basic', 50], ['ads', 25], ['aoe', 25]],
