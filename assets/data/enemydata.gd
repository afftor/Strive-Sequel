...
#		ai = [['basic', 30], ['ads', 40], ['aoe', 30]],
	...
	greg = {
		...
		traits = ['boss_resists'],
		tags = ['human','boss'],
		ai = [['basic', 66], ['ads', 33], ['support', 33], ['aoe', 33], ['heal', 33], ['taunt', 33]],
#		ai = [['basic', 66], ['ads', 33]],
		ai_position = ['melee'],
		xpreward = 100,
	...
	greg_act4 = {
		...
		traits = ['boss_resists'],
		tags = ['human','boss'],
		ai = [['basic', 66], ['damage_spot', 33], ['ads', 33], ['support', 33], ['aoe', 33], ['instant', 33], ['heal', 33], ['taunt', 33]],
#		ai = [['ads', 66],['aoe',33]],
		ai_position = ['melee'],
		xpreward = 100,
...
#		ai = [['ads', 66],['aoe',33]],
	...
	nixx = {
		...
		matk = 150,
		speed = 60,
		resists = {dark = 100, mind = 50, light = -50},
		status_resists = {stun = 100, freeze = 90},
		race = 'demon',
		loot = 'nixx_reward',
		...
		traits = ['boss_resists'],
		tags = ['boss'],
		ai = [['damage_spread', 50], ['damage_spot', 50], ['ads', 50], ['aoe', 50]],
#		ai = [['ads', 50],['aoe',50]],
		ai_position = ['melee'],
		xpreward = 100,
