	...
	resource_gather_fish = {
		...
		levels = {
			1:{
				...
				taskprogress = 15,
				cost = {wood = 50, fish = 35},
			},
			2:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 30,
				cost = {wood = 100, fish = 85},
			},
			3:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 45,
				cost = {wood = 200, stone = 100, fish = 120},
			},
			4:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 60,
				cost = {woodmagic = 100, stone = 100, fish = 170},
			},
			5:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
			...
			6:{
				...
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 90,
				cost = {woodiron = 100, stone = 100, fish = 170},
			},
			7:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
	...
	resource_gather_meat = {
		...
		levels = {
			1:{
				...
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 15,
				cost = {wood = 50, grain = 7},
			},
			2:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 30,
				cost = {wood = 100, grain = 35},
			},
			3:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 45,
				cost = {wood = 200, stone = 100, grain = 85},
			},
			4:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 60,
				cost = {woodmagic = 100, stone = 100, grain = 120},
			},
			5:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 75,
				cost = {woodmagic = 100, stone = 100, grain = 135},
			},
			6:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 90,
				cost = {woodiron = 100, stone = 100, grain = 170},
			},
			7:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
	...
	resource_gather_veges = {
		...
		levels = {
			1:{
				...
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 15,
				cost = {wood = 50, vegetables = 17},
			},
			2:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 30,
				cost = {wood = 100, vegetables = 50},
			},
			3:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 45,
				cost = {wood = 200, stone = 100, vegetables = 85},
			},
			4:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 60,
				cost = {woodmagic = 100, stone = 100, vegetables = 120},
			},
			5:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 75,
				cost = {woodmagic = 100, stone = 100, vegetables = 170},
			},
			6:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 90,
				cost = {woodiron = 100, stone = 100, vegetables = 170},
			},
			7:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
	...
	resource_gather_grain = {
		...
		levels = {
			1:{
				...
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 15,
				cost = {wood = 50, grain = 17},
			},
			2:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 30,
				cost = {wood = 100, grain = 50},
			},
			3:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
			...
			5:{
				...
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
				taskprogress = 75,
				cost = {woodmagic = 100, stone = 100, grain = 170},
			},
			6:{
				unlockreqs = [],
				bonusdescript = tr("UPGRADERESOURCE_MAXIMUM1"),
