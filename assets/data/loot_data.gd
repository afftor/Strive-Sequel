...
var loot_tables = {
	...
	plains_area_shop = {list = [
		{material = 'meat', min = 13, max = 27},
		{material = 'fish', min = 13, max = 27, chance = 0.9},
		{material = 'vegetables', min = 13, max = 27, chance = 0.9},
		{material = 'grain', min = 20, max = 50},
		{material = 'bread', min = 10, max = 20},
	...
	forests_area_shop = {list = [
		{material = 'vegetables', min = 13, max = 27},
		{material = 'grain', min = 20, max = 50},
		{material = 'bread', min = 10, max = 20},
		{material = 'vegetable_stirfry', min = 1, max = 2},
	...
	mountain_area_shop = {list = [
		...
		{material = 'grain', min = 20, max = 50},
		{material = 'bread', min = 10, max = 20},
		{material = 'miners_lunch', min = 1, max = 2},
		{material = 'clothsilk', min = 10, max = 15, chance = 0.9},
		{material = 'bone', min = 5, max = 20, chance = 0.7},
		{item = 'lifeshard', min = 4, max = 8},
	...
	empire_area_shop = {list = [
		...
		{material = 'grain', min = 20, max = 50},
		{material = 'bread', min = 10, max = 20},
		{material = 'roasted_feast', min = 1, max = 2},
		{material = 'defenders_meal', min = 1, max = 2},
		{material = 'clothsilk', min = 10, max = 15, chance = 0.9},
		{material = 'bone', min = 5, max = 20, chance = 0.7},
	...
	beastkin_area_shop = {list = [
		{material = 'meat', min = 13, max = 27},
		{material = 'fishcakes', min = 1, max = 2},
	...
	settlement_plains1_shop = {list = [
		{material = 'meat', min = 7, max = 10, chance = 0.2},
		{material = 'fish', min = 5, max = 15},
		{material = 'vegetables', min = 7, max = 10, chance = 0.2},
		{material = 'grain', min = 13, max = 20, chance = 0.9},
	...
	settlement_plains2_shop = {list = [
		{material = 'meat', min = 7, max = 17, chance = 0.8},
		{material = 'fish', min = 5, max = 15, chance = 0.6},
		{material = 'vegetables', min = 7, max = 13, chance = 0.9},
		{material = 'grain', min = 13, max = 20, chance = 0.9},
	...
	biome_grove_res = {selector = [
		{material = 'meat', weight = 6, min = 30, max = 40},
