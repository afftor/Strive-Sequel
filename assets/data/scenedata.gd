...
#			},
	...
	tutorial_wolves_start = {text = tr("DIALOGUEWOLVES_SKIRMISH_START"), set_enemy = 'tutorial_skirmish',tags = [], image = 'wolves_skirmish', options = [{code = 'fight_skirmish', reqs = [], text = tr("DIALOGUEFIGHTOPTION")},{code = 'leave', reqs = [], text = tr("DIALOGUELEAVE")}]},
...
#		},
		...
		},
		{
			code = 'default',
			name = tr("DIALOGUEMEETLEADER"),
			reqs = [{type = 'active_quest_stage', value = 'jean_sylas_quest', stage = 'stage14'}],
			target = 'jean_sylas_keep_sphere_1',
			target_option = 1,
		},
		{
			code = 'default',
...
#			stage1 = {code = 'stage1', name = "ZEPHYRA_DISAPPEARANCE_QUEST_NAME", descript = "ZEPHYRA_DISAPPEARANCE_QUEST_STAGE_1"}, # search for Zephyra
	...
	jean_sylas_quest = {
		...
		stages = {
			stage1 = {code = 'stage1', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_1'},
			stage2 = {code = 'stage2', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_2'},
			stage3 = {code = 'stage3', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_3'},
			stage4 = {code = 'stage4', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_4'},
			stage5 = {code = 'stage5', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_5'},
			stage6 = {code = 'stage6', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_6'},
			stage7 = {code = 'stage7', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_7'},
			stage8 = {code = 'stage8', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_8'},
			stage9 = {code = 'stage9', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_9'},
			stage10 = {code = 'stage10', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_10'},
			stage11 = {code = 'stage11', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_11'},
			stage12 = {code = 'stage12', name = 'JEAN_SYLAS_QUEST_NAME', descript = 'JEAN_SYLAS_QUEST_STAGE_12'},
	...
	lira_quest_3 = {
		...
		stages = {
			...
			empire = {code = 'empire', name = 'LIRA_QUEST3_QUEST_NAME', descript = 'LIRA_QUEST3_QUEST_STAGE_EMPIRE'},
			road = {code = 'road', name = 'LIRA_QUEST3_QUEST_NAME', descript = 'LIRA_QUEST3_QUEST_STAGE_ROAD'},
			den = {code = 'den', name = 'LIRA_QUEST3_QUEST_NAME', descript = 'LIRA_QUEST3_QUEST_STAGE_DEN'},
			caravan_prepare = {code = 'caravan_prepare', name = 'LIRA_QUEST3_QUEST_NAME', descript = 'LIRA_QUEST3_QUEST_STAGE_CARAVAN_PREPARE'},
			caravan_attack = {code = 'caravan_attack', name = 'LIRA_QUEST3_QUEST_NAME', descript = 'LIRA_QUEST3_QUEST_STAGE_CARAVAN_ATTACK'},
			follow_leader = {code = 'follow_leader', name = 'LIRA_QUEST3_QUEST_NAME', descript = 'LIRA_QUEST3_QUEST_STAGE_FOLLOW_LEADER'},
	...
	rouge_quest = {
		...
		stages = {
			...
			tax_intro = {code = 'tax_intro', name = 'ROUGE_QUEST_NAME', descript = 'ROUGE_QUEST_STAGE_TAX_INTRO'},
			tax_errand = {code = 'tax_errand', name = 'ROUGE_QUEST_NAME', descript = 'ROUGE_QUEST_STAGE_TAX_ERRAND'},
			tax_done = {code = 'tax_done', name = 'ROUGE_QUEST_NAME', descript = 'ROUGE_QUEST_STAGE_TAX_DONE'},
			rouge_meet = {code = 'rouge_meet', name = 'ROUGE_QUEST_NAME', descript = 'ROUGE_QUEST_STAGE_ROUGE_MEET'},
	...
	erdyna_quest = {
		...
		stages = {
			...
			thalendir_visit = {code = 'thalendir_visit', name = 'ACT4_ERDYNA_QUEST_NAME', descript = 'ACT4_ERDYNA_QUEST_STAGE_THALENDIR_VISIT'},
	...
	heleviel_quest1 = {
		...
		summary = "HELEVIEL_QUEST1_SUMMARY",
		stages = {
			stage1 = {code = 'stage1', name = 'HELEVIEL_QUEST1_NAME', descript = "HELEVIEL_SLAVE_STAGE_1"},
			stage2 = {code = 'stage2', name = 'HELEVIEL_QUEST1_NAME', descript = "HELEVIEL_SLAVE_STAGE_2"},
		},
	},
	heleviel_quest2 = {
		code = 'heleviel_quest2',
		summary = "HELEVIEL_QUEST2_SUMMARY",
		stages = {
			stage3 = {code = 'stage3', name = 'HELEVIEL_QUEST2_NAME', descript = "HELEVIEL_SLAVE_STAGE_3"},
			stage4 = {code = 'stage4', name = 'HELEVIEL_QUEST2_NAME', descript = "HELEVIEL_SLAVE_STAGE_4"},
		},
	},
	heleviel_quest3 = {
		code = 'heleviel_quest3',
		summary = "HELEVIEL_QUEST3_SUMMARY",
		stages = {
			stage5 = {code = 'stage5', name = 'HELEVIEL_QUEST3_NAME', descript = "HELEVIEL_SLAVE_STAGE_5"},
