...
#	},
	...
	event_dungeon_coccoon_1 = {
		text = tr("DIALOGUEEVENTDUNGEONCOCCOON_1"),
		tags = ['linked_event'],
		default_event_type = "character_event",
		image = 'cell', #fix
		common_effects = [
		...
		options = [
			{code = 'event_dungeon_coccoon_2', reqs = [{type = 'has_stamina', value = 10}], text = ("DIALOGUEEVENTDUNGEONCOCCOON_OPTION1")},
			{code = 'event_dungeon_coccoon_3', select_person = true, challenge = 'strength', reqs = [{type = 'has_stamina', value = 3}], text = ("DIALOGUEEVENTDUNGEONCOCCOON_OPTION2")},
			{code = 'event_dungeon_coccoon_4', reqs = [], text = tr("DIALOGUELEAVE")},
		]
	},
	event_dungeon_coccoon_2 = {
		text = tr("DIALOGUEEVENTDUNGEONCOCCOON_2"),
		tags = [],
		image = '',
		common_effects = [],
		options = [
		{code = 'add_to_captured', reqs = [], text = tr("DIALOGUELEAVE"), bonus_effects = [{code = 'clear_subroom'}, {code = 'pay_stamina', value = 10}]},
		]
	},
	event_dungeon_coccoon_3 = {
		text = tr("DIALOGUEEVENTDUNGEONCOCCOON_3"),
		tags = ['active_character_translate'],
		image = '',
		common_effects = [],
		options = [
		{code = 'add_to_captured', reqs = [], text = tr("DIALOGUELEAVE"), bonus_effects = [{code = 'clear_subroom'}, {code = 'pay_stamina', value = 3}]},
		]
	},
	event_dungeon_coccoon_4 = {
		text = tr("DIALOGUEEVENTDUNGEONCOCCOON_4"),
		tags = [],
		image = '',
		common_effects = [],
		options = [
		{code = 'close', reqs = [], text = tr("DIALOGUELEAVE"), bonus_effects = [{code = 'clear_subroom'}]},
		]
	},
	event_dungeon_library_1 = {
		text = tr("DIALOGUEEVENTDUNGEONLIBRARY_1"),
		tags = ['linked_event'],
		default_event_type = "character_event",
		image = 'cell', #fix
		options = [
			{code = 'event_dungeon_library_2', reqs = [{type = 'has_stamina', value = 10}], text = ("DIALOGUEEVENTDUNGEONLIBRARY_OPTION1")},
			{code = 'event_dungeon_library_3', select_person = true, challenge = 'wisdom', reqs = [{type = 'has_stamina', value = 3}], text = ("DIALOGUEEVENTDUNGEONLIBRARY_OPTION2")},
			{code = 'event_dungeon_library_4', reqs = [], text = tr("DIALOGUELEAVE")},
		]
	},
	event_dungeon_library_2 = {
		text = tr("DIALOGUEEVENTDUNGEONLIBRARY_2"),
		tags = [],
		image = '',
		common_effects = [{code = 'make_loot',type = 'tableloot', pool = [['medium_boss_chest',1]]}],
		options = [
		{code = 'open_chest', reqs = [], text = tr("DIALOGUELEAVE"), bonus_effects = [{code = 'clear_subroom'}, {code = 'pay_stamina', value = 10}]},
		]
	},
	event_dungeon_library_3 = {
		text = tr("DIALOGUEEVENTDUNGEONLIBRARY_3"),
		tags = ['active_character_translate'],
		image = '',
		common_effects = [{code = 'make_loot',type = 'tableloot', pool = [['medium_boss_chest',1]]}],
		options = [
		{code = 'open_chest', reqs = [], text = tr("DIALOGUELEAVE"), bonus_effects = [{code = 'clear_subroom'}, {code = 'pay_stamina', value = 2}]},
		]
	},
	event_dungeon_library_4 = {
		text = tr("DIALOGUEEVENTDUNGEONLIBRARY_4"),
		tags = [],
		image = '',
		common_effects = [],
		options = [
	...
	event_dungeon_coffin_1 = {
		text = tr("DIALOGUEEVENTDUNGEONCOFFIN_1"),
		tags = ['linked_event'],
		default_event_type = "character_event",
		image = 'cell', #fix
		options = [
			{code = 'event_dungeon_coffin_2', reqs = [{type = 'has_stamina', value = 5}], text = ("DIALOGUEEVENTDUNGEONCOFFIN_OPTION1")},
			{code = 'event_dungeon_coffin_3', reqs = [], text = ("DIALOGUEEVENTDUNGEONCOFFIN_OPTION2")},
		]
	},
	event_dungeon_coffin_2 = {
		text = tr("DIALOGUEEVENTDUNGEONCOFFIN_2"),
		tags = [],
		image = '',
		common_effects = [{code = 'make_loot',type = 'tableloot', pool = [['medium_boss_chest',1]]}],
		options = [
		{code = 'open_chest', reqs = [], text = tr("DIALOGUELEAVE"), bonus_effects = [{code = 'clear_subroom'}, {code = 'pay_stamina', value = 5}]},
		]
	},
	event_dungeon_coffin_3 = {
		text = tr("DIALOGUEEVENTDUNGEONCOFFIN_3"),
		tags = [],
		image = '',
		common_effects = [],
		options = [
		{code = 'close', reqs = [], text = tr("DIALOGUELEAVE"), bonus_effects = [{code = 'affect_active_party', type = 'effect', value = 'e_coffin_bless'}, {code = 'clear_subroom'}]},
		]
	},
