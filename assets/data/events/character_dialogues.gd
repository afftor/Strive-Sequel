...
var data = {
	zephyra_dialogue_start = {
		...
		options = [
			{
				code = "zephyra_dialogue_start",
				text = "ZEPHYRA_EXTRA_OPTION1",
				reqs = [
			...
			{
				code = "zephyra_dialogue_2",
				text = "ZEPHYRA_EXTRA_OPTION2",
				reqs = [
			...
			{
				code = "zephyra_brush_8",
				text = "ZEPHYRA_BRUSH_8_OPTION_0",
				reqs = [
					{
						type = "decision",
						value = "GotZephyrasBrush",
						check = true
					},
					{
						type = "dialogue_seen",
						check = false,
						value = "ZEPHYRA_BRUSH_8"
					}
				],
				dialogue_argument = 1,
				repeat_next_day = true
			},
			{
				code = "zephyra_brush_19",
				text = "ZEPHYRA_BRUSH_19_OPTION_0",
				reqs = [
					{
						type = "dialogue_seen",
						check = false,
						value = "ZEPHYRA_BRUSH_19"
					},
					{
						type = "dialogue_selected",
						check = true,
						value = "ZEPHYRA_BRUSH_6_OPTION_1"
					},
					{
						type = "dialogue_selected",
						check = true,
						value = "ZEPHYRA_BRUSH_8_OPTION_0"
					}
				],
				dialogue_argument = 1,
				repeat_next_day = true
	...
	zephyra_dialogue_2 = {
		...
		options = [
			{
				code = "zephyra_dialogue_3",
				text = "ZEPHYRA_EXTRA_OPTION2_1",
				reqs = [
	...
	zephyra_dialogue_3 = {
		...
		options = [
			{
				code = "zephyra_dialogue_2",
				text = "ZEPHYRA_EXTRA_OPTION2_1_1",
				reqs = [
			...
			{
				code = "zephyra_dialogue_2",
				text = "ZEPHYRA_EXTRA_OPTION2_1_2",
				reqs = [
			...
			{
				code = "zephyra_dialogue_2",
				text = "ZEPHYRA_EXTRA_OPTION2_1_3",
				reqs = [
	...
	amelia_dialogue_start = {
		...
		options = [
			{
				code = "cali_servants_new_leader_6",
				text = "CALI_SERVANTS_AMELIA_OPTION_1",
				reqs = [
					{
						type = "decision",
					...
					},
					{
						type = "dialogue_seen",
						check = false,
						value = "CALI_SERVANTS_NEW_LEADER_6"
					}
				],
				dialogue_argument = 4,
				type = "next_dialogue"
	...
	anastasia_dialogue_start = {
		...
		text = [
			{
				...
				reqs = [
					{
						type = "decision",
						value = "mindbreak_completed",
						check = false
					},
					{
						type = "decision",
						value = "anastasia_rape_scene",
						check = false
					},
					{
						type = "active_character_checks",
		...
		options = [
			{
				code = "ana_gryphon_sex_start",
				text = "GRYPHON_ANA_SEX_OPTION_INIT",
				reqs = [
					{
						type = "decision",
						value = "AnaAireThreesome",
						check = true
					},
					{
						type = "dialogue_seen",
						check = false,
						value = "GRYPHON_ANA_SEX_10"
					}
				],
				dialogue_argument = 1
			},
	...
	daisy_dialogue_start = {
		...
		options = [
			{
				code = "daisy_serve_start",
				text = "DAISY_SERVE_OPTION_START",
				reqs = [
					{
	...
	daisy_dialogue_1_1 = {
		...
		text = [
			...
			{
				text = "DAISY_EXTRA_REPLY_1_1_YES",
				reqs = [
	...
	daisy_dialogue_1_2 = {
		...
		text = [
			...
			{
				text = "DAISY_EXTRA_REPLY_1_2_YES",
				reqs = [
	...
	daisy_serve_start = {
		...
		options = [
			{
				code = "daisy_serve_1_1",
				text = "DAISY_SERVE_OPTION_1_1",
				reqs = [
					{
						type = "quest_completed",
						name = "daisy_training",
			...
			{
				code = "daisy_serve_2_1",
				text = "DAISY_SERVE_OPTION_1_2",
				reqs = [
					{
						type = "quest_completed",
						name = "daisy_lost",
			...
			{
				code = "daisy_dialogue_start",
				text = "DAISY_SERVE_OPTION_1_3",
				reqs = [
	...
	aire_dialogue_start = {
		...
		options = [
			{
				code = "aire_gryphon_sex_start",
				text = "GRYPHON_AIRE_SEX_START_OPTION_INIT",
				reqs = [
					{
						type = "quest_completed",
						name = "gryphon_quest",
	...
	cali_dialogue_start = {
		...
		options = [
			{
				code = "cali_sword_return_1",
				text = "CALI_SWORD_RETURN_INIT",
				reqs = [
					{
						type = "active_quest_stage",
						value = "cali_heirloom_quest",
						stage = "stage9"
					}
				],
				dialogue_argument = 1,
			...
			{
				code = "cali_act3_blow_1",
				text = "CALI_ACT3_BLOW_OPTION_INIT",
				reqs = [
					{
						type = "active_quest_stage",
	...
	cali_serve_start = {
		...
		options = [
			{
				code = "cali_serve_1_1",
				text = "CALI_SERVE_OPTION_1_1",
				reqs = [
					{
						type = "quest_completed",
						name = "cali_heirloom_quest",
						check = true
					}
				],
				dialogue_argument = 1,
			...
			{
				code = "cali_dialogue_start",
				text = "CALI_SERVE_OPTION_1_3",
				reqs = [
	...
	lilith_dialogue_start = {
		...
		options = [
			{
				code = "lilith_patron_meeting",
				text = "LILITH_PATRON_MEETING_OPTION",
				reqs = [
					{
						type = "active_quest_stage",
	...
	kuro_dialogue_start = {
		...
		options = [
			{
				code = "kuro3_dialogue_1",
				text = "KURO3_DIALOGUE_INIT",
				reqs = [
					{
						type = "event_seen",
						check = false,
						value = "kuro3_dialogue_1"
					}
				]
			},
			{
				code = "kuro3_dialogue2_1",
				text = "KURO3_DIALOGUE2_INIT",
				reqs = [
					{
						type = "quest_completed",
						name = "kuro_quest_3",
