...
var data = {
	...
	marriage_church_4 = {
		...
		options = [
				{code = 'close', text = "MARRIAGE_CHURCH_CLOSE_OPTION", reqs = [], type = 'next_dialogue', bonus_effects = [{code = 'progress_quest', value = 'marriage_quest_main', stage = 'stage2'}],}
			],
	},
	...
	marriage_servants_2 = {
		...
		options = [
				{code = 'marriage_servants_completed_1', text = "MARRIAGE_SERVANTS_COMPLETE_OPTION", reqs = [
					...
					{type = 'has_material', operant = 'gte', value = 50, material = 'fish'},
					{type = 'has_material', operant = 'gte', value = 50, material = 'meat'},
					{type = 'has_material', operant = 'gte', value = 50, material = 'vegetables'},
					{type = 'has_material', operant = 'gte', value = 50, material = 'grain'},
	...
	marriage_servants_completed_1 = {
		...
		text = [{text = "MARRIAGE_SERVANTS_COMPLETE_1", reqs = [], bonus_effects = [
			...
			{code = 'material_change', operant = '-', material = 'fish', value = 50},
			{code = 'material_change', operant = '-', material = 'meat', value = 50},
			{code = 'material_change', operant = '-', material = 'vegetables', value = 50},
			{code = 'material_change', operant = '-', material = 'grain', value = 50},
...
#		character2 = 'spouse',
	...
	marriage_night_group_2 = {
		...
		common_effects = [{code = 'money_change', operant = '+', value = 5000}],
		options = [
