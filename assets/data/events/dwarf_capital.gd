				...
				reqs = [
					{
						type = "event_seen",
						check = false,
						value = "dwarf_tavern_bark_physics"
					},
					{
						type = "event_seen",
						check = false,
						value = "dwarf_tavern_bark_leave"
					}
				]
			},
			{
				code = "dwarf_tavern_patron",
				text = "DWARF_TAVERN_PATRONS",
				reqs = [
	...
	dwarf_workshop = {
		variations = [
			...
			},
			{
				...
				text = [
					{
						text = "DWARF_WARKSHOP_START",
						reqs = [

						]
					},
					{
						text = "DKING2TASK_HARA_START",
						reqs = [
