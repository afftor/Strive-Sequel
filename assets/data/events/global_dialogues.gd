...
var data = {
	fighters_introduction2 = {
		...
		{code = 'princess_search_fighters_3', text = "SEARCH_FIGHTERS_OPTION_4", reqs = [{type = 'active_quest_stage', value = 'princess_search', stage = 'stage2'}, {type = 'dialogue_seen', check = false, value = 'SEARCH_FIGHTERS_3'}, {type = 'decision', value = 'aire_is_dead', check = false}], type = 'next_dialogue', dialogue_argument = 11},
	...
	workers_introduction2 = {
		...
		{code = 'final_operation_workers_1', text = "FINAL_OPERATON_WORKERS_OPTION_1", reqs = [{type = 'active_quest_stage', value = 'final_operation', stage = 'stage2'}, {type = 'dialogue_seen', check = false, value = 'FINAL_OPERATON_WORKERS_1'}], dialogue_argument = 1, type = 'next_dialogue'},
...
#		type = 'next_dialogue', dialogue_argument = 1, remove_after_first_use = true},
	...
	mages_introduction3 = {
		...
		{code = 'looking_for_princess_mages_pre_bracelet', text = "LOOKING_FOR_PRINCESS_OPTION_19_1", reqs = [{type = 'decision', value = 'bracelet_found', check = false}, {type = 'dialogue_seen', check = false, value = 'LOOKING_FOR_PRINCESS_19_1'}, {type = 'active_quest_stage', value = 'princess_search', stage = 'stage2'}],
		dialogue_argument = 6, type = 'next_dialogue', },
