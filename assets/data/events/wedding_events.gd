...
var data = {
	...
	mae_wedding_1 = { 
		...
		scene_type = "ero_scene",
		music = "intimate",
		custom_background = "mae_wedding_1",
		save_scene_to_gallery = true,
		unlocked_gallery_seq = "mae_wed",
		reqs = [], 
		text = [{text = "MAE_WEDDING_1", reqs = [], }], 
		options = [ 
			{code = 'mae_wed_2', text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = 'next_dialogue',}, 
			],
	},
	mae_wed_2 = { 
		image = null, tags = ['dialogue_scene', 'master_translate'],
		scene_type = "ero_scene",
		custom_background = "mae_wedding_2",
		save_scene_to_gallery = true,
		reqs = [], 
		text = [{text = "MAE_WEDDING_2", reqs = [], }], 
		options = [ {code = 'mae_wed_3', text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = 'next_dialogue',}, ],
	},
	mae_wed_3 = { 
		image = null, tags = ['dialogue_scene', 'master_translate'],
		scene_type = "ero_scene",
		custom_background = "mae_wedding_4",
		save_scene_to_gallery = true,
		reqs = [], 
		text = [{text = "MAE_WEDDING_3", reqs = [], }], 
		options = [ {code = 'mae_wed_4', text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = 'next_dialogue',}, ],
	},
	mae_wed_4 = { 
		image = null, tags = ['dialogue_scene', 'master_translate'],
		scene_type = "ero_scene",
		custom_background = "mae_wedding_5",
		save_scene_to_gallery = true,
		reqs = [], 
		text = [{text = "MAE_WEDDING_4", reqs = [], }], 
		options = [{code = 'mae_wed_5', text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = 'next_dialogue',},],
	},
	mae_wed_5 = { 
		image = null, tags = ['dialogue_scene', 'master_translate'],
		scene_type = "ero_scene",
		custom_background = "mae_wedding_7",
		save_scene_to_gallery = true,
		reqs = [], 
		text = [{text = "MAE_WEDDING_5", reqs = [], }], 
		options = [ {code = 'close', text = "DIALOGUECLOSE", reqs = [], dialogue_argument = 1, type = 'next_dialogue', bonus_effects = [{code = 'complete_quest', value = 'marriage_quest_main'}, {code = 'complete_wedding'} ]}, ],
	},
	jean_wedding_1 = { 
		image = null, tags = ['dialogue_scene'],
		...
		character = 'jean_wed',
		save_scene_to_gallery = true,
		unlocked_gallery_seq = "jean_wed",
		reqs = [], 
		text = [{text = "JEAN_WED_1", reqs = [], }], 
		options = [ 
			{code = 'jean_wed_2', text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = 'next_dialogue', change_dialogue_type = 2}, 
			],
	},
	jean_wed_2 = { 
		image = null, tags = ['dialogue_scene'],
		scene_type = "ero_scene",
		custom_background = "jean_wedding_1",
		save_scene_to_gallery = true,
		reqs = [], 
		text = [{text = "JEAN_WED_2", reqs = [], }], 
		options = [ {code = 'jean_wed_3', text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = 'next_dialogue',}, ],
	},
	jean_wed_3 = { 
		image = null, tags = ['dialogue_scene'],
		scene_type = "ero_scene",
		custom_background = "jean_wedding_2",
		save_scene_to_gallery = true,
		reqs = [], 
		text = [{text = "JEAN_WED_3", reqs = [], }], 
		options = [ {code = 'jean_wed_4', text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = 'next_dialogue',}, ],
	},
	jean_wed_4 = { 
		image = null, tags = ['dialogue_scene'],
		scene_type = "ero_scene",
		custom_background = "jean_wedding_3",
		save_scene_to_gallery = true,
		reqs = [], 
		text = [{text = "JEAN_WED_4", reqs = [], }], 
		options = [{code = 'jean_wed_5', text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = 'next_dialogue',},],
	},
	jean_wed_5 = { 
		image = null, tags = ['dialogue_scene'],
		scene_type = "ero_scene",
		...
		save_scene_to_gallery = true,
		reqs = [], 
		text = [{text = "JEAN_WED_5", reqs = [], }], 
		options = [{code = 'jean_wed_6', text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = 'next_dialogue',},],
	},
	jean_wed_6 = { 
		image = null, tags = ['dialogue_scene'],
		scene_type = "ero_scene",
		custom_background = "jean_wedding_4",
		save_scene_to_gallery = true,
		reqs = [], 
		text = [{text = "JEAN_WED_6", reqs = [], }], 
		options = [ {code = 'close', text = "DIALOGUECLOSE", reqs = [], dialogue_argument = 1, type = 'next_dialogue', bonus_effects = [{code = 'complete_quest', value = 'marriage_quest_main'}, {code = 'complete_wedding'} ]}, ],
	},
}
