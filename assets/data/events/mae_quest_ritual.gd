...
var data = {
	mae_spirit_quest_initiate = {
		...
		reqs = [
			...
			{
				type = "decision",
				value = "mae_spirit_quest_started",
				check = false
			}
		],
		character = "mae",
		...
		options = [
			{
				code = "mae_spirit_quest_response",
				text = "MAE_SPIRIT_QUEST_INITIATE_OPTION_1",
				reqs = [
			...
			{
				code = "mae_spirit_quest_response",
				text = "MAE_SPIRIT_QUEST_INITIATE_OPTION_2",
				reqs = [
			...
			{
				code = "mae_spirit_quest_response",
				text = "MAE_SPIRIT_QUEST_INITIATE_OPTION_3",
				reqs = [
	...
	mae_spirit_quest_response = {
		...
		text = [
			...
			{
				text = "MAE_SPIRIT_QUEST_INITIATE_RESPONSE_2",
				reqs = [
			...
			{
				text = "MAE_SPIRIT_QUEST_INITIATE_RESPONSE_3",
				reqs = [
	...
	mae_spirit_follow_savra = {
		...
		options = [
			{
				code = "mae_spirit_follow_savra_2",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_follow_savra_2 = {
		...
		options = [
			{
				code = "mae_spirit_follow_midnight",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_follow_midnight = {
		...
		options = [
			{
				code = "mae_spirit_follow_response",
				text = "MAE_SPIRIT_FOLLOW_OPTION_1",
				reqs = [
			...
			{
				code = "mae_spirit_follow_response",
				text = "MAE_SPIRIT_FOLLOW_OPTION_2",
				reqs = [
			...
			{
				code = "mae_spirit_follow_response",
				text = "MAE_SPIRIT_FOLLOW_OPTION_3",
				reqs = [
	...
	mae_spirit_follow_response = {
		...
		text = [
			...
			{
				text = "MAE_SPIRIT_FOLLOW_RESPONSE_2",
				reqs = [
			...
			{
				text = "MAE_SPIRIT_FOLLOW_RESPONSE_3",
				reqs = [
	...
	mae_spirit_ritual_start = {
		...
		options = [
			{
				code = "mae_spirit_ritual_stag_intro",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_ritual_stag_intro = {
		...
		options = [
			{
				code = "mae_spirit_ritual_stag_challenge",
				text = "DIALOGUECONTINUE",
				reqs = [
		...
		options = [
			{
				...
				bonus_effects = [
					{
						code = "decision",
						value = "mae_spirit_hide_unlocked"
					},
					{
						code = "progress_quest",
						value = "mae_spirit_quest",
	...
	mae_spirit_white_stag_continuation = {
		...
		text = [
			{
				text = "MAE_SPIRIT_WHITE_STAG_CONTINUATION_1",
				reqs = [

				]
			},
			{
				text = "MAE_SPIRIT_WHITE_STAG_CONTINUATION_2",
				reqs = [
					{
						type = "decision",
						value = "mae_druid_training_done",
						check = true
					}
				]
			},
			{
				text = "MAE_SPIRIT_WHITE_STAG_CONTINUATION_3",
				reqs = [

				]
			},
			{
				text = "MAE_SPIRIT_WHITE_STAG_MAE_OWL",
				reqs = [
					{
						type = "decision",
						value = "mae_druid_training_done",
			...
			{
				text = "MAE_SPIRIT_WHITE_STAG_MAE_SAFE",
				reqs = [
					{
						type = "decision",
						value = "mae_druid_training_done",
			...
			{
				text = "MAE_SPIRIT_WHITE_STAG_MAE_SATYR",
				reqs = [
					{
						type = "decision",
						value = "mae_druid_training_done",
		...
		options = [
			...
			},
			{
				...
				bonus_effects = [
					{
						code = "decision",
						value = "mae_spirit_velhorn"
					},
					{
						code = "dialogue_counter",
						name = "mae_sex_actions",
						op = "+"
					},
					{
						code = "dialogue_counter",
	...
	mae_spirit_after_choice = {
		...
		options = [
			{
				code = "mae_spirit_after_choice_response",
				text = "MAE_SPIRIT_AFTER_CHOICE_OPTION_1",
				reqs = [
			...
			{
				code = "mae_spirit_after_choice_response",
				text = "MAE_SPIRIT_AFTER_CHOICE_OPTION_2",
				reqs = [
			...
			{
				code = "mae_spirit_after_choice_response",
				text = "MAE_SPIRIT_AFTER_CHOICE_OPTION_3",
				reqs = [
	...
	mae_spirit_after_choice_response = {
		...
		text = [
			...
			{
				text = "MAE_SPIRIT_AFTER_CHOICE_RESPONSE_2",
				reqs = [
			...
			{
				text = "MAE_SPIRIT_AFTER_CHOICE_RESPONSE_3",
				reqs = [
			...
			{
				text = "MAE_SPIRIT_AFTER_CHOICE_LEAVE",
				reqs = [
		...
		options = [
			{
				...
				bonus_effects = [
					{
						code = "make_quest_location",
						value = "quest_mae_ancient_jungle"
					},
					{
						code = "progress_quest",
						value = "mae_spirit_quest",
	...
	mae_ancient_jungle_complete_start = {
		...
		options = [
			{
				code = "mae_ancient_jungle_ritual_choice",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_ancient_jungle_ritual_choice = {
		...
		options = [
			{
				code = "mae_ancient_jungle_ritual_lewd",
				text = "MAE_ANCIENT_JUNGLE_RITUAL_OPTION_1",
				reqs = [
			...
			},
			{
				...
				text = "MAE_ANCIENT_JUNGLE_RITUAL_OPTION_2",
				reqs = [
	...
	mae_ancient_jungle_ritual_lewd = {
		...
		options = [
			{
				code = "mae_ancient_jungle_ritual_lewd_response",
				text = "MAE_ANCIENT_JUNGLE_RITUAL_LEWD_OPTION_1",
				reqs = [
			...
			{
				code = "mae_ancient_jungle_ritual_lewd_response",
				text = "MAE_ANCIENT_JUNGLE_RITUAL_LEWD_OPTION_2",
				reqs = [
	...
	mae_ancient_jungle_ritual_lewd_response = {
		...
		text = [
			...
			{
				text = "MAE_ANCIENT_JUNGLE_RITUAL_LEWD_RESPONSE_2",
				reqs = [
		...
		options = [
			{
				code = "mae_ancient_jungle_ritual_scene",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_ancient_jungle_ritual_1 = {
		...
		options = [
			{
				code = "mae_ancient_jungle_ritual_2",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_ancient_jungle_ritual_2 = {
		...
		options = [
			{
				code = "mae_ancient_jungle_ritual_3",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_ancient_jungle_ritual_4 = {
		...
		options = [
			{
				code = "mae_ancient_jungle_ritual_5",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_ancient_jungle_ritual_5 = {
		...
		options = [
			{
				code = "mae_ancient_jungle_ritual_6",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_ancient_jungle_ritual_6 = {
		...
		options = [
			{
				code = "mae_ancient_jungle_ritual_7",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_ancient_jungle_ritual_finish = {
		...
		text = [
			{
				text = "MAE_ANCIENT_JUNGLE_RITUAL_FINISH",
				reqs = [
	...
	mae_spirit_visit_savra = {
		...
		options = [
			{
				code = "mae_spirit_visit_savra_response",
				text = "MAE_SPIRIT_VISIT_SAVRA_OPTION_1",
				reqs = [
			...
			{
				code = "mae_spirit_visit_savra_response",
				text = "MAE_SPIRIT_VISIT_SAVRA_OPTION_2",
				reqs = [
		...
		options = [
			{
				...
				bonus_effects = [
					...
					{
						code = "make_quest_location",
						value = "quest_mae_northern_tribe"
					},
					{
						code = "update_city"
					}
	...
	mae_spirit_northern_arrival = {
		...
		options = [
			{
				code = "mae_spirit_northern_directions",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_directions = {
		...
		options = [
			{
				code = "mae_spirit_northern_shaman",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_shaman = {
		...
		options = [
			{
				code = "mae_spirit_northern_request",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_request = {
		...
		options = [
			{
				code = "mae_spirit_northern_request_2",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_request_2 = {
		...
		options = [
			{
				code = "mae_spirit_northern_request_3",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_request_3 = {
		...
		options = [
			{
				code = "mae_spirit_northern_offer",
				text = "MAE_NORTHERN_TRIBE_REQUEST_OPTION_1",
				reqs = [
			...
			{
				code = "mae_spirit_northern_offer",
				text = "MAE_NORTHERN_TRIBE_REQUEST_OPTION_2",
				reqs = [
	...
	mae_spirit_northern_offer = {
		...
		options = [
			{
				code = "mae_spirit_northern_offer_2",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_offer_2 = {
		...
		options = [
			{
				code = "mae_spirit_northern_ritual_consent",
				text = "MAE_NORTHERN_TRIBE_OFFER_OPTION_1",
				reqs = [
			...
			{
				code = "mae_spirit_northern_decline",
				text = "MAE_NORTHERN_TRIBE_OFFER_OPTION_2",
				reqs = [
			...
			{
				code = "mae_spirit_northern_missed",
				text = "MAE_NORTHERN_TRIBE_OFFER_OPTION_3",
				reqs = [
					{
						type = "decision",
						value = "mae_druid_training_done",
		...
		variations = [
			{
				...
				options = [
					{
						code = "mae_spirit_northern_ritual_scene_1",
						text = "DIALOGUECONTINUE",
						reqs = [
	...
	mae_spirit_northern_ritual_scene_1 = {
		...
		options = [
			{
				code = "mae_spirit_northern_ritual_scene_2",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_ritual_scene_2 = {
		...
		options = [
			{
				code = "mae_spirit_northern_ritual_scene_3",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_ritual_scene_3 = {
		...
		options = [
			{
				code = "mae_spirit_northern_ritual_scene_4",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_ritual_scene_4 = {
		...
		options = [
			{
				code = "mae_spirit_northern_ritual_scene_5",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_ritual_after = {
		...
		options = [
			{
				code = "mae_spirit_northern_ritual_gift",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_decline = {
		...
		options = [
			{
				code = "mae_spirit_northern_decline_2",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_decline_2 = {
		...
		options = [
			{
				code = "mae_spirit_northern_decline_fade",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_decline_fade = {
		...
		options = [
			{
				code = "mae_spirit_northern_decline_after",
				text = "DIALOGUECONTINUE",
				reqs = [
	...
	mae_spirit_northern_missed = {
		...
		options = [
			{
				code = "mae_spirit_northern_missed_fade",
				text = "DIALOGUECONTINUE",
				reqs = [
