...
var data = {
	jean_sylas_next_day_start = {
		...
		options = [
			...
			{code = "jean_sylas_next_day_followup", text = "JEAN_SYLAS_NEXT_DAY_OPTION_LATER", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_next_day_followup = {
		...
		options = [
			...
			{code = "jean_sylas_origin_short", text = "JEAN_SYLAS_ORIGIN_OPTION_SHORT", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
			{code = "jean_sylas_origin_repeat", text = "JEAN_SYLAS_ORIGIN_OPTION_REPEAT", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
		...
		options = [
			{
				...
				dialogue_argument = 1, 
				type = "next_dialogue",
				bonus_effects = [{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage1'}],
			},
		]
	},
	...
	jean_sylas_after_guild = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_AFTER_GUILD_RYNN_ALIVE", reqs = [{type = "decision", value = "rynn_cursed_at_church", check = true}]},
			{text = "JEAN_SYLAS_AFTER_GUILD_RYNN_LEFT", reqs = [{type = "decision", value = "rynn_cursed_at_church", check = false}]},
		],
		options = [
			{
				code = "close", 
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage2'},
					{code = 'update_city'}
					],
			},
		]
		...
		options = [
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage3'},
					{code = 'update_city'}
					],
			},
			{
			...
			},
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage4'},
					{code = 'update_city'}
					],
			},
		]
	...
	jean_sylas_arena_melchor = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_ARENA_MELCHOR_INTRO", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_ARENA_REPLY_REASON", reqs = [], previous_dialogue_option = 2},
			{text = "JEAN_SYLAS_ARENA_REPLY_NOT_FRIENDS", reqs = [], previous_dialogue_option = 3},
			{text = "JEAN_SYLAS_ARENA_REPLY_PERSONAL", reqs = [], previous_dialogue_option = 4},
		],
		options = [
			{code = "jean_sylas_arena_melchor", text = "JEAN_SYLAS_ARENA_OPTION_REASON", reqs = [], dialogue_argument = 2, remove_after_first_use = true},
			{code = "jean_sylas_arena_repljean_sylas_arena_melchory_not_friends", text = "JEAN_SYLAS_ARENA_OPTION_NOT_FRIENDS", reqs = [], dialogue_argument = 3, remove_after_first_use = true},
			{code = "jean_sylas_arena_melchor", text = "JEAN_SYLAS_ARENA_OPTION_PERSONAL", reqs = [], dialogue_argument = 4, remove_after_first_use = true},
			{code = "jean_sylas_arena_reply_dangerous", text = "JEAN_SYLAS_ARENA_OPTION_DANGEROUS", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
		...
		options = [
			{
				...
				text = "DIALOGUECONTINUE", 
				reqs = [{type = "decision", value = "JeanSylasHelpDuncan", check = false}],
				dialogue_argument = 1, 
				type = "next_dialogue"
			},
			{
	...
	jean_sylas_arena_bribe = {
		...
		options = [
			{code = "jean_sylas_arena_fighter_start", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
		...
		options = [
			{
				...
				text = "DIALOGUECONTINUE", 
				reqs = [{code = "stat", stat = "physics", operant = "gte", value = 5}], 
				dialogue_argument = 1, 
				type = "next_dialogue"
			},
			{
				...
				text = "DIALOGUECONTINUE", 
				reqs = [{code = "stat", stat = "physics", operant = "lt", value = 5}], 
				dialogue_argument = 1, 
				type = "next_dialogue"
			},
		]
	...
	jean_sylas_arena_fighter_start = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_ARENA_MYR_TALK", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_ARENA_DUNCAN_INTRO", reqs = [], previous_dialogue_option = 2},
		...
		options = [
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage6'},
					{code = 'update_city'}
					],
			},
		]
	...
	jean_sylas_merchants_talk_2 = {
		...
		options = [
			{code = "jean_sylas_merchants_talk_21", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_merchants_talk_3 = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_MERCHANTS_TALK_3", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_MERCHANTS_REPLY_START", reqs = [], previous_dialogue_option = 2},
			{text = "JEAN_SYLAS_MERCHANTS_REPLY_ENEMIES", reqs = [], previous_dialogue_option = 3},
		],
		options = [
			{code = "jean_sylas_merchants_talk_3", text = "JEAN_SYLAS_MERCHANTS_OPTION_START", reqs = [], dialogue_argument = 2, remove_after_first_use = true},
			{code = "jean_sylas_merchants_talk_3", text = "JEAN_SYLAS_MERCHANTS_OPTION_ENEMIES", reqs = [], dialogue_argument = 3, remove_after_first_use = true},
			{code = "jean_sylas_merchants_deal", text = "JEAN_SYLAS_MERCHANTS_OPTION_DEAL", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
		...
		options = [
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage5'},
					#add search task
					{code = 'update_city'}
					],
			},
		...
		options = [
			{
				...
				reqs = [{type = "unique_character_checks", name = "erdyna", value = [{code = 'is_free', check = true}]}], #or add location check here
				dialogue_argument = 1,
				type = "next_dialogue",
				bonus_effects = [
					{code = "decision", value = "JeanSylasHelpErdyna"},
				]
			},
			{code = "jean_sylas_carriage_diplomacy", text = "JEAN_SYLAS_CARRIAGE_OPTION_DIPLOMACY", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
			{code = "jean_sylas_carriage_diplomacy", text = "JEAN_SYLAS_CARRIAGE_OPTION_PAY", reqs = [], dialogue_argument = 2, type = "next_dialogue"},
			{
				code = "jean_sylas_carriage_intimidate_fail", 
				text = "JEAN_SYLAS_CARRIAGE_OPTION_INTIMIDATE", 
				reqs = [{type = "master_check", value = [{code = "stat", stat = "physics", operant = "lt", value = 5}]}],
				dialogue_argument = 1, 
				type = "next_dialogue"
			},
			{
				...
				text = "JEAN_SYLAS_CARRIAGE_OPTION_INTIMIDATE", 
				reqs = [{type = "master_check", value = [{code = "stat", stat = "physics", operant = "gte", value = 5}]}],
				dialogue_argument = 1, 
				type = "next_dialogue"
			},
		]
	...
	jean_sylas_carriage_erdyna_2 = {
		...
		options = [
			{code = "jean_sylas_carriage_after_fight", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 2, type = "next_dialogue"},
		]
	},
	jean_sylas_carriage_diplomacy = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_CARRIAGE_DIPLOMACY", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_CARRIAGE_PAY", reqs = [], previous_dialogue_option = 2},
		],
		options = [
	...
	jean_sylas_carriage_intimidate_fail = {
		...
		options = [
			{code = "jean_sylas_carriage_fight_intro", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_carriage_intimidate_1 = {
		...
		options = [
			{code = "jean_sylas_carriage_intimidate_2", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_carriage_fight_intro = {
		...
		options = [
			{code = 'quest_fight', args = 'jean_sylas_thugs', text = "DIALOGUEFIGHTOPTION", reqs = [], dialogue_argument = 1, type = 'next_dialogue',}
		]
	},
	jean_sylas_carriage_after_fight = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_CARRIAGE_AFTER_FIGHT", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_CARRIAGE_AFTER_FIGHT_DRIVER", reqs = []},
		],
		options = [
	...
	jean_sylas_brothel_girls = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_BROTHEL_GIRLS", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_BROTHEL_FLIRT_JEAN", reqs = [], previous_dialogue_option = 2},
		],
		options = [
			{code = "jean_sylas_brothel_girls", text = "JEAN_SYLAS_BROTHEL_OPTION_FLIRT", reqs = [], dialogue_argument = 2, type = "next_dialogue"},
			{code = "jean_sylas_brothel_madam_intro", text = "JEAN_SYLAS_BROTHEL_OPTION_QUESTIONS", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_brothel_madam_intro = {
		...
		options = [
			{code = "jean_sylas_brothel_madam_dismiss_1", text = "JEAN_SYLAS_BROTHEL_MADAM_OPTION_DISAPPEAR", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
			{code = "jean_sylas_brothel_madam_dismiss_1", text = "JEAN_SYLAS_BROTHEL_MADAM_OPTION_LOOKING", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_brothel_madam_dismiss_1 = {
		...
		options = [
			{code = "jean_sylas_brothel_madam_dismiss_2", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_brothel_crying = {
		...
		options = [
			{code = "jean_sylas_brothel_girl_bad", text = "JEAN_SYLAS_BROTHEL_CRYING_OPTION_TRUST", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
			{code = "jean_sylas_brothel_girl_bad", text = "JEAN_SYLAS_BROTHEL_CRYING_OPTION_DISAPPEAR", reqs = [], dialogue_argument = 2, type = "next_dialogue"},
			{
				code = "jean_sylas_brothel_amelia_intro",
				text = "JEAN_SYLAS_BROTHEL_CRYING_OPTION_AMELIA",
				rreqs = [{type = "unique_character_checks", name = "amelia", value = [{code = 'is_free', check = true}]}], #or add location check here
				dialogue_argument = 1,
				type = "next_dialogue"
			},
		]
	...
	jean_sylas_brothel_girl_bad = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_BROTHEL_GIRL_TRUST", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_BROTHEL_GIRL_KNOWS", reqs = [], previous_dialogue_option = 2},
	...
	jean_sylas_brothel_plan_intro = {
		...
		options = [
			...
			{code = "jean_sylas_girl_plan_shock", text = "JEAN_SYLAS_BROTHEL_PLAN_OPTION_GIRL", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_client_return = {
		...
		options = [
			...
			{code = "jean_sylas_client_offer", text = "JEAN_SYLAS_CLIENT_OPTION_RECOMMEND", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
			{code = "jean_sylas_client_offer", text = "JEAN_SYLAS_CLIENT_OPTION_STORMED", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_client_offer = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_CLIENT_OFFER", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_CLIENT_TELL_MORE", reqs = [], previous_dialogue_option = 2},
			{text = "JEAN_SYLAS_CLIENT_COST", reqs = [], previous_dialogue_option = 3},
		],
		options = [
			{code = "jean_sylas_client_offer", text = "JEAN_SYLAS_CLIENT_OPTION_TELL_MORE", reqs = [], dialogue_argument = 2, type = "next_dialogue", remove_after_first_use = true},
			{
				...
				bonus_effects = [
					{code = "decision", value = "JeanSylasBrothelBargain"},
				]
			},
			{code = "jean_sylas_client_decline", text = "JEAN_SYLAS_CLIENT_OPTION_DECLINE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
			{
				code = "jean_sylas_client_accept",
				text = "JEAN_SYLAS_CLIENT_OPTION_ACCEPT",
				reqs = [
					{type = "has_money", value = 200},
					{type = "decision", value = "JeanSylasBrothelBargain", check = false},
				],
				dialogue_argument = 1,
				type = "next_dialogue",
			...
			},
			{
				...
				text = "JEAN_SYLAS_CLIENT_OPTION_ACCEPT",
				reqs = [
					{type = "has_money", value = 100},
					{type = "decision", value = "JeanSylasBrothelBargain", check = true},
				],
				dialogue_argument = 1,
				type = "next_dialogue",
				bonus_effects = [{code = "money_change", operant = "-", value = 100}]
			},
		]
	},
	...
	jean_sylas_client_after = {
		...
		options = [
			...
			{code = "jean_sylas_client_after_info", text = "JEAN_SYLAS_CLIENT_AFTER_OPTION_FOUND", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_girl_plan_shock = {
		...
		options = [
			...
			{code = "jean_sylas_girl_plan_objection", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_UNDERCOVER", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_girl_plan_objection = {
		...
		options = [
			...
			{code = "jean_sylas_girl_plan_no_clothes", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_CHANGE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_girl_plan_no_clothes = {
		...
		options = [
			...
			},
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage7'},
					{code = 'update_city'}
					],
			},
		]
	...
	jean_sylas_girl_plan_gold = {
		...
		options = [
			...
			{code = "jean_sylas_girl_plan_gold_reply", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_CATCH", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_girl_plan_hallway = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_GIRL_PLAN_HALLWAY", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_GIRL_PLAN_DOOR1", reqs = [], previous_dialogue_option = 2},
			{text = "JEAN_SYLAS_GIRL_PLAN_DOOR2", reqs = [], previous_dialogue_option = 3},
			{text = "JEAN_SYLAS_GIRL_PLAN_DOOR3", reqs = [], previous_dialogue_option = 4},
		],
		options = [
			{code = "jean_sylas_girl_plan_hallway", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_DOOR1", reqs = [], dialogue_argument = 2, type = "next_dialogue", remove_after_first_use = true},
			{code = "jean_sylas_girl_plan_hallway", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_DOOR2", reqs = [], dialogue_argument = 3, type = "next_dialogue", remove_after_first_use = true},
			{code = "jean_sylas_girl_plan_hallway", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_DOOR3", reqs = [], dialogue_argument = 4, type = "next_dialogue", remove_after_first_use = true},
			{code = "jean_sylas_girl_plan_office", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_DOOR4", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_girl_plan_office = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_GIRL_PLAN_OFFICE", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_GIRL_PLAN_OFFICE", reqs = [], previous_dialogue_option = 2},
			{text = "JEAN_SYLAS_GIRL_PLAN_OFFICE", reqs = [], previous_dialogue_option = 3},
		],
		options = [
			{code = "jean_sylas_girl_plan_office", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_PAINTINGS", reqs = [], dialogue_argument = 2, type = "next_dialogue", remove_after_first_use = true},
			{code = "jean_sylas_girl_plan_office", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_CABINETS", reqs = [], dialogue_argument = 3, type = "next_dialogue", remove_after_first_use = true},
			{code = "jean_sylas_girl_plan_table", text = "JEAN_SYLAS_GIRL_PLAN_OPTION_TABLE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_girl_plan_after = {
		...
		options = [
			...
			{code = "jean_sylas_girl_plan_after_response", text = "JEAN_SYLAS_GIRL_PLAN_AFTER_OPTION_LEARNED", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_sylas_reply = {
		...
		text = [
			...
			{text = "JEAN_SYLAS_SYLAS_SERVANT_KILLED", reqs = [{type = "decision", value = "jean_q2_captive_kill", check = true}]},
			{text = "JEAN_SYLAS_SYLAS_SERVANT_FREED", reqs = [{type = "decision", value = "jean_q2_captive_free", check = true}]},
			{text = "JEAN_SYLAS_SYLAS_MONSTERS_2", reqs = []},
			{text = "JEAN_SYLAS_SYLAS_DEVICE", reqs = [{type = "decision", value = "JeanSylasHelpMyr", check = true}]},
		],
		options = [
			{code = 'quest_fight', args = 'jean_sylas_1', text = "DIALOGUEFIGHTOPTION", reqs = [{type = "decision", value = "JeanSylasHelpMyr", check = true}], dialogue_argument = 1, type = 'next_dialogue',},
			{code = 'quest_fight', args = 'jean_sylas_2', text = "DIALOGUEFIGHTOPTION", reqs = [{type = "decision", value = "JeanSylasHelpMyr", check = false}], dialogue_argument = 1, type = 'next_dialogue',},
		]
	},
		...
		options = [
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = "affect_unique_character", name = "jean", type = "set_availability", value = false},
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage8'},
					{code = 'update_city'}
					],
			},
		]
	...
	jean_sylas_myr_issue_library = {
		...
		character = "myr",
		text = [
			{text = "JEAN_SYLAS_MYR_ISSUE_LIBRARY", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_MYR_ISSUE_SNARK", reqs = [], previous_dialogue_option = 2},
		],
		options = [
			{code = "jean_sylas_myr_issue_snark", text = "JEAN_SYLAS_MYR_ISSUE_OPTION_SNARK", reqs = [], dialogue_argument = 2, remove_after_first_use = true},
			{code = "jean_sylas_myr_issue_archives", text = "JEAN_SYLAS_MYR_ISSUE_OPTION_ARCHIVES", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
		...
		options = [
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage9'},
					{code = 'update_city'},
					{
						...
						args = [{code = 'start_event', data = 'jean_sylas_library_complete', args = {}}]
					}
				],
			},
		]
		...
		options = [
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage10'},
					{code = 'update_city'}
					],
			},
		]
	...
	jean_sylas_myr_records_intro_1 = {
		...
		options = [
			{code = "jean_sylas_myr_records_intro_2", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_myr_records_intro_2 = {
		...
		options = [
			{code = "jean_sylas_myr_records_plan", text = "JEAN_SYLAS_MYR_RECORDS_OPTION_RUINS", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
	...
	jean_sylas_myr_records_plan = {
		...
		character = "myr",
		text = [
			{text = "JEAN_SYLAS_MYR_RECORDS_RUINS", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_MYR_RECORDS_PLAN", reqs = [], previous_dialogue_option = [1, 2]},
			{text = "JEAN_SYLAS_MYR_RECORDS_SAFE", reqs = [], previous_dialogue_option = 3},
		],
		options = [
			{code = "jean_sylas_myr_records_plan", text = "JEAN_SYLAS_MYR_RECORDS_OPTION_SAFE", reqs = [], dialogue_argument = 3, remove_after_first_use = true},
			{code = "jean_sylas_myr_records_artifact", text = "JEAN_SYLAS_MYR_RECORDS_OPTION_HOW", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
		...
		options = [
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage11'},
					{code = 'update_city'},
					{
						code = "add_timed_event",
						value = "jean_sylas_artifact_crafted",
						args = [
							{type = 'has_material', operant = 'eq', value = 1, material = 'mindlink', negative = "repeat_next_turn"},
							{type = "add_to_date", date = [1,1], hour = 1}
						]
					},
				],
			},
		...
		options = [
			{
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage12'},
					{code = 'make_quest_location', value = 'quest_jean_demon_location'},
					],
			},
		]
	},
	...
	jean_sylas_search_jean_intro_1 = {
		...
		options = [
			{code = "jean_sylas_search_jean_intro_2", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_search_jean_intro_2 = {
		...
		options = [
			{code = "jean_sylas_demon_time", text = "JEAN_SYLAS_SEARCH_JEAN_OPTION_LONG", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
			{code = "jean_sylas_demon_time", text = "JEAN_SYLAS_SEARCH_JEAN_OPTION_VERY_LONG", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
			{code = "jean_sylas_demon_time", text = "JEAN_SYLAS_SEARCH_JEAN_OPTION_RECORDS", reqs = [], dialogue_argument = 2, type = "next_dialogue"},
		]
	},
	jean_sylas_demon_time = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_DEMON_TIME_LONG", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_DEMON_TIME_RECORDS", reqs = [], previous_dialogue_option = 2},
			{text = "JEAN_SYLAS_DEMON_MONOLOGUE_1", reqs = []},
		],
		options = [
			{code = "jean_sylas_demon_monologue", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_demon_monologue = {
		...
		options = [
			{code = 'quest_fight', args = 'jean_demon_1', text = "DIALOGUEFIGHTOPTION", reqs = [], dialogue_argument = 1, type = 'next_dialogue',},
		]
	},
	...
	jean_sylas_dream_praise = {
		...
		options = [
			{code = "jean_sylas_dream_reply", text = "JEAN_SYLAS_DREAM_OPTION_FUN", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
			{code = "jean_sylas_dream_reply", text = "JEAN_SYLAS_DREAM_OPTION_WAKE", reqs = [], dialogue_argument = 2, type = "next_dialogue"},
		]
	},
	jean_sylas_dream_reply = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_DREAM_REPLY_FUN", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_DREAM_REPLY_WAKE", reqs = [], previous_dialogue_option = 2},
		],
		options = [
	...
	jean_sylas_wake_reality = {
		...
		common_effects = [{code = "affect_unique_character", name = "jean", type = "set_availability", value = true},],
		options = [
	...
	jean_sylas_demon_reveal = {
		...
		options = [
			{code = 'quest_fight', args = 'jean_demon_2', text = "DIALOGUEFIGHTOPTION", reqs = [], dialogue_argument = 1, type = 'next_dialogue',},
		]
	},
		...
		options = [
			{
				...
				reqs = [{type = "decision", value = "rynn_cursed_at_church", check = true}],
				dialogue_argument = 1,
				type = "next_dialogue"
			},
			{
			...
			},
			{
				...
				text = "JEAN_SYLAS_SPHERE_OPTION_RESEARCH",
				reqs = [{type = "decision", value = "rynn_cursed_at_church", check = false}],
				dialogue_argument = 1,
				type = "next_dialogue"
			},
			{
	...
	jean_sylas_sphere_church = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_SPHERE_CHURCH", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_SPHERE_RIGHT", reqs = [], previous_dialogue_option = 2},
			{text = "JEAN_SYLAS_SPHERE_DESTROY_ALIVE", reqs = [], previous_dialogue_option = 3},
		],
		options = [
			{
				code = "close", 
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage13'},
					{code = 'remove_quest_location', value = 'quest_jean_demon_location'},
					],
			},
		]
	},
	jean_sylas_sphere_research = {
		...
		reqs = [],
		text = [
			{text = "JEAN_SYLAS_SPHERE_RESEARCH_DEAD", reqs = [], previous_dialogue_option = 1},
			{text = "JEAN_SYLAS_SPHERE_UP_TO_YOU", reqs = [], previous_dialogue_option = 2},
		],
		options = [
			{
				code = "close", 
				...
				type = "next_dialogue",
				bonus_effects = [
					{code = 'progress_quest', value = 'jean_sylas_quest', stage = 'stage14'},
					{code = 'remove_quest_location', value = 'quest_jean_demon_location'},
					],
			},
		]
	...
	jean_sylas_sphere_research_alive = {
		...
		options = [
			{code = "jean_sylas_sphere_church", text = "JEAN_SYLAS_SPHERE_OPTION_RIGHT", reqs = [], dialogue_argument = 2, type = "next_dialogue"},
		...
		options = [
			{
				...
				dialogue_argument = 1, 
				type = "next_dialogue",
				bonus_effects = [{code = 'complete_quest', value = 'jean_sylas_quest'},],
			},
		]
	},
	...
	jean_sylas_keep_sphere_3 = {
		...
		options = [
			{code = "jean_sylas_keep_sphere_31", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	...
	jean_sylas_keep_sphere_5 = {
		...
		options = [
			{code = "jean_sylas_keep_sphere_51", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
	jean_sylas_keep_sphere_51 = {
		...
		options = [
			{code = "jean_sylas_keep_sphere_52", text = "DIALOGUECONTINUE", reqs = [], dialogue_argument = 1, type = "next_dialogue"},
		]
	},
