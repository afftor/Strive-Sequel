...
var data = {
	...
	workers_introduction2 = {
		...
		{code = 'after_mines_sigmund_start', text = "AFTER_MINES_WORKERS_OPTION_1", reqs = [{type = 'decision', value = 'PreFinalBossDone', check = true}], dialogue_argument = 7},
		],
	},
	workers_join = {
		image = null,
	...
	reim_encounter3 = {
		variations = [
			{reqs = [{type = 'master_check', value = [{code = 'stat', stat = 'charm_factor', operant = 'gte', value = 3}]}],
			image = null,
			tags = [],
			text = [
