var data = {
	act3_intro = {
		reqs = [
			{type = "has_active_quest", name = "zephyra_disappearance_quest", check = false, negative = 'repeat_next_day'},
		],
		variations = [
			{#act3_intro_no_z
				image = "letter",
				...
				options = [{
					...
					bonus_effects = [
						...
						{code = 'make_quest_location', value = 'quest_dwarfs_gate'}
					],
				}]
			},{#act3_intro_z
				character = "zephyra",
	...
	enter_city_t_0 = {
		...
		tags = ['dialogue_scene'],
		text = [
			{text = "ENTER_CITY_T_0", reqs = [], previous_dialogue_option = 0},
		...
		options = [
			{
				code = 'enter_city_t_0', 
				text = "ENTER_CITY_OPTION_VISITORS", reqs = [], dialogue_argument = 1,
			},
			{
				code = 'enter_city_t_0', 
				text = "ENTER_CITY_OPTION_ALERT", reqs = [], dialogue_argument = 2,
			},
			{
				code = 'enter_city_introduce', 
				text = "ENTER_CITY_OPTION_INTRODUCE", reqs = [], dialogue_argument = 0, type = 'next_dialogue',
			},
			{
				code = 'close', 
				text = "ENTER_CITY_OPTION_TURN_AWAY", reqs = [], dialogue_argument = 0, type = 'next_dialogue',
			}
		]
	},
	...
	dwarf_palace_first = {
		...
		tags = ['dialogue_scene', "master_translate"],
		text = [
			{text = "DWARF_PALACE_FIRST", reqs = [], previous_dialogue_option = 0
			},{
				text = "DWARF_PALACE_REPLY_PATTERN1", reqs = [],
				previous_dialogue_option = 1,
			},{
				text = "DWARF_PALACE_REPLY_PATTERN2_NOSHORT",
				previous_dialogue_option = 1,
				reqs = [{type = 'master_check',
					value = [{code = 'stat', stat = 'body_shape', operant = 'neq', value = 'shortstack'}]}]
			},{
				text = "DWARF_PALACE_REPLY_PATTERN2_SHORT",
				previous_dialogue_option = 1,
				reqs = [{type = 'master_check',
					value = [{code = 'stat', stat = 'body_shape', operant = 'eq', value = 'shortstack'}]}]
			},{
				text = "DWARF_PALACE_REPLY_PATTERN3", reqs = [],
				previous_dialogue_option = 1,
			}
		],
		options = [
			{
				...
				text = "DWARF_PALACE_OPT_PATTERN", reqs = [], dialogue_argument = 1
			},{
				code = 'dwarf_palace_first_biz',
				text = "DWARF_PALACE_OPT_BIZ", dialogue_argument = 0, type = 'next_dialogue',
				reqs = [{type = 'active_quest_stage', value = 'visit_dwarfs_quest', stage = 'audience'}]
			},{
				code = 'jean_report',
				text = "DWARF_PALACE_OPT_CRIME", dialogue_argument = 0, type = 'next_dialogue',
				reqs = [{type = 'active_quest_stage', value = 'visit_dwarfs_quest', stage = 'jean'}]
			},{
				code = 'close',
	...
	dwarf_palace_first_biz = {
		...
		tags = ['dialogue_scene'],
		text = [
			{text = "DWARF_PALACE_BIZ", reqs = [], previous_dialogue_option = 0}
		],
		options = [
			{
				code = 'dwarf_palace_first_end', 
				text = "DWARF_PALACE_OPT_URGENT", reqs = [], dialogue_argument = 1, type = 'next_dialogue'
			},
			{
				code = 'dwarf_palace_reply_important', 
				text = "DWARF_PALACE_OPT_IMPORTANT", reqs = [], dialogue_argument = 0, type = 'next_dialogue'
			}
		]
	},
	dwarf_palace_reply_important = {
		...
		tags = ['dialogue_scene'],
		text = [
			{text = "DWARF_PALACE_REPLY_IMPORTANT1", reqs = [], previous_dialogue_option = 0},
		],
		options = [
			{
				code = 'dwarf_palace_first_end', 
	...
	dwarf_palace_first_end = {
		...
		tags = ['dialogue_scene'],
		text = [
			{text = "DWARF_PALACE_REPLY_URGENT", reqs = [], previous_dialogue_option = 1},
			{text = "DWARF_PALACE_REPLY_IMPORTANT2", reqs = [], previous_dialogue_option = 2},
			{text = "DWARF_PALACE_FIRST_END", reqs = [], previous_dialogue_option = [1,2]},
		],
		options = [{
			...
			options = [
				{
					...
					code = 'dwarf_tavern', 
					text = "DIALOGUENEVERMIND", reqs = [], dialogue_argument = 1, type = 'next_dialogue'
				}
			]
		},{
			reqs = [{type = 'master_check', value = [{code = 'race', race = 'Dwarf', check = true}]}],
		...
		options = [
			{
				...
				text = "DTAVERN_BARK_OPT_FIGHT", reqs = [], dialogue_argument = 0, type = 'next_dialogue'
			},
		]
	},
		...
		options = [
			{
				...
				code = 'close',
				text = "DIALOGUELEAVE", dialogue_argument = 0, type = 'next_dialogue',
				reqs = [{type = 'active_quest_stage', value = 'visit_dwarfs_quest', stage = 'tavern', state = false}]
			}
		]
	},
	...
	dwarf_tavern_bark_leave = {
		...
		options = [
			{
				code = 'dwarf_tavern_jean_outside',
				text = "DIALOGUECONTINUE", dialogue_argument = 4, type = 'next_dialogue',
				reqs = [{type = 'active_quest_stage', value = 'visit_dwarfs_quest', stage = 'tavern'}],
#				bonus_effects = [{code = "update_city"}],#should close tavern if it is a "guild"
			},{
				code = 'close',
				text = "DIALOGUELEAVE", dialogue_argument = 0, type = 'next_dialogue',
				reqs = [{type = 'active_quest_stage', value = 'visit_dwarfs_quest', stage = 'tavern', state = false}]
	...
	jean_dungeon_guard = {
		...
		tags = ['dialogue_scene'],
		text = [
			{text = "JEAN_DUNGEON_GUARD", reqs = [], previous_dialogue_option = 0},
			{text = "JEAN_DUNGEON_REPLY_WHAT", reqs = [], previous_dialogue_option = 1},
		],
		options = [
			{
				code = 'jean_dungeon_guard',
				text = "JEAN_DUNGEON_OPT_WHAT", reqs = [], dialogue_argument = 1
			},{
				code = 'jean_dungeon_reply_until',
				text = "JEAN_DUNGEON_OPT_UNTIL", dialogue_argument = 0,
				reqs = [{type = 'dialogue_seen', check = true, value = 'JEAN_DUNGEON_REPLY_WHAT'}]
			},{
				code = 'jean_dungeon_obey',
				text = "JEAN_DUNGEON_OPT_OBEY", reqs = [], dialogue_argument = 0, type = 'next_dialogue'
			},
		]
	},
	jean_dungeon_reply_until = {
		...
		tags = ['dialogue_scene'],
		text = [
			{text = "JEAN_DUNGEON_REPLY_UNTIL", reqs = []},
		],
		options = [{
	...
	jean_dungeon_reply_until2 = {
		...
		tags = ['dialogue_scene'],
		text = [
			{text = "JEAN_DUNGEON_REPLY_UNTIL2", reqs = []},
		],
		options = [{
			code = 'jean_dungeon_obey',
			text = "JEAN_DUNGEON_OPT_OBEY", reqs = [], dialogue_argument = 0, type = 'next_dialogue'
	...
	jean_dungeon_obey = {
		...
		tags = ['dialogue_scene'],
		text = [
			{text = "JEAN_DUNGEON_REPLY_OBEY", reqs = []},
		],
		options = [{
