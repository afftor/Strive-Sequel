...
var data = {
	...
	goblin_quest_10 = {
	 ...
	 goblin_quest_13 = {
		...
		options = [ {
			code = 'close', text = "DIALOGUECLOSE", reqs = [], dialogue_argument = 1, bonus_effects = [{code = 'progress_quest', value = 'goblin_quest', stage = 'stage5'}, {code = 'update_location'}], type = 'next_dialogue',
		}, ]
	},
	...
	goblin_quest_14 = {
	 ...
	 goblin_quest_15 = {
		...
		options = [ {
			code = 'close', text = "DIALOGUECLOSE", reqs = [], dialogue_argument = 1, type = 'next_dialogue', previous_dialogue_option = 1, bonus_effects = [{code = 'complete_quest', value = 'goblin_quest'}, {code = 'remove_quest_location', value = 'quest_goblin_location'}]
		}, {
	...
	goblin_quest_hara_2 = {
		...
		reqs = [], character = "$hara",
		text = [
			{text = "GOBLIN_QUEST_HARA_2_1", reqs = [], bonus_effects = [{code = 'make_story_character', value = 'Hara', recruit_from_location = true}], previous_dialogue_option = 1},
	...
	goblin_quest_sex_3 = {
		...
		common_effects = [{code = 'unique_character_changes', value = 'master', args = [
