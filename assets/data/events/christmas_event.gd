var data = {
	...
	christmas_6 = {
		...
		options = [ {
			code = 'christmas_7', reqs = [], text = tr("DIALOGUECONTINUE"), type = 'next_dialogue', dialogue_argument = 0
		} ]
	},
	...
	christmas_7 = {
		...
		options = [ {
			code = 'christmas_8', reqs = [], text = tr("DIALOGUECONTINUE"), type = 'next_dialogue', dialogue_argument = 0
		} ]
	},
