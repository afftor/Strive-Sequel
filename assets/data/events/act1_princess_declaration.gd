...
var data = {
	...
	final_words_1 = {
		...
		common_effects = [
			...
			{
				code = "add_timed_event",
				value = "zephyra_recruitment_letter",
				args = [
					{
						type = "add_to_date",
						date = [
		...
		text = [
						...
						args = [
							{
								...
								item = "anastasia_broken_bracelet",
								parts = {
			...
			},
			{
				...
				reqs = [
					{
						type = "decision",
						value = "AireAnastasiaPersuasion",
						check = true
					},
					{
						type = "decision",
						value = "persuade_2_completed",
						check = true
					}
				],
				bonus_effects = [
		...
		variations = [
			{
				...
				text = [
					{
						text = "AFTER_ELECTION_PRINCESS_1",
						reqs = [

						]
					},
					{
						text = "AFTER_ELECTION_PRINCESS_2",
						reqs = [
							{
								type = "decision",
								value = "marry_option",
					...
					{
						text = "AFTER_ELECTION_PRINCESS_3",
						reqs = [
							{
								type = "decision",
								value = "enslave_option",
								check = true
							}
						]
					}
			...
			},
			{
				...
				text = [
					{
						text = "AFTER_ELECTION_PRINCESS_MINDBREAK_0",
						reqs = [
	...
	princess_cutscene_mindbreak_1 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_MINDBREAK_1",
				reqs = [
	...
	princess_cutscene_mindbreak_2 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_MINDBREAK_2",
				reqs = [
	...
	princess_cutscene_mindbreak_3 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_MINDBREAK_3",
				reqs = [
	...
	princess_cutscene_mindbreak_4 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_MINDBREAK_4",
				reqs = [
	...
	princess_cutscene_mindbreak_5 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_MINDBREAK_5",
				reqs = [
	...
	princess_cutscene_mindbreak_6 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_MINDBREAK_6",
				reqs = [
	...
	princess_cutscene_mindbreak_7 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_MINDBREAK_7",
				reqs = [
	...
	princess_cutscene_mindbreak_8 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_MINDBREAK_8",
				reqs = [
	...
	princess_cutscene_good_1 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_4",
				reqs = [
	...
	princess_cutscene_good_2 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_7",
				reqs = [
	...
	princess_cutscene_pre_sex_good_1 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_1",
				reqs = [
	...
	princess_sex_good_1 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_2",
				reqs = [
	...
	princess_sex_good_3 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_3",
				reqs = [
	...
	princess_sex_good_4 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_4",
				reqs = [
	...
	princess_sex_good_5 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_5",
				reqs = [
	...
	princess_sex_good_6 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_6",
				reqs = [
	...
	princess_sex_good_7 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_7",
				reqs = [
	...
	princess_sex_good_8 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_REPLY_1",
				reqs = [
			...
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_REPLY_2",
				reqs = [
			...
			{
				text = "AFTER_ELECTION_PRINCESS_CONSENT_REPLY_3",
				reqs = [
	...
	princess_cutscene_exit_1 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_12",
				reqs = [
	...
	princess_cutscene_exit_2 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_16_OLD",
				reqs = [
	...
	princess_cutscene_bad_1 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_13",
				reqs = [
	...
	princess_cutscene_bad_pre_2 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_PRE_14",
				reqs = [
	...
	princess_cutscene_bad_2 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_14",
				reqs = [
	...
	princess_sex_bad_3 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_17",
				reqs = [
	...
	princess_sex_bad_4 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_18",
				reqs = [
	...
	princess_sex_bad_5 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_19",
				reqs = [
	...
	princess_sex_bad_6 = {
		...
		text = [
			{
				text = "AFTER_ELECTION_PRINCESS_20",
				reqs = [
