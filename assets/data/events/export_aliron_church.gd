...
var data = {
	...
	aliron_church_enter = {
		...
		options = [
			...
			{code = 'heleviel_slave_church_intro', text = tr("HELEVIEL_CITY_OPTION"), reqs = [{type = 'active_quest_stage', value = 'heleviel_quest2', stage = 'stage3'}], dialogue_argument = 0, type = 'next_dialogue'},
			{code = 'act4_sebastian_church_visit', text = "ACT4_SEBASTIAN_CHURCH_ENTER_OPTION", reqs = [{type = 'active_quest_stage', value = 'sebastian_railroad_quest', stage = 'speak_to_church'}], dialogue_argument = 0, type = 'next_dialogue'},
