...
#	},
	...
	workers_food_easy = {
		...
		randomconditions = [{code = 'random_material', function = 'range', type =  ['meat','fish','vegetables','bread'], range = [12,18]}],
		unlockreqs = [],
		reputation = [100,150],
	...
	workers_food_medium = {
		...
		name = tr("WORKERS_FOOD_NAME"),
		descript = tr("WORKERS_FOOD_DESC"),
		randomconditions = [{code = 'random_material', function = 'range', type =  ['meat','fish','vegetables','bread'], range = [25,40]}],
		unlockreqs = [],
		reputation = [150,250],
	...
	workers_food_hard = {
		...
		name = tr("WORKERS_FOOD_NAME"),
		descript = tr("WORKERS_FOOD_DESC"),
		randomconditions = [{code = 'random_material', function = 'range', type =  ['bread','fishcakes','meatsoup'], range = [25,40]}],
		unlockreqs = [],
		reputation = [250,450],
	...
	fighters_dungeon_easy = {
		...
		randomconditions = [{code = 'complete_dungeon', type = ['dungeon_bandit_den', 'dungeon_goblin_cave','dungeon_spider_lair']}],
		unlockreqs = [],
		reputation = [150,250],
	...
	fighters_dungeon_medium = {
		...
		name = tr("FIGHTERS_DUNGEON_NAME"),
		descript = tr("FIGHTERS_DUNGEON_DESC"),
		randomconditions = [{code = 'complete_dungeon', type = ['dungeon_bandit_fort','dungeon_undead_crypt','dungeon_ancient_jungles','dungeon_rebel_redoubt','dungeon_grove']}],
		unlockreqs = [],
		reputation = [200,350],
	...
	fighters_dungeon_hard = {
		...
		name = tr("FIGHTERS_DUNGEON_NAME"),
		descript = tr("FIGHTERS_DUNGEON_DESC"),
		randomconditions = [{code = 'complete_dungeon', type = ['dungeon_fire_depths','dungeon_ancient_jungles','dungeon_goblin_stronghold']}],
		unlockreqs = [],
		reputation = [300,500],
