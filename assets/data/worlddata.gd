...
var lands = {
	...
	forests = {
		...
		events = [{code = 'looking_for_princess_elven_1', text = "Meet Priestess", reqs = [{type = 'active_quest_stage', value = 'princess_search', stage = 'stage3'}, {type = 'decision', value = 'PrincessDead', check = false}, {type = 'decision', value = 'PrincessObtained', check = false}], args = {"oneshot": false}},
			...
			{code = 'priestess_talk_start', text = "Visit Erlen", reqs = [{type = 'quest_completed', name = 'sword_artifact_quest', check = true}, {code = 'value_check', type = 'dialogue_seen', check = false, value = 'PRIESTESS_TALK_START'}], args = {"oneshot": false}},
...
#	},
	beastkin_slave_trader = {
		...
		hireable_characters = [
			...
			slavelevel = 2,
			character_types = [['servant',1]],
			character_bonuses = {authority = [50,175], obedience = [48,48], pricemod = 1.3},
			slave_races = [['beast',3]],
			tags = ['unique_slave_races'],
			slavenumber = [3,4],
			},
			...
			slavelevel = 2,
			character_types = [['servant',1]],
			character_bonuses = {authority = [50,75], obedience = [48,48], pricemod = 1.3},
	...
	elvish_slave_trader = {
		...
		hireable_characters = [
			...
			slavelevel = 1,
			character_types = [['servant',1]],
			character_bonuses = {authority = [30,50], obedience = [48,48], pricemod = 1.1},
