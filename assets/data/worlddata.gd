...
var pregen_characters = {
	...
	Aire = {
		...
		food_consumption = 2,
		icon_image = 'daisy_sad',
		body_image = "res://assets/images/sprites/aire.png",
		physics = 36.0,
		wits = 6.0,
		charm = 10.0,
		sexuals = 8.0,
	...
	Anastasia = {
		...
		food_consumption = 2,
		icon_image = 'daisy_sad',
		body_image = "res://assets/images/sprites/anastasia.png",
		physics = 2.0,
		wits = 25.0,
		charm = 41.0,
		sexuals = 1.0,
	...
	Elf_Priestess = {
		...
		food_consumption = 1,
		icon_image = 'daisy_sad',
		body_image = "res://assets/images/sprites/elf_priestess.png",
		physics = 6.0,
		wits = 55.0,
		charm = 31.0,
		sexuals = 12.0,
