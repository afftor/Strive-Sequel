...
var dungeons = {
	...
	dungeon_bandit_den = {
		...
		eventarray =[['event_goblin_friendly',0.3]], #[['dungeon_find_chest_easy', 1],['dungeon_find_armory_easy',1],['event_trap_easy', 1],['event_dungeon_prisoner',1]], 
		levels = [2,3], 
	...
	dungeon_bandit_fort = {
		...
		eventarray = [['dungeon_find_chest_medium', 1],['event_trap_easy', 1],['event_dungeon_prisoner',1]], 
		levels = [3,5], 
	...
	dungeon_undead_crypt = {
		...
		eventarray = [['dungeon_find_chest_easy', 1],['event_trap_easy', 1], ['crypt_find_bones',1]], 
		levels = [3,5], 
	...
	dungeon_goblin_cave = {
		...
		eventarray = [['dungeon_find_chest_easy', 1],['event_trap_easy', 1],['event_goblin_friendly',0.3]], 
		levels = [2,3], 
	...
	dungeon_grove = {
		...
		eventarray = [['dungeon_find_chest_easy', 1],['grove_find_wood',1],['grove_find_leather',0.5]],
		levels = [2,4],
