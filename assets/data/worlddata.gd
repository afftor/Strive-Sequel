...
var dungeons = {
	...
	dungeon_grove = {
		...
		eventarray = [['dungeon_find_chest_easy', 1],['grove_find_wood',1],['grove_find_leather',0.5],['event_fairy_friendly', 0.2]],
		levels = [2,4],
...
var pregen_characters = {
	Daisy = {
		...
		timid_factor = 5,
		food_consumption = 2,
		icon_image = 'daisy_sad',
		body_image = "res://assets/images/sprites/daisy_default.png",
		physics = 11.0,
		wits = 2.0,
		charm = 0.0,
		sexuals = 0.0,
