...
var lands = {
	...
	mountains = {
		...
		starting_locations = [],
		locations = {settlement_mountains1 = [1,1],settlement_mountains2 = [1,1]},
...
var locations = {
	...
	settlement_plains2 = {
		...
		bgm = 'exploration',
		gather_resources = {wood = [1,2], vegetables = [2,3], wheat = [2,3], cloth = [2,3], clothsilk = [2,2]},
		area_shop_items = {
	...
	settlement_plains4 = {
		...
		bgm = 'exploration',
		gather_resources = {wood = [2,3], fish = [2,3], wheat = [2,3], cloth = [2,2]},
		area_shop_items = {
			fish = {min = 15, max = 45, chance = 0.6},
			grain = {min = 40, max = 60, chance = 0.9},
			wood = {min = 10, max = 30, chance = 0.75},
	...
	settlement_mountains2 = {
		...
		background_pool = ['cave3'],
		bgm = 'exploration',
		gather_resources = {iron = [2,3], bone = [2,3], mithril = [2,2]},
		area_shop_items = {
			},
	},
}
...
var dungeons = {
	...
	dungeon_undead_crypt = {
		...
		difficulty = 'medium',
		descript = '',
		background_pool = ['cryp1', 'crypt2', 'crypt3', 'crypt4', 'crypt5'],
		...
		gatherable_resources = {number = [2,3], pool = {bone = [50,80], stone = [50,100], boneancient = [20,50]}},
		gather_mod = 1.5,
