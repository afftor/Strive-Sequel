...
var lands = {
	...
	forests = {
		...
		guilds = [],  
		events = [{code = 'looking_for_princess_elven_1', text = "Meet priestess", reqs = [{type = 'dialogue_seen', check = true, value = 'LOOKING_FOR_PRINCESS_21'}, {type = 'decision', value = 'PrincessDead', check = false}, {type = 'decision', value = 'PrincessObtained', check = false}, {type = 'decision', value = 'interrogation_success', check = true, orflag = true}], args = {"oneshot": false}},],
		capital_options = [],
...
var pregen_characters = {
	Daisy = {
		...
		food_consumption = 2,
		icon_image = 'daisy',
		body_image = "res://assets/images/sprites/daisy_happy_body.png",
		physics = 11.0,
		wits = 2.0,
		charm = 0.0,
		obedience = 48,
	...
	Kurdan = {
		...
		food_consumption = 3,
		icon_image = 'kurdan',
		body_image = "res://assets/images/sprites/kurdan.png",
		physics = 13.0,
		wits = 32.0,
		charm = 4.0,
		obedience = 48,
	...
	Aire = {
		...
		food_consumption = 2,
		icon_image = 'aire',
		body_image = "res://assets/images/sprites/aire_body.png",
		physics = 36.0,
		wits = 6.0,
		charm = 10.0,
		obedience = 48,
	...
	Anastasia = {
		...
		body_image = "res://assets/images/sprites/anastasia_body.png",
		physics = 2.0,
		wits = 25.0,
		charm = 22.0,
		obedience = 48,
	...
	Zephyra = {
		...
		food_consumption = 1,
		icon_image = 'zephyra',
		body_image = "res://assets/images/sprites/zephyra_body.png",
		physics = 6.0,
		wits = 45.0,
		charm = 31.0,
		obedience = 48,
