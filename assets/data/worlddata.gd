...
var lands = {
	...
	forests = {
		...
		events = [{code = 'looking_for_princess_elven_1', text = "Meet Priestess", reqs = [{type = 'active_quest_stage', value = 'princess_search', stage = 'stage3'}, {type = 'decision', value = 'PrincessDead', check = false}, {type = 'decision', value = 'PrincessObtained', check = false}], args = {"oneshot": false}},
			...
			{code = 'priestess_talk_start', text = "Visit Erlen", reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage1', state = true}], args = {"oneshot": false}},
			{code = 'after_temple_priestess_1', text = "Meet High Priestess", reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage2', state = true}, {type = 'active_quest_stage', value = 'temple_quest', stage = 'stage3', state = true, orflag = true}], args = {"oneshot": false}},
			{code = 'after_temple_priestess_3', text = "Meet High Priestess", reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage4', state = true}], args = {"oneshot": false}},
			{code = 'lira_encounter_1', text = "Search For Lira", reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage6', state = true}], args = {"oneshot": false}},
			{code = 'lira_encounter_4', text = "Find Lira", reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage7', state = true}, {type = 'active_quest_stage', value = 'temple_quest', stage = 'stage8', state = true, orflag = true}], args = {"oneshot": false}},
			{code = 'erlen_leon_1', text = "Initiate", reqs = [{type = 'quest_completed', name = 'temple_quest', check = true}, {code = 'value_check', type = 'dialogue_seen', check = false, value = 'ERLEN_LEON_1'}], args = {"oneshot": false}},
		],
		capital_options = [],
	...
	seas = {
	 ...
	 beastkin_tribe = {
		...
		events = [
			...
			{code = 'savra_talk_start', text = "Visit Savra", reqs = [{type = 'active_quest_stage', value = 'sword_artifact_quest', stage = 'stage11', state = true}, 
				{type = 'active_quest_stage', value = 'sword_artifact_quest', stage = 'stage12', state = true, orflag = true}, 
				{type = 'active_quest_stage', value = 'sword_artifact_quest', stage = 'stage15', state = true, orflag = true}], args = {"oneshot": false}},
		],
		capital_options = [],
		material_tiers = {easy = 1, medium = 0.7, hard = 0.1},
		area_shop_items = {
...
#			],
	...
	quest_temple_location = {
		...
		travel_time = [1,1],
		options = [
			{text = 'Approach', reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage2', state = true}],
				args = [{code = 'start_event', data = 'temple_start', args = []}]},
			{text = 'Approach', reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage3', state = true}],
	...
	quest_erlen_location = {
		...
		travel_time = [1,1],
		options = [
			{text = 'Search Around', reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage5', state = true}],
				args = [{code = 'start_event', data = 'erlern_encounter_start', args = []}]},
			{text = 'Meet Erlen', reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage6', state = true}, {type = 'active_quest_stage', value = 'temple_quest', stage = 'stage7', state = true, orflag = true}, {type = 'active_quest_stage', value = 'temple_quest', stage = 'stage8', state = true, orflag = true}, ],
				args = [{code = 'start_event', data = 'erlen_lira_1', args = []}]},
			{text = 'Meet Erlen', reqs = [{type = 'active_quest_stage', value = 'temple_quest', stage = 'stage9', state = true}],
