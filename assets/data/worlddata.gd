...
#	},
	...
	exotic_slave_trader = {
		...
		hireable_characters = [
			...
			slavelevel = 0,
			character_types = [['slave',1]],
			character_bonuses = {submission = [10,20], authority = [0,10], obedience = [12,18], pricemod = 5},
			slave_races = [['top', 1]],
			tags = ['unique_slave_races'],
			slavenumber = [1,1],
			},
			...
			slavelevel = 0,
			character_types = [['slave',1]],
			character_bonuses = {submission = [10,20], authority = [0,10], obedience = [12,18], pricemod = 3},
